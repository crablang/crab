...
use crablangc_hir::{GenericArg, GenericParam, GenericParamKind, HirIdMap, LifetimeName, Node};
use crablangc_middle::bug;
use crablangc_middle::hir::nested_filter;
use crablangc_middle::middle::resolve_bound_vars::*;
use crablangc_middle::ty::{self, TyCtxt, TypeSuperVisitable, TypeVisitor};
        ...
        let result = loop {
            match *scope {
                ...
                Scope::Binder { ref bound_vars, scope_type, s, where_bound_origin, .. } => {
                    ...
                    {
                        let mut diag =  crablangc_session::parse::feature_err(
                            ...
                            self.tcx.hir().get_generics(lifetime_ref.hir_id.owner.def_id)
                        {
                            ...
                            diag.multipart_suggestion(
                                ...
                                suggestions,
                                crablangc_errors::Applicability::MaybeIncorrect,
                            );
                        }
