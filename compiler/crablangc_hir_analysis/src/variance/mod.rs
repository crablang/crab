//! Module for inferring the variance of type and lifetime parameters. See the [crablangc dev guide]
//! chapter for more info.
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/variance.html
...
use crablangc_middle::ty::{self, CrateVariancesMap, SubstsRef, Ty, TyCtxt};
use crablangc_middle::ty::{TypeSuperVisitable, TypeVisitable};
