...
use crablangc_hir::def_id::{LocalDefId, LocalDefIdMap};
...
pub fn determine_parameters_to_be_inferred<'a, 'tcx>(
    ...
    //
    // - https://crablangc-dev-guide.crablang.org/query.html
    // - https://crablangc-dev-guide.crablang.org/variance.html
