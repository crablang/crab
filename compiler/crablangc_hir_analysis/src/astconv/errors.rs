...
use crablangc_errors::{pluralize, struct_span_err, Applicability, Diagnostic, ErrorGuaranteed};
use crablangc_hir as hir;
use crablangc_hir::def_id::DefId;
use crablangc_infer::traits::FulfillmentError;
...
impl<'o, 'tcx> dyn AstConv<'tcx> + 'o {
    ...
    // FIXME(fmease): Heavily adapted from `crablangc_hir_typeck::method::suggest`. Deduplicate.
    ...
    pub(crate) fn complain_about_inherent_assoc_type_not_found(
        ...
        // FIXME(fmease): This was copied in parts from an old version of `crablangc_hir_typeck::method::suggest`.
        // Either
        ...
        if fulfillment_errors.is_empty() {
            // FIXME(fmease): Copied from `crablangc_hir_typeck::method::probe`. Deduplicate.
        ...
        // FIXME(fmease): `crablangc_hir_typeck::method::suggest` uses a `skip_list` to filter out some bounds.
