...
use crablangc_ast::ast::ParamKindOrd;
use crablangc_errors::{struct_span_err, Applicability, Diagnostic, ErrorGuaranteed, MultiSpan};
...
use crablangc_session::lint::builtin::LATE_BOUND_LIFETIME_ARGUMENTS;
    ...
    match (arg, &param.kind) {
        (
            GenericArg::Type(hir::Ty {
                kind: hir::TyKind::Path(crablangc_hir::QPath::Resolved(_, path)),
                ..
            }),
        ...
        (GenericArg::Const(cnst), GenericParamDefKind::Type { .. }) => {
            ...
            if let crablangc_hir::ExprKind::Path(crablangc_hir::QPath::Resolved(_, path)) = body.value.kind
            {
