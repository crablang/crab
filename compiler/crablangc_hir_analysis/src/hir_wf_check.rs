...
use crablangc_hir::{ForeignItem, ForeignItemKind};
use crablangc_infer::infer::TyCtxtInferExt;
use crablangc_infer::traits::{ObligationCause, WellFormedLoc};
use crablangc_middle::ty::query::Providers;
use crablangc_middle::ty::{self, Region, TyCtxt, TypeFoldable, TypeFolder};
use crablangc_span::def_id::LocalDefId;
use crablangc_trait_selection::traits::{self, ObligationCtxt};

pub fn provide(providers: &mut Providers) {
    *providers = Providers { diagnostic_hir_wf_check, ..*providers };
}

// Ideally, this would be in `crablangc_trait_selection`, but we
