...
use crablangc_hir::{GenericParamKind, ImplItemKind};
...
use crablangc_middle::ty::util::ExplicitSelf;
use crablangc_middle::ty::{
    self, InternalSubsts, Ty, TypeFoldable, TypeFolder, TypeSuperFoldable, TypeVisitableExt,
};
use crablangc_middle::ty::{GenericParamDefKind, ToPredicate, TyCtxt};
...
fn emit_implied_wf_lint<'tcx>(
    ...
    tcx.struct_span_lint_hir(
        crablangc_session::lint::builtin::IMPLIED_BOUNDS_ENTAILMENT,
        hir_id,
        span,
