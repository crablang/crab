...
hir_analysis_paren_sugar_attribute = the `#[crablangc_paren_sugar]` attribute is a temporary means of controlling which traits can use parenthetical notation
    .help = add `#![feature(unboxed_closures)]` to the crate attributes to use it

hir_analysis_must_implement_one_of_attribute = the `#[crablangc_must_implement_one_of]` attribute must be used with at least 2 args
...
hir_analysis_must_implement_not_function_note = all `#[crablangc_must_implement_one_of]` arguments must be associated function names

hir_analysis_function_not_found_in_trait = function not found in this trait

hir_analysis_functions_names_duplicated = functions names are duplicated
    .note = all `#[crablangc_must_implement_one_of]` arguments must be unique
