...
use crablangc_infer::infer::NllRegionVariableOrigin;
...
use crablangc_middle::ty::{self, RegionVid, TyCtxt};
use crablangc_span::symbol::{kw, Symbol};
use crablangc_span::{sym, DesugaringKind, Span};
use crablangc_trait_selection::traits::error_reporting::FindExprBySpan;
...
impl<'cx, 'tcx> MirBorrowckCtxt<'cx, 'tcx> {
    ...
    ///
    /// [d]: https://crablang.github.io/rfcs/2094-nll.html#leveraging-intuition-framing-errors-in-terms-of-points
