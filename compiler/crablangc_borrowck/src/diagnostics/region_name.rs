...
use crablangc_middle::ty::print::RegionHighlightMode;
...
impl crablangc_errors::IntoDiagnosticArg for RegionName {
    ...
    fn highlight_if_we_can_match_hir_ty(
        ...
        while let Some((ty, hir_ty)) = search_stack.pop() {
            match (ty.kind(), &hir_ty.kind) {
                ...
                // just worry about trying to match up the crablangc type
                // with the HIR types:
