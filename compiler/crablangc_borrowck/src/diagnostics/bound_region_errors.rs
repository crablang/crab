...
use crablangc_infer::infer::canonical::Canonical;
use crablangc_infer::infer::error_reporting::nice_region_error::NiceRegionError;
use crablangc_infer::infer::region_constraints::Constraint;
use crablangc_infer::infer::region_constraints::RegionConstraintData;
use crablangc_infer::infer::RegionVariableOrigin;
use crablangc_infer::infer::{InferCtxt, RegionResolutionError, SubregionOrigin, TyCtxtInferExt as _};
use crablangc_infer::traits::ObligationCause;
use crablangc_middle::ty::error::TypeError;
use crablangc_middle::ty::RegionVid;
use crablangc_middle::ty::UniverseIndex;
use crablangc_middle::ty::{self, Ty, TyCtxt, TypeFoldable};
use crablangc_span::Span;
use crablangc_trait_selection::traits::query::type_op;
use crablangc_trait_selection::traits::ObligationCtxt;
use crablangc_traits::{type_op_ascribe_user_type_with_span, type_op_prove_predicate_with_cause};
    ...
    T: Copy + fmt::Display + TypeFoldable<TyCtxt<'tcx>> + 'tcx,
{
    ...
    fn nice_error(
        ...
        // `crablangc_traits::type_op::type_op_normalize` query to allow the span we need in the
