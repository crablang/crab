...
use crablangc_middle::mir::{Mutability, Place, PlaceRef, ProjectionElem};
...
use crablangc_const_eval::util::collect_writes::FindAssignments;
            ...
            let reason = if let PlaceBase::Upvar(upvar_id) = closure_kind_origin.base {
                ...
                for captured_place in captured_places {
                    let captured_place_kinds = captured_place
                        ...
                        .map(|proj| proj.kind)
                        .collect::<Vec<_>>();
                    if crablangc_middle::ty::is_ancestor_or_same_capture(
...
fn suggest_ref_mut(tcx: TyCtxt<'_>, binding_span: Span) -> Option<String> {
    ...
    if hi_src.starts_with("ref") && hi_src["ref".len()..].starts_with(crablangc_lexer::is_whitespace) {
