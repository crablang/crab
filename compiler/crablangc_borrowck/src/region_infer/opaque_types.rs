...
use crablangc_hir::OpaqueTyOrigin;
use crablangc_infer::infer::TyCtxtInferExt as _;
use crablangc_infer::infer::{DefiningAnchor, InferCtxt};
...
use crablangc_middle::ty::{self, OpaqueHiddenType, OpaqueTypeKey, Ty, TyCtxt, TypeFoldable};
