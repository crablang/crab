...
use crablangc_errors::{Diagnostic, DiagnosticBuilder, DiagnosticMessage, SubdiagnosticMessage};
...
use crablangc_middle::mir::{AggregateKind, BasicBlock, BorrowCheckResult, BorrowKind};
use crablangc_middle::mir::{InlineAsmOperand, Terminator, TerminatorKind};
use crablangc_middle::mir::{ProjectionElem, Promoted, Rvalue, Statement, StatementKind};
use crablangc_middle::ty::query::Providers;
use crablangc_middle::ty::{self, CapturedPlace, ParamEnv, RegionVid, TyCtxt};
use crablangc_session::lint::builtin::UNUSED_MUT;
...
use crablangc_mir_dataflow::impls::{
    EverInitializedPlaces, MaybeInitializedPlaces, MaybeUninitializedPlaces,
};
use crablangc_mir_dataflow::move_paths::{InitIndex, MoveOutIndex, MovePathIndex};
use crablangc_mir_dataflow::move_paths::{InitLocation, LookupResult, MoveData, MoveError};
use crablangc_mir_dataflow::Analysis;
use crablangc_mir_dataflow::MoveDataParamEnv;
...
/// A public API provided for the CrabLang compiler consumers.
pub mod consumers;
...
fn do_mir_borrowck<'tcx>(
    ...
    // We also have a `#[crablangc_regions]` annotation that causes us to dump
    // information.
    nll::dump_annotation(
        &infcx,
        &body,
    ...
    crablangc_mir_dataflow::visit_results(
        body,
...
impl<'cx, 'tcx> crablangc_mir_dataflow::ResultsVisitor<'cx, 'tcx> for MirBorrowckCtxt<'cx, 'tcx> {
...
impl<'cx, 'tcx> MirBorrowckCtxt<'cx, 'tcx> {
        ...
        each_borrow_involving_path(
            ...
            |this, borrow_index, borrow| match (rw, borrow.kind) {
                ...
                (Reservation(_), BorrowKind::Shallow | BorrowKind::Shared) => {
                    ...
                    // disallowed on NLL). See crablang/crablang#56254
                    Control::Continue
                }
    ...
    fn check_if_assigned_path_is_moved(
                ...
                ProjectionElem::Field(..) => {
                    ...
                    match base_ty.kind() {
                        ...
                        ty::Adt(..) | ty::Tuple(..) => {
                            ...
                            // crablang/crablang#21232, #54499, #54986: during period where we reject
        ...
        fn check_parent_of_field<'cx, 'tcx>(
            ...
            // crablang/crablang#21232: Until CrabLang allows reads from the
    ...
    fn check_access_permissions(
        ...
        match kind {
            ...
            | Write(
                ...
                {
                    // crablang/crablang#46908: In pure NLL mode this code path should be
        ...
        // crablang/crablang#21232, #54986: during period where we reject
