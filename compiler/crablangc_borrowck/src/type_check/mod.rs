...
use crablangc_data_structures::frozen::Frozen;
...
use crablangc_infer::infer::outlives::env::RegionBoundPairs;
use crablangc_infer::infer::region_constraints::RegionConstraintData;
...
use crablangc_middle::ty::adjustment::PointerCast;
use crablangc_middle::ty::cast::CastTy;
use crablangc_middle::ty::subst::{SubstsRef, UserSubsts};
...
use crablangc_target::abi::{FieldIdx, FIRST_VARIANT};
use crablangc_trait_selection::traits::query::type_op::custom::scrape_region_constraints;
use crablangc_trait_selection::traits::query::type_op::custom::CustomTypeOp;
use crablangc_trait_selection::traits::query::type_op::{TypeOp, TypeOpOutput};
use crablangc_trait_selection::traits::query::Fallible;
use crablangc_trait_selection::traits::PredicateObligation;

use crablangc_mir_dataflow::impls::MaybeInitializedPlaces;
use crablangc_mir_dataflow::move_paths::MoveData;
...
impl<'a, 'b, 'tcx> TypeVerifier<'a, 'b, 'tcx> {
    ...
    fn get_ambient_variance(&self, context: PlaceContext) -> ty::Variance {
        use crablangc_middle::mir::visit::NonMutatingUseContext::*;
        use crablangc_middle::mir::visit::NonUseContext::*;
