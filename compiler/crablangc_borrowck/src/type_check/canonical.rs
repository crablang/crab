...
use crablangc_infer::infer::{canonical::Canonical, InferOk};
use crablangc_middle::mir::ConstraintCategory;
use crablangc_middle::ty::{self, ToPredicate, Ty, TyCtxt, TypeFoldable};
use crablangc_span::def_id::DefId;
use crablangc_span::Span;
use crablangc_trait_selection::traits::query::type_op::{self, TypeOpOutput};
use crablangc_trait_selection::traits::query::{Fallible, NoSolution};
use crablangc_trait_selection::traits::{ObligationCause, ObligationCtxt};
...
impl<'a, 'tcx> TypeChecker<'a, 'tcx> {
    ...
    /// `locations`.
    ///
    /// **Any `crablangc_infer::infer` operations that might generate region
