...
use crablangc_hir::BodyOwnerKind;
...
use crablangc_middle::ty::{self, InlineConstSubsts, InlineConstSubstsParts, RegionVid, Ty, TyCtxt};
...
impl<'tcx> UniversalRegions<'tcx> {
    ...
    /// `#[crablangc_regions]`, and we will emit information about the region
