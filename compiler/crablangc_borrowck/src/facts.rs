...
use crablangc_middle::mir::Local;
use crablangc_middle::ty::{RegionVid, TyCtxt};
use crablangc_mir_dataflow::move_paths::MovePathIndex;
use std::error::Error;
use std::fmt::Debug;
...
pub struct CrabLangcFacts;

impl polonius_engine::FactTypes for CrabLangcFacts {
...
pub type AllFacts = PoloniusFacts<CrabLangcFacts>;
