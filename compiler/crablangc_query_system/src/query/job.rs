...
use {
    ...
    rayon_core,
    crablangc_data_structures::fx::FxHashSet,
    crablangc_data_structures::sync::Lock,
    crablangc_data_structures::sync::Lrc,
    crablangc_data_structures::{jobserver, OnDrop},
...
impl<D: DepKind> QueryJob<D> {
    ...
    ///
    /// This does nothing for single threaded crablangc,
