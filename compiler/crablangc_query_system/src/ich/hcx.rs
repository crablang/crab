...
use crablangc_data_structures::stable_hasher::{HashStable, HashingControls, StableHasher};
...
use crablangc_span::{BytePos, CachingSourceMapView, SourceFile, Span, SpanData, DUMMY_SP};
...
impl<'a> crablangc_span::HashStableContext for StableHashingContext<'a> {
    #[inline]
...
impl<'a> crablangc_session::HashStableContext for StableHashingContext<'a> {}
