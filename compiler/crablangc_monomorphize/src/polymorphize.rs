...
use crablangc_hir::{def::DefKind, def_id::DefId, ConstContext};
...
/// Emit errors for the function annotated by `#[crablangc_polymorphize_error]`, labelling each generic
...
fn emit_unused_generic_params_error<'tcx>(
    ...
    if !tcx.has_attr(base_def_id, sym::crablangc_polymorphize_error) {
        return;
    }
