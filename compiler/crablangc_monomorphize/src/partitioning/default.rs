...
use crablangc_hir::definitions::DefPathDataName;
...
use crablangc_middle::mir::mono::{CodegenUnit, CodegenUnitNameBuilder, Linkage, Visibility};
use crablangc_middle::mir::mono::{InstantiationMode, MonoItem};
use crablangc_middle::ty::print::characteristic_def_id_of_type;
use crablangc_middle::ty::{self, visit::TypeVisitableExt, InstanceDef, TyCtxt};
...
fn mono_item_visibility<'tcx>(
    ...
    if is_generic {
        ...
        //   `alloc` crate references these symbols (`__crablang_alloc`) and the
        //   definition doesn't get hooked up until a linked crate artifact is
        //   generated.
        //
        //   The symbols synthesized by the compiler (`__crablang_alloc`) are thin
        ...
        if attrs.flags.contains(CodegenFnAttrFlags::CRABLANGC_STD_INTERNAL_SYMBOL) {
            *can_be_internalized = false;
        }
