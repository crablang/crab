...
use crablangc_hir::def::{DefKind, PartialRes, Res};
use crablangc_hir::GenericArg;
use crablangc_span::symbol::{kw, sym, Ident};
use crablangc_span::{BytePos, Span, DUMMY_SP};
...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
    ...
    fn maybe_insert_elided_lifetimes_in_path(
        ...
        // See crablangc_resolve::late::lifetimes::LifetimeContext::add_missing_lifetime_specifiers_label
