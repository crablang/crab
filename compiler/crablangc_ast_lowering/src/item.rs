...
use crablangc_ast::visit::AssocCtxt;
use crablangc_ast::*;
...
use crablangc_middle::ty::{ResolverAstLowering, TyCtxt};
...
impl<'hir> LoweringContext<'_, 'hir> {
    ...
    fn lower_maybe_async_body(
        ...
        self.lower_body(|this| {
            ...
            // parameters (c.f. crablang/crablang#64512).
            for (index, parameter) in decl.inputs.iter().enumerate() {
                ...
                let (ident, is_simple_parameter) = match parameter.pat.kind {
                    ...
                    // This lets crablangdoc render it correctly in documentation.
                    hir::PatKind::Binding(_, _, ident, _) => (ident, false),
                    hir::PatKind::Wild => {
                        (Ident::with_dummy_span(crablangc_span::symbol::kw::Underscore), false)
                    }
                    _ => {
    ...
    fn error_on_invalid_abi(&self, abi: StrLit) {
        ...
        self.tcx.sess.emit_err(InvalidAbi {
            ...
            command: "crablangc --print=calling-conventions".to_string(),
        });
    }
