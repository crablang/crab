...
use crablangc_hir::def::{DefKind, LifetimeRes, Namespace, PartialRes, PerNS, Res};
use crablangc_hir::def_id::{LocalDefId, CRATE_DEF_ID};
use crablangc_hir::definitions::DefPathData;
use crablangc_hir::{ConstArg, GenericArg, ItemLocalId, ParamName, TraitCandidate};
...
use crablangc_session::parse::{add_feature_diagnostics, feature_err};
use crablangc_span::hygiene::MacroKind;
use crablangc_span::source_map::DesugaringKind;
...
pub fn lower_to_hir(tcx: TyCtxt<'_>, (): ()) -> hir::Crate<'_> {
    ...
    if !sess.opts.unstable_opts.keep_hygiene_data {
        crablangc_span::hygiene::clear_syntax_context_map();
    }
...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
            ...
            TyKind::ImplTrait(def_node_id, bounds) => {
                ...
                match itctx {
                    ...
                    ImplTraitContext::Universal => {
                        ...
                        let ident = Ident::from_str_and_span(&ppcrablang::ty_to_string(t), span);
    ...
    fn lower_opaque_impl_trait(
        ...
        // Not tracking it makes lints in crablangc and clippy very fragile, as
