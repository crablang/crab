//! the crablangc crate store interface. This also includes types that
...
use crablangc_data_structures::sync::{self, AppendOnlyIndexVec, MetadataRef, RwLock};
use crablangc_hir::def_id::{CrateNum, DefId, LocalDefId, StableCrateId, LOCAL_CRATE};
use crablangc_hir::definitions::{DefKey, DefPath, DefPathHash, Definitions};
...
/// metadata in library -- this trait just serves to decouple crablangc_metadata from
...
/// A store of CrabLang crates, through which their metadata can be accessed.
///
