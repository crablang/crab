...
use crablangc_ast::util::literal::LitError;
use crablangc_errors::{error_code, DiagnosticMessage, EmissionGuarantee, IntoDiagnostic, MultiSpan};
use crablangc_macros::Diagnostic;
use crablangc_span::{Span, Symbol};
use crablangc_target::spec::{SplitDebuginfo, StackProtector, TargetTriple};
...
impl<'a, T: EmissionGuarantee> IntoDiagnostic<'a, T> for FeatureGateError {
    ...
    ) -> crablangc_errors::DiagnosticBuilder<'a, T> {
