...
use crablangc_data_structures::sync::{AppendOnlyVec, AtomicBool, Lock, Lrc};
use crablangc_errors::{emitter::SilentEmitter, ColorConfig, Handler};
use crablangc_errors::{
    fallback_fluent_bundle, Diagnostic, DiagnosticBuilder, DiagnosticId, DiagnosticMessage,
    EmissionGuarantee, ErrorGuaranteed, IntoDiagnostic, MultiSpan, Noted, StashKey,
};
use crablangc_feature::{find_feature_issue, GateIssue, UnstableFeatures};
use crablangc_span::edition::Edition;
use crablangc_span::hygiene::ExpnId;
...
/// The `feature`'s `Symbol` is the one you used in `active.rs` and `crablangc_span::symbols`.
pub fn feature_err(
    sess: &ParseSess,
    feature: Symbol,
...
pub fn feature_warn_issue(
    ...
    // Decorate this as a future-incompatibility lint as in crablangc_middle::lint::struct_lint_level
