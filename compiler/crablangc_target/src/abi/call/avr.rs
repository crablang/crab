...
//! adopted in both CrabLang and Clang.
//!
...
//! and CrabLang emit code to the same AVR-GCC compatible ABI.
//!
//! In particular, both Clang and CrabLang may not have the same semantics
...
//! compatible with AVR-GCC - CrabLang and AVR-GCC only differ in the small amount
