...
pub fn opts() -> TargetOptions {
    ...
    TargetOptions {
        ...
        // While we support ELF TLS, crablang requires a way to register
        ...
        // FIXME: Currently, crablang is invoking cc to link, which ends up
        // causing these to get included twice. We should eventually transition
        // to having crablangc invoke ld directly, in which case these will need to
        // be uncommented.
        //
