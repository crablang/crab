...
pub fn target() -> Target {
    ...
    // will trigger an exception. CrabLang does not inject any code that enables AVX/MMX/SSE
    ...
    //   https://github.com/crablang-nursery/compiler-builtins.
    //   As result, crablang-lld generates link error finally.
    // Root-cause:
    //   In crablang\src\llvm-project\llvm\lib\Target\X86\X86ISelLowering.cpp,
