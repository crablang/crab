...
use crablangc_infer::traits::ObligationCauseCode;
use crablangc_middle::ty::query::Providers;
use crablangc_middle::ty::{self, FnSig, Lift, PolyFnSig, Ty, TyCtxt, TypeFoldable};
use crablangc_middle::ty::{ParamEnvAnd, Predicate};
use crablangc_middle::ty::{UserSelfTy, UserSubsts, UserType};
...
use crablangc_trait_selection::traits::query::type_op::ascribe_user_type::AscribeUserType;
use crablangc_trait_selection::traits::query::type_op::eq::Eq;
use crablangc_trait_selection::traits::query::type_op::normalize::Normalize;
use crablangc_trait_selection::traits::query::type_op::prove_predicate::ProvePredicate;
use crablangc_trait_selection::traits::query::type_op::subtype::Subtype;
use crablangc_trait_selection::traits::query::{Fallible, NoSolution};
use crablangc_trait_selection::traits::{Normalized, Obligation, ObligationCause, ObligationCtxt};
use std::fmt;
