...
use crablangc_errors::{DecorateLint, DiagnosticBuilder, DiagnosticMessage, MultiSpan};
...
use crablangc_middle::ty::{RegisteredTools, TyCtxt};
use crablangc_session::lint::builtin::{RENAMED_AND_REMOVED_LINTS, UNKNOWN_LINTS, UNUSED_ATTRIBUTES};
    ...
    fn add(&mut self, attrs: &[ast::Attribute], is_crate_node: bool, source_hir_id: Option<HirId>) {
        ...
        for (attr_index, attr) in attrs.iter().enumerate() {
            ...
            for (lint_index, li) in metas.iter_mut().enumerate() {
                ...
                let name = ppcrablang::path_to_string(&meta_item.path);
                let lint_result =
                ...
                match &lint_result {
                    ...
                    &CheckLintNameResult::NoTool => {
                        sess.emit_err(UnknownToolInScopedLint {
                            ...
                            lint_name: ppcrablang::path_to_string(&meta_item.path),
