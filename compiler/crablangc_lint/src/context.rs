...
use crablangc_ast::util::unicode::TEXT_FLOW_CONTROL_CHARS;
use crablangc_data_structures::fx::FxHashMap;
use crablangc_data_structures::sync;
use crablangc_errors::{add_elided_lifetime_in_path_suggestion, DiagnosticBuilder, DiagnosticMessage};
use crablangc_errors::{Applicability, DecorateLint, MultiSpan, SuggestionStyle};
use crablangc_hir as hir;
use crablangc_hir::def::Res;
use crablangc_hir::def_id::{CrateNum, DefId};
use crablangc_hir::definitions::{DefPathData, DisambiguatedDefPathData};
use crablangc_middle::middle::privacy::EffectiveVisibilities;
use crablangc_middle::middle::stability;
use crablangc_middle::ty::layout::{LayoutError, LayoutOfHelpers, TyAndLayout};
use crablangc_middle::ty::print::with_no_trimmed_paths;
use crablangc_middle::ty::{self, print::Printer, subst::GenericArg, RegisteredTools, Ty, TyCtxt};
use crablangc_session::lint::{BuiltinLintDiagnostics, LintExpectationId};
use crablangc_session::lint::{FutureIncompatibleInfo, Level, Lint, LintBuffer, LintId};
use crablangc_session::Session;
use crablangc_span::edit_distance::find_best_match_for_name;
...
enum TargetLint {
    ...
    ///
    /// This is used by crablangc to avoid warning about old crablangdoc lints before crablangdoc registers them as tool lints.
    Ignored,
}
...
pub enum CheckLintNameResult<'a> {
    ...
    /// returned as if it where a crablangc lint.
...
impl LintStore {
    ...
    ///
    /// * See [crablang#69838](https://github.com/crablang/crablang/pull/69838)
    /// * See [crablang-clippy#5518](https://github.com/crablang/crablang-clippy/pull/5518)
        ...
        for lint in lints {
            ...
            if let Some(FutureIncompatibleInfo { reason, .. }) = lint.future_incompatible {
                if let Some(edition) = reason.edition() {
                    ...
                    // future version of crablangc will cause existing code to stop compiling.
    ...
    pub fn check_lint_name(
        ...
        if let Some(tool_name) = tool_name {
            // FIXME: crablangc and crablangdoc are considered tools for lints, but not for attributes.
            if tool_name != sym::crablangc
                && tool_name != sym::crablangdoc
            ...
            match self.by_name.get(&complete_name) {
                None => match self.lint_groups.get(&*complete_name) {
                    ...
                    None => {
                        ...
                        // FIXME: should this handle tools that never register a lint, like crablangfmt?
                ...
                // to treat tool_lints and crablangc lints different and can use the code below.
                _ => {}
            }
        }
        match self.by_name.get(&complete_name) {
...
pub trait LintContext: Sized {
    ...
    ///
    /// [`struct_lint_level`]: crablangc_middle::lint::struct_lint_level#decorate-signature
        ...
        self.lookup(lint, span, msg,|db| {
            ...
            match diagnostic {
                ...
                BuiltinLintDiagnostics::UnusedDocComment(span) => {
                    db.span_label(span, "crablangdoc does not generate documentation for macro invocations");
                ...
                BuiltinLintDiagnostics::ReservedPrefix(span) => {
                    ...
                    db.span_suggestion_verbose(
                        span.shrink_to_hi(),
                        "insert whitespace here to avoid this being parsed as a prefix in CrabLang 2021",
                        " ",
                        Applicability::MachineApplicable,
                    );
                }
                ...
                BuiltinLintDiagnostics::NamedAsmLabel(help) => {
                    db.help(&help);
                    db.note("see the asm section of CrabLang By Example <https://doc.crablang.org/nightly/crablang-by-example/unsafe/asm.html#labels> for more information");
                },
                ...
                BuiltinLintDiagnostics::DeprecatedWhereclauseLocation(new_span, suggestion) => {
                    ...
                    db.note(
                        "see issue #89122 <https://github.com/crablang/crablang/issues/89122> for more information",
                    );
                },
...
impl<'tcx> LateContext<'tcx> {
    ...
    /// `crablangc_diagnostic_item` or a `lang_item`. This is less prone to errors
    /// as paths get invalidated if the target definition moves.
    ///
    /// # Examples
    ///
    /// ```crablang,ignore (no context or def id available)
