...
use crablangc_session::lint::builtin::HardwiredLints;
use crablangc_session::lint::LintPass;
...
macro_rules! late_lint_methods {
    ($macro:path, $args:tt) => (
        $macro!($args, [
            ...
            fn check_fn(
                a: crablangc_hir::intravisit::FnKind<'tcx>,
...
macro_rules! early_lint_methods {
    ($macro:path, $args:tt) => (
        $macro!($args, [
            ...
            fn check_fn(a: crablangc_ast::visit::FnKind<'_>, c: Span, d_: ast::NodeId);
