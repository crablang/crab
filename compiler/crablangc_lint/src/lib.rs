...
//! all other analyses. The `LintPass`es built into crablangc are defined
//! within [crablangc_session::lint::builtin],
//! which has further comments on how to add such a lint.
//! crablangc can also load user-defined lint plugins via the plugin mechanism.
//!
//! Some of crablangc's lints are defined elsewhere in the compiler and work by
...
//! in `context.rs`.
//!
//! Some code also exists in [crablangc_session::lint], [crablangc_middle::lint].
//!
//! ## Note
//!
...
pub use crablangc_session::lint::Level::{self, *};
pub use crablangc_session::lint::{BufferedEarlyLint, FutureIncompatibleInfo, Lint, LintId};
pub use crablangc_session::lint::{LintArray, LintPass};
...
/// `crablangc_session::lint::builtin`).
fn register_builtins(store: &mut LintStore) {
    ...
    store.register_renamed("disjoint_capture_migration", "crablang_2021_incompatible_closure_captures");
    store.register_renamed("or_patterns_back_compat", "crablang_2021_incompatible_or_patterns");
    store.register_renamed("non_fmt_panic", "non_fmt_panics");

    // These were moved to tool lints, but crablangc still sees them when compiling normally, before
    // tool lints are registered, so `check_tool_name_for_backwards_compat` doesn't work. Use
    // `register_removed` explicitly.
    const CRABLANGDOC_LINTS: &[&str] = &[
    ...
    for crablangdoc_lint in CRABLANGDOC_LINTS {
        store.register_ignored(crablangdoc_lint);
    }
    store.register_removed(
        "intra_doc_link_resolution_failure",
        "use `crablangdoc::broken_intra_doc_links` instead",
    );
    store.register_removed("crablangdoc", "use `crablangdoc::all` instead");
    ...
    store.register_removed(
        ...
        "converted into hard error, see issue #33685 \
         <https://github.com/crablang/crablang/issues/33685> for more information",
    );
    store.register_removed(
        "inaccessible_extern_crate",
        "converted into hard error, see issue #36886 \
         <https://github.com/crablang/crablang/issues/36886> for more information",
    );
    store.register_removed(
        "super_or_self_in_global_path",
        "converted into hard error, see issue #36888 \
         <https://github.com/crablang/crablang/issues/36888> for more information",
    );
    store.register_removed(
        "overlapping_inherent_impls",
        "converted into hard error, see issue #36889 \
         <https://github.com/crablang/crablang/issues/36889> for more information",
    );
    store.register_removed(
        "illegal_floating_point_constant_pattern",
        "converted into hard error, see issue #36890 \
         <https://github.com/crablang/crablang/issues/36890> for more information",
    );
    store.register_removed(
        "illegal_struct_or_enum_constant_pattern",
        "converted into hard error, see issue #36891 \
         <https://github.com/crablang/crablang/issues/36891> for more information",
    );
    store.register_removed(
        "lifetime_underscore",
        "converted into hard error, see issue #36892 \
         <https://github.com/crablang/crablang/issues/36892> for more information",
    );
    store.register_removed(
        "extra_requirement_in_impl",
        "converted into hard error, see issue #37166 \
         <https://github.com/crablang/crablang/issues/37166> for more information",
    );
    store.register_removed(
        "legacy_imports",
        "converted into hard error, see issue #38260 \
         <https://github.com/crablang/crablang/issues/38260> for more information",
    );
    store.register_removed(
        "coerce_never",
        "converted into hard error, see issue #48950 \
         <https://github.com/crablang/crablang/issues/48950> for more information",
    );
    store.register_removed(
    ...
    store.register_removed(
        ...
        "converted into hard error, see issue #57742 \
         <https://github.com/crablang/crablang/issues/57742> for more information",
    );
    store.register_removed(
        "incoherent_fundamental_impls",
        "converted into hard error, see issue #46205 \
         <https://github.com/crablang/crablang/issues/46205> for more information",
    );
    store.register_removed(
        "legacy_constructor_visibility",
        "converted into hard error, see issue #39207 \
         <https://github.com/crablang/crablang/issues/39207> for more information",
    );
    store.register_removed(
        "legacy_directory_ownership",
        "converted into hard error, see issue #37872 \
         <https://github.com/crablang/crablang/issues/37872> for more information",
    );
    store.register_removed(
        "safe_extern_statics",
        "converted into hard error, see issue #36247 \
         <https://github.com/crablang/crablang/issues/36247> for more information",
    );
    store.register_removed(
        "parenthesized_params_in_types_and_modules",
        "converted into hard error, see issue #42238 \
         <https://github.com/crablang/crablang/issues/42238> for more information",
    );
    store.register_removed(
        "duplicate_macro_exports",
        "converted into hard error, see issue #35896 \
         <https://github.com/crablang/crablang/issues/35896> for more information",
    );
    store.register_removed(
        "nested_impl_trait",
        "converted into hard error, see issue #59014 \
         <https://github.com/crablang/crablang/issues/59014> for more information",
    );
    store.register_removed("plugin_as_library", "plugins have been deprecated and retired");
    store.register_removed(
        "unsupported_naked_functions",
        "converted into hard error, see RFC 2972 \
         <https://github.com/crablang/rfcs/blob/master/text/2972-constrained-naked.md> for more information",
    );
    store.register_removed(
        "mutable_borrow_reservation_conflict",
        "now allowed, see issue #59159 \
         <https://github.com/crablang/crablang/issues/59159> for more information",
    );
    store.register_removed(
        "const_err",
        "converted into hard error, see issue #71800 \
         <https://github.com/crablang/crablang/issues/71800> for more information",
    );
    store.register_removed(
        "safe_packed_borrows",
        "converted into hard error, see issue #82523 \
         <https://github.com/crablang/crablang/issues/82523> for more information",
    );
    store.register_removed(
...
fn register_internals(store: &mut LintStore) {
    ...
    // `DIAGNOSTIC_OUTSIDE_OF_IMPL` here because `-Wcrablangc::internal` is provided to every crate and
