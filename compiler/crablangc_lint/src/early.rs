...
use crablangc_ast::visit::{self as ast_visit, Visitor};
use crablangc_ast::{self as ast, walk_list, HasAttrs};
use crablangc_data_structures::stack::ensure_sufficient_stack;
use crablangc_middle::ty::RegisteredTools;
use crablangc_session::lint::{BufferedEarlyLint, LintBuffer, LintPass};
...
#[allow(crablangc::lint_pass_impl_without_macro)]
