//! Lints in the CrabLang compiler.
//!
//! This contains lints which can feasibly be implemented as their own
//! AST visitor. Also see `crablangc_session::lint::builtin`, which contains the
//! definitions of lints that are emitted directly inside the main compiler.
//!
//! To add a new lint to crablangc, declare it here using `declare_lint!()`.
//! Then add code to emit the new lint in the appropriate circumstances.
//! You can do that in an existing `LintPass` if it makes sense, or in a
//! new `LintPass`, or using `Session::add_lint` elsewhere in the
//! compiler. Only do the latter if the check can't be written cleanly as a
//! `LintPass` (also, note that such lints will need to be defined in
//! `crablangc_session::lint::builtin`, not here).
//!
...
use crablangc_ast::visit::{FnCtxt, FnKind};
use crablangc_ast::{self as ast, *};
use crablangc_ast_pretty::ppcrablang::{self, expr_to_string};
use crablangc_data_structures::fx::{FxHashMap, FxHashSet};
use crablangc_data_structures::stack::ensure_sufficient_stack;
use crablangc_errors::{Applicability, DecorateLint, MultiSpan};
use crablangc_feature::{deprecated_attributes, AttributeGate, BuiltinAttribute, GateIssue, Stability};
use crablangc_hir as hir;
use crablangc_hir::def::{DefKind, Res};
use crablangc_hir::def_id::{DefId, LocalDefId, LocalDefIdSet, CRATE_DEF_ID};
use crablangc_hir::intravisit::FnKind as HirFnKind;
use crablangc_hir::{Body, FnDecl, ForeignItemKind, GenericParamKind, Node, PatKind, PredicateOrigin};
use crablangc_middle::lint::in_external_macro;
use crablangc_middle::ty::layout::{LayoutError, LayoutOf};
use crablangc_middle::ty::print::with_no_trimmed_paths;
use crablangc_middle::ty::subst::GenericArgKind;
use crablangc_middle::ty::{self, Instance, Ty, TyCtxt, VariantDef};
use crablangc_session::lint::{BuiltinLintDiagnostics, FutureIncompatibilityReason};
use crablangc_span::edition::Edition;
use crablangc_span::source_map::Spanned;
use crablangc_span::symbol::{kw, sym, Ident, Symbol};
use crablangc_span::{BytePos, InnerSpan, Span};
use crablangc_target::abi::{Abi, FIRST_VARIANT};
use crablangc_trait_selection::infer::{InferCtxtExt, TyCtxtInferExt};
use crablangc_trait_selection::traits::{self, misc::type_allowed_to_implement_copy};

use crate::nonstandard_style::{method_context, MethodLateContext};

use std::fmt::Write;

// hardwired lints from libcrablangc_middle
pub use crablangc_session::lint::builtin::*;
...
declare_lint! {
    ...
    /// allocation. Today's CrabLang can call into other allocators, etc.
    BOX_POINTERS,
    Allow,
...
declare_lint! {
    ...
    ///
    /// [`fmt::Debug`]: https://doc.crablang.org/std/fmt/trait.Debug.html
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
...
declare_lint! {
    ...
    ///
    /// [issue #41686]: https://github.com/crablang/crablang/issues/41686
    /// [`cargo fix`]: https://doc.crablang.org/cargo/commands/cargo-fix.html
    pub ANONYMOUS_PARAMETERS,
    Warn,
    "detects anonymous parameters",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #41686 <https://github.com/crablang/crablang/issues/41686>",
        ...
        if attr.has_name(sym::no_start) || attr.has_name(sym::crate_id) {
            cx.emit_spanned_lint(
                ...
                BuiltinDeprecatedAttrUsed {
                    name: ppcrablang::path_to_string(&attr.get_normal_item().path),
...
declare_lint! {
    ...
    /// [`no_mangle` attribute].
    ///
    /// [`no_mangle` attribute]: https://doc.crablang.org/reference/abi.html#the-no_mangle-attribute
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    /// [`const`]: https://doc.crablang.org/reference/items/constant-items.html
...
declare_lint! {
    ...
    ///
    /// [`UnsafeCell`]: https://doc.crablang.org/std/cell/struct.UnsafeCell.html
    MUTABLE_TRANSMUTES,
    Deny,
...
declare_lint! {
    ...
    ///
    /// [`closure_track_caller` feature flag]: https://doc.crablang.org/beta/unstable-book/language-features/closure-track-caller.html
...
declare_lint! {
    ...
    /// amount existing CrabLang code, and has some false-positives. Eventually it
...
declare_lint! {
    ...
    ///
    /// [RFC 2056]: https://github.com/crablang/rfcs/blob/master/text/2056-allow-trivial-where-clause-constraints.md
    /// [tracking issue #48214]: https://github.com/crablang/crablang/issues/48214
    TRIVIAL_BOUNDS,
    Warn,
...
impl<'tcx> LateLintPass<'tcx> for TrivialConstraints {
    fn check_item(&mut self, cx: &LateContext<'tcx>, item: &'tcx hir::Item<'tcx>) {
        use crablangc_middle::ty::visit::TypeVisitableExt;
        use crablangc_middle::ty::Clause;
        use crablangc_middle::ty::PredicateKind::*;
...
declare_lint! {
    ...
    ///
    /// [`...` range pattern]: https://doc.crablang.org/reference/patterns.html#range-patterns
    ///
    /// ### Example
    ///
    ...
    ///
    /// [`..` range expression]: https://doc.crablang.org/reference/expressions/range-expr.html
...
declare_lint! {
    ...
    ///
    /// [test]: https://doc.crablang.org/reference/attributes/testing.html#the-test-attribute
    ///
    /// ### Example
    ///
    /// ```crablang,test
    ...
    ///
    /// [RFC 2471]: https://github.com/crablang/rfcs/pull/2471#issuecomment-397414443
    /// [issue #36629]: https://github.com/crablang/crablang/issues/36629
...
impl<'tcx> LateLintPass<'tcx> for UnnameableTestItems {
    fn check_item(&mut self, cx: &LateContext<'_>, it: &hir::Item<'_>) {
        ...
        let attrs = cx.tcx.hir().attrs(it.hir_id());
        if let Some(attr) = attr::find_by_name(attrs, sym::crablangc_test_marker) {
...
declare_lint! {
    ...
    /// [raw identifier]: https://doc.crablang.org/reference/identifiers.html
    /// [`cargo fix`]: https://doc.crablang.org/cargo/commands/cargo-fix.html
    pub KEYWORD_IDENTS,
    Allow,
    "detects edition keywords being used as an identifier",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #49716 <https://github.com/crablang/crablang/issues/49716>",
        reason: FutureIncompatibilityReason::EditionError(Edition::Edition2018),
    };
}
        ...
        let next_edition = match cx.sess().edition() {
            Edition::Edition2015 => {
                match ident.name {
                    ...
                    // crablang/crablang#56327: Conservatively do not
                    ...
                    // do not want crablangfix to inject bugs into working
...
impl ExplicitOutlivesRequirements {
    ...
    fn collect_outlives_bound_spans<'tcx>(
        ...
        use crablangc_middle::middle::resolve_bound_vars::ResolvedArg;
...
declare_lint_pass!(
    /// Check for used feature gates in `INCOMPLETE_FEATURES` in `crablangc_feature/src/active.rs`.
...
impl EarlyLintPass for IncompleteFeatures {
    fn check_crate(&mut self, cx: &EarlyContext<'_>, _: &ast::Crate) {
        ...
        features
            ...
            .for_each(|(&name, &span)| {
                let note = crablangc_feature::find_feature_issue(name, GateIssue::Language)
...
declare_lint! {
    ...
    ///
    /// [`mem::zeroed`]: https://doc.crablang.org/std/mem/fn.zeroed.html
    /// [`mem::uninitialized`]: https://doc.crablang.org/std/mem/fn.uninitialized.html
    /// [`mem::transmute`]: https://doc.crablang.org/std/mem/fn.transmute.html
    /// [`MaybeUninit::assume_init`]: https://doc.crablang.org/std/mem/union.MaybeUninit.html#method.assume_init
    /// [undefined behavior]: https://doc.crablang.org/reference/behavior-considered-undefined.html
    pub INVALID_VALUE,
    Warn,
...
impl<'tcx> LateLintPass<'tcx> for DerefNullPtr {
    fn check_expr(&mut self, cx: &LateContext<'tcx>, expr: &hir::Expr<'_>) {
        ...
        fn is_null_ptr(cx: &LateContext<'_>, expr: &hir::Expr<'_>) -> bool {
            match &expr.kind {
                crablangc_hir::ExprKind::Cast(ref expr, ref ty) => {
                    if let crablangc_hir::TyKind::Ptr(_) = ty.kind {
                        return is_zero(expr) || is_null_ptr(cx, expr);
                    }
                }
                // check for call to `core::ptr::null` or `core::ptr::null_mut`
                crablangc_hir::ExprKind::Call(ref path, _) => {
                    if let crablangc_hir::ExprKind::Path(ref qpath) = path.kind {
        ...
        fn is_zero(expr: &hir::Expr<'_>) -> bool {
            match &expr.kind {
                crablangc_hir::ExprKind::Lit(ref lit) => {
        ...
        if let crablangc_hir::ExprKind::Unary(crablangc_hir::UnOp::Deref, expr_deref) = expr.kind {
...
declare_lint! {
    ...
    ///
    /// See the explanation in [CrabLang By Example] for more details.
    ///
    /// [local labels]: https://sourceware.org/binutils/docs/as/Symbol-Names.html#Local-Labels
    /// [CrabLang By Example]: https://doc.crablang.org/nightly/crablang-by-example/unsafe/asm.html#labels
...
impl<'tcx> LateLintPass<'tcx> for NamedAsmLabels {
    #[allow(crablangc::diagnostic_outside_of_impl)]
...
pub use crablangc_session::lint::builtin::UNEXPECTED_CFGS;
