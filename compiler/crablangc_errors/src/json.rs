...
struct Diagnostic {
    ...
    /// The message as crablangc would render it.
...
// NOTE: Keep this in sync with the equivalent structs in crablangdoc's
// doctest component (as well as cargo).
// We could unify this struct the one in crablangdoc but they have different
