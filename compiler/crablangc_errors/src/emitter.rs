//! The current crablangc diagnostics emitter.
//!
...
//!
//! The output types are defined in `crablangc_session::config::ErrorOutputType`.

use Destination::*;

use crablangc_span::source_map::SourceMap;
use crablangc_span::{FileLines, SourceFile, Span};
...
pub trait Emitter: Translate {
    ...
    fn emit_unused_externs(
        &mut self,
        _lint_level: crablangc_lint_defs::Level,
        _unused_externs: &[&str],
    ) {
    }

    /// Checks if should show explanations about "crablangc --explain"
...
/// failures of crablangc, as witnessed e.g. in issue #89358.
...
impl EmitterWriter {
        ...
        if !msp.has_primary_spans() && !msp.has_span_labels() && is_secondary && !self.short_message
        {
            ...
            if let Some(DiagnosticId::Error(ref code)) = *code {
                ...
                let code = if let TerminalUrl::Yes = self.terminal_url {
                    let path = "https://doc.crablang.org/error_codes";
    ...
    fn draw_code_line(
        ...
        if let DisplaySuggestion::Diff = show_code_change {
            ...
            // For more info: https://github.com/crablang/crablang/issues/92741
...
fn emit_to_destination(
    ...
    let _buffer_lock = lock::acquire_global_lock("crablangc_errors");
...
impl Destination {
    fn from_stderr(color: ColorConfig) -> Destination {
        ...
        // system for emitting crablangc errors, so there's no need to buffer
        // anything.
        //
