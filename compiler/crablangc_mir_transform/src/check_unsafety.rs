use crablangc_data_structures::unord::{UnordItems, UnordSet};
use crablangc_errors::struct_span_err;
use crablangc_hir as hir;
use crablangc_hir::def::DefKind;
use crablangc_hir::def_id::{DefId, LocalDefId};
use crablangc_hir::hir_id::HirId;
use crablangc_hir::intravisit;
use crablangc_hir::{BlockCheckMode, ExprKind, Node};
use crablangc_middle::mir::visit::{MutatingUseContext, PlaceContext, Visitor};
use crablangc_middle::mir::*;
use crablangc_middle::ty::query::Providers;
use crablangc_middle::ty::{self, TyCtxt};
use crablangc_session::lint::builtin::{UNSAFE_OP_IN_UNSAFE_FN, UNUSED_UNSAFE};
...
impl<'tcx> Visitor<'tcx> for UnsafetyChecker<'_, 'tcx> {
    ...
    fn visit_place(&mut self, place: &Place<'tcx>, context: PlaceContext, _location: Location) {
        ...
        // <https://github.com/crablang/crablang/pull/78068#issuecomment-731753506>.
