...
//!
//! [`AscribeUserType`]: crablangc_middle::mir::StatementKind::AscribeUserType
//! [`Assign`]: crablangc_middle::mir::StatementKind::Assign
//! [`FakeRead`]: crablangc_middle::mir::StatementKind::FakeRead
//! [`Nop`]: crablangc_middle::mir::StatementKind::Nop
//! [`Shallow`]: crablangc_middle::mir::BorrowKind::Shallow

use crate::MirPass;
use crablangc_middle::mir::{Body, BorrowKind, Rvalue, StatementKind, TerminatorKind};
