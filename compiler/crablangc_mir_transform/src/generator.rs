...
use crablangc_errors::pluralize;
use crablangc_hir as hir;
use crablangc_hir::lang_items::LangItem;
use crablangc_hir::GeneratorKind;
use crablangc_index::bit_set::{BitMatrix, BitSet, GrowableBitSet};
use crablangc_index::vec::{Idx, IndexVec};
use crablangc_middle::mir::dump_mir;
use crablangc_middle::mir::visit::{MutVisitor, PlaceContext, Visitor};
use crablangc_middle::mir::*;
use crablangc_middle::ty::{self, AdtDef, Ty, TyCtxt};
use crablangc_middle::ty::{GeneratorSubsts, SubstsRef};
use crablangc_mir_dataflow::impls::{
    MaybeBorrowedLocals, MaybeLiveLocals, MaybeRequiresStorage, MaybeStorageLive,
};
use crablangc_mir_dataflow::storage::always_storage_live_locals;
use crablangc_mir_dataflow::{self, Analysis};
...
/// See <https://github.com/crablang/crablang/issues/105501>.
///
...
fn locals_live_across_suspend_points<'tcx>(
    ...
    let mut borrowed_locals_cursor =
        crablangc_mir_dataflow::ResultsCursor::new(body_ref, &borrowed_locals_results);
    ...
    let mut requires_storage_cursor =
        crablangc_mir_dataflow::ResultsCursor::new(body_ref, &requires_storage_results);
...
fn compute_storage_conflicts<'mir, 'tcx>(
    ...
    saved_locals: &GeneratorSavedLocals,
    always_live_locals: BitSet<Local>,
    requires_storage: crablangc_mir_dataflow::Results<'tcx, MaybeRequiresStorage<'mir, 'tcx>>,
...
impl<'mir, 'tcx> crablangc_mir_dataflow::ResultsVisitor<'mir, 'tcx>
...
fn elaborate_generator_drops<'tcx>(tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) {
    ...
    use crablangc_mir_dataflow::elaborate_drops::{elaborate_drop, Unwind};
...
fn create_generator_resume_function<'tcx>(
    ...
    use crablangc_middle::mir::AssertKind::{ResumedAfterPanic, ResumedAfterReturn};
...
///
/// [#73137]: https://github.com/crablang/crablang/issues/73137
...
fn check_must_not_suspend_def(
    ...
    if let Some(attr) = tcx.get_attr(def_id, sym::must_not_suspend) {
        let msg = crablangc_errors::DelayDm(|| {
            format!(
        ...
        tcx.struct_span_lint_hir(
            crablangc_session::lint::builtin::MUST_NOT_SUSPEND,
            hir_id,
            data.source_span,
            msg,
            |lint| {
