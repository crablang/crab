...
use crablangc_middle::ty::layout::{LayoutError, LayoutOf, LayoutOfHelpers, TyAndLayout};
use crablangc_middle::ty::InternalSubsts;
use crablangc_middle::ty::{self, ConstKind, Instance, ParamEnv, Ty, TyCtxt, TypeVisitableExt};
use crablangc_span::{def_id::DefId, Span, DUMMY_SP};
use crablangc_target::abi::{self, Align, HasDataLayout, Size, TargetDataLayout};
use crablangc_target::spec::abi::Abi as CallAbi;
use crablangc_trait_selection::traits;

use crate::MirPass;
use crablangc_const_eval::interpret::{
...
macro_rules! throw_machine_stop_str {
    ($($tt:tt)*) => {{
        ...
        impl crablangc_middle::mir::interpret::MachineStopType for Zst {}
...
impl<'mir, 'tcx> interpret::Machine<'mir, 'tcx> for ConstPropMachine<'mir, 'tcx> {
    ...
    fn assert_panic(
        ...
        _unwind: crablangc_middle::mir::UnwindAction,
    ) -> InterpResult<'tcx> {
...
impl<'mir, 'tcx> ConstPropagator<'mir, 'tcx> {
    ...
    fn check_rvalue(&mut self, rvalue: &Rvalue<'tcx>) -> Option<()> {
            ...
            .is_sized(*self.ecx.tcx, self.param_env)
        {
            ...
            // but crablangc does (in a kinda broken way), so we have to skip them here
            return None;
        }
...
impl Visitor<'_> for CanConstProp {
    fn visit_local(&mut self, local: Local, context: PlaceContext, _: Location) {
        use crablangc_middle::mir::visit::PlaceContext::*;
        match context {
