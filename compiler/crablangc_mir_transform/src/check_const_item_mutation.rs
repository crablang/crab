use crablangc_errors::{DiagnosticBuilder, DiagnosticMessage};
use crablangc_middle::mir::visit::Visitor;
use crablangc_middle::mir::*;
use crablangc_middle::ty::TyCtxt;
use crablangc_session::lint::builtin::CONST_ITEM_MUTATION;
...
impl<'tcx> ConstMutationChecker<'_, 'tcx> {
    ...
    fn is_const_item_without_destructor(&self, local: Local) -> Option<DefId> {
        ...
        //
        // FIXME(https://github.com/crablang/crablang/issues/77425):
