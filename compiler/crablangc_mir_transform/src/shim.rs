...
use crablangc_middle::ty::{self, EarlyBinder, GeneratorSubsts, Ty, TyCtxt};
...
use crablangc_mir_dataflow::elaborate_drops::{self, DropElaborator, DropFlagMode, DropStyle};
...
fn build_call_shim<'tcx>(
    ...
    if let Abi::CrabLangCall = sig.abi {
