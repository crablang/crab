...
use crablangc_middle::mir::spanview::source_range_no_file;
use crablangc_middle::mir::{
    self, AggregateKind, BasicBlock, FakeReadCause, Rvalue, Statement, StatementKind, Terminator,
    TerminatorKind,
};
use crablangc_middle::ty::TyCtxt;
use crablangc_span::source_map::original_sp;
use crablangc_span::{BytePos, ExpnKind, MacroKind, Span, Symbol};
...
///
/// [^1]Expansions result from CrabLang syntax including macros, syntactic sugar,
/// etc.).
#[inline]
