...
use crablangc_span::{CharPos, ExpnKind, Pos, SourceFile, Span, Symbol};
...
impl<'tcx> MirPass<'tcx> for InstrumentCoverage {
    ...
    fn run_pass(&self, tcx: TyCtxt<'tcx>, mir_body: &mut mir::Body<'tcx>) {
        ...
        // See: https://github.com/crablang/crablang/pull/73011#discussion_r438317601
...
fn fn_sig_and_body(
    tcx: TyCtxt<'_>,
    def_id: DefId,
) -> (Option<&crablangc_hir::FnSig<'_>>, &crablangc_hir::Body<'_>) {
...
fn get_body_span<'tcx>(
    tcx: TyCtxt<'tcx>,
    hir_body: &crablangc_hir::Body<'tcx>,
...
fn hash_mir_source<'tcx>(tcx: TyCtxt<'tcx>, hir_body: &'tcx crablangc_hir::Body<'tcx>) -> u64 {
