...
use crablangc_middle::mir::visit::Visitor as _;
...
use crablangc_const_eval::transform::check_consts::{self, ConstCx};
use crablangc_const_eval::transform::promote_consts;
use crablangc_const_eval::transform::validate;
use crablangc_mir_dataflow::crablangc_peek;
...
fn mir_const(tcx: TyCtxt<'_>, def: ty::WithOptConstParam<LocalDefId>) -> &Steal<Body<'_>> {
    ...
    pm::run_passes(
        ...
        &[
            ...
            &crablangc_peek::SanityCheck, // Just a lint
        ],
        None,
    );
