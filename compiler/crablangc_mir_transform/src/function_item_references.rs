...
use crablangc_middle::ty::{self, EarlyBinder, GenericArgKind, PredicateKind, SubstsRef, Ty, TyCtxt};
use crablangc_session::lint::builtin::FUNCTION_ITEM_REFERENCES;
