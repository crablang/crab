...
use crablangc_hir::FnRetTy;
use crablangc_macros::{Diagnostic, Subdiagnostic};
use crablangc_middle::ty::print::TraitRefPrintOnlyTraitPath;
use crablangc_middle::ty::{Binder, FnSig, Region, Ty, TyCtxt};
use crablangc_span::symbol::kw;
use crablangc_span::Symbol;
use crablangc_span::{symbol::Ident, BytePos, Span};
...
impl AddToDiagnostic for MoreTargeted {
    ...
    where
        F: Fn(&mut Diagnostic, SubdiagnosticMessage) -> SubdiagnosticMessage,
    {
        diag.code(crablangc_errors::error_code!(E0772));
