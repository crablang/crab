...
use crablangc_middle::ty::subst::{GenericArg, GenericArgKind};
use crablangc_middle::ty::{self, BoundVar, ToPredicate, Ty, TyCtxt};
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    ///
    /// [c]: https://crablang.github.io/chalk/book/canonical_queries/canonicalization.html#processing-the-canonicalized-query-result
