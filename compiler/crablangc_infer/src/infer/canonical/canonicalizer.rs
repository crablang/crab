...
//! crablangc, check out the [chapter in the crablangc dev guide][c].
//!
...
use crablangc_middle::ty::flags::FlagComputation;
use crablangc_middle::ty::fold::{TypeFoldable, TypeFolder, TypeSuperFoldable};
use crablangc_middle::ty::subst::GenericArg;
use crablangc_middle::ty::{self, BoundVar, InferConst, List, Ty, TyCtxt, TypeFlags, TypeVisitableExt};
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    /// out the [chapter in the crablangc dev guide][c].
    ///
    /// [c]: https://crablang.github.io/chalk/book/canonical_queries/canonicalization.html#canonicalizing-the-query
    ...
    /// out the [chapter in the crablangc dev guide][c].
    ///
    /// [c]: https://crablang.github.io/chalk/book/canonical_queries/canonicalization.html#canonicalizing-the-query-result
    ...
    fn canonicalize_free_region<'tcx>(
        ...
        match *r {
            ...
            _ => {
                ...
                //
                // crablang/crablang#57464: `impl Trait` can leak local
