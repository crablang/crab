...
use crablangc_middle::ty::{self, Ty, TyVid};
use crablangc_span::symbol::Symbol;
use crablangc_span::Span;

use crate::infer::InferCtxtUndoLogs;

use crablangc_data_structures::snapshot_vec as sv;
use crablangc_data_structures::unify as ut;
use std::cmp;
use std::marker::PhantomData;
use std::ops::Range;

use crablangc_data_structures::undo_log::{Rollback, UndoLogs};
...
pub struct TypeVariableStorage<'tcx> {
    ...
    ///
    /// This is reasonable because, in CrabLang, subtypes have the same
...
impl<'tcx> TypeVariableTable<'_, 'tcx> {
    ...
    ///   variable is diverging, but the main CrabLang type-checker will
