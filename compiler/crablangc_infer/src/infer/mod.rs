...
use crablangc_data_structures::undo_log::Rollback;
use crablangc_data_structures::unify as ut;
use crablangc_errors::{DiagnosticBuilder, ErrorGuaranteed};
use crablangc_hir::def_id::{DefId, LocalDefId};
use crablangc_middle::infer::canonical::{Canonical, CanonicalVarValues};
use crablangc_middle::infer::unify_key::{ConstVarValue, ConstVariableValue};
use crablangc_middle::infer::unify_key::{ConstVariableOrigin, ConstVariableOriginKind, ToType};
use crablangc_middle::mir::interpret::{ErrorHandled, EvalToValTreeResult};
use crablangc_middle::mir::ConstraintCategory;
use crablangc_middle::traits::select;
use crablangc_middle::ty::error::{ExpectedFound, TypeError};
use crablangc_middle::ty::fold::BoundVarReplacerDelegate;
use crablangc_middle::ty::fold::{TypeFoldable, TypeFolder, TypeSuperFoldable};
use crablangc_middle::ty::relate::RelateResult;
use crablangc_middle::ty::subst::{GenericArg, GenericArgKind, InternalSubsts, SubstsRef};
use crablangc_middle::ty::visit::{TypeVisitable, TypeVisitableExt};
pub use crablangc_middle::ty::IntVarValue;
use crablangc_middle::ty::{self, GenericParamDefKind, InferConst, InferTy, Ty, TyCtxt};
use crablangc_middle::ty::{ConstVid, FloatVid, IntVid, TyVid};
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    pub fn skip_region_resolution(&self) {
        ...
        let lexical_region_resolutions = LexicalRegionResolutions {
            values: crablangc_index::vec::IndexVec::from_elem_n(
    ...
    pub fn resolve_regions_and_report_errors(
        ...
        if errors.is_empty() {
            ...
            Err(self
                .tcx
                .sess
                .delay_span_bug(crablangc_span::DUMMY_SP, "error should have been emitted"))
        }
    }
