...
use crablangc_data_structures::undo_log::UndoLogs;
use crablangc_data_structures::unify as ut;
use crablangc_index::vec::IndexVec;
use crablangc_middle::infer::unify_key::{RegionVidKey, UnifiedRegion};
use crablangc_middle::ty::ReStatic;
use crablangc_middle::ty::{self, Ty, TyCtxt};
use crablangc_middle::ty::{ReLateBound, ReVar};
use crablangc_middle::ty::{Region, RegionVid};
...
pub use crablangc_middle::infer::MemberConstraint;
...
impl<'tcx> RegionConstraintCollector<'_, 'tcx> {
    ...
    pub fn opportunistic_resolve_var(
        ...
        let mut ut = self.unification_table_mut(); // FIXME(crablang/ena#42): unnecessary mut
