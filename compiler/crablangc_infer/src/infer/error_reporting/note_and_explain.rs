...
use crablangc_errors::Applicability::{MachineApplicable, MaybeIncorrect};
use crablangc_errors::{pluralize, Diagnostic, MultiSpan};
use crablangc_hir as hir;
use crablangc_middle::traits::ObligationCauseCode;
use crablangc_middle::ty::error::ExpectedFound;
use crablangc_middle::ty::print::Printer;
use crablangc_middle::{
    traits::ObligationCause,
    ty::{self, error::TypeError, print::FmtPrinter, suggest_constraining_type_param, Ty},
};
use crablangc_span::{def_id::DefId, sym, BytePos, Span, Symbol};
...
```",
                    ...
                    (_, ty::Alias(ty::Projection, proj_ty)) if !tcx.is_impl_trait_in_trait(proj_ty.def_id) => {
                        ...
                        if !(self.suggest_constraining_opaque_associated_type(
                            ...
                            diag.note(
                                "for more information, visit \
                                https://doc.crablang.org/book/ch19-03-advanced-traits.html",
                            );
                        }
                    }
