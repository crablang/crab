...
use crablangc_middle::ty::print::{FmtPrinter, Print, RegionHighlightMode};
use crablangc_middle::ty::subst::SubstsRef;
use crablangc_middle::ty::{self, RePlaceholder, Region, TyCtxt};
    ...
    T: for<'a> Print<'tcx, FmtPrinter<'a, 'tcx>, Error = fmt::Error, Output = FmtPrinter<'a, 'tcx>>,
{
    fn into_diagnostic_arg(self) -> crablangc_errors::DiagnosticArgValue<'static> {
        crablangc_errors::DiagnosticArgValue::Str(self.to_string().into())
    }
}
