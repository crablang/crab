...
use crablangc_middle::ty::{self, Binder, TyCtxt, TypeFoldable};
...
impl<'a, 'tcx> CombineFields<'a, 'tcx> {
    ...
    /// the [crablangc dev guide][rd]
    ///
    /// [rd]: https://crablangc-dev-guide.crablang.org/borrow_check/region_inference/placeholders_and_universes.html
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    /// For more details visit the relevant sections of the [crablangc dev guide].
    ///
