...
// benchmarks like `crablangc-perf`'s inflate and keccak.
#[repr(C)]
#[derive(Debug)]
...
pub struct ObligationForest<O: ForestObligation> {
    ...
    /// [`crablangc_index::newtype_index!`] indices, because this code is hot enough
    ...
    ///
    /// [details]: https://github.com/crablang/crablang/pull/53255#issuecomment-421184780
