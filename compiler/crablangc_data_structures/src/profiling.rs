//! # CrabLang Compiler Self-Profiling
//!
...
//!
//! [mm]: https://github.com/crablang/measureme/
...
// keep this in sync with the `-Z self-profile-events` help message in crablangc_session/options.rs
...
impl SelfProfilerRef {
    ...
    ///
    /// This `EventArgRecorder` may implement more specific traits from other crablangc crates, e.g. for
    /// richer handling of crablangc-specific argument types, while keeping this single entry-point API
...
impl SelfProfiler {
    pub fn new(
        ...
        let filename = format!("{crate_name}-{pid:07}.crablangc_profile");
