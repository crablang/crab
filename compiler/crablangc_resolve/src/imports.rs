...
use crablangc_errors::{pluralize, struct_span_err, Applicability, MultiSpan};
use crablangc_hir::def::{self, DefKind, PartialRes};
...
use crablangc_span::hygiene::LocalExpnId;
