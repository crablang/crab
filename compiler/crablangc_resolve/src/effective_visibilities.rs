...
use crablangc_ast::Crate;
use crablangc_ast::EnumDef;
...
use crablangc_middle::middle::privacy::{EffectiveVisibilities, EffectiveVisibility};
...
impl<'r, 'ast, 'tcx> Visitor<'ast> for EffectiveVisibilitiesVisitor<'ast, 'r, 'tcx> {
    fn visit_item(&mut self, item: &'ast ast::Item) {
        ...
        match item.kind {
            // Resolved in crablangc_privacy when types are available
