...
ast_passes_extern_keyword_link = for more information, visit https://doc.crablang.org/std/keyword.extern.html
...
ast_passes_extern_item_ascii = items in `extern` blocks cannot use non-ascii identifiers
    .label = in this `extern` block
    .note = this limitation may be lifted in the future; see issue #83942 <https://github.com/crablang/crablang/issues/83942> for more information
...
ast_passes_where_after_type_alias = where clauses are not allowed after the type for type aliases
    .note = see issue #89122 <https://github.com/crablang/crablang/issues/89122> for more information
...
ast_passes_equality_in_where = equality constraints are not yet supported in `where` clauses
    ...
    .note = see issue #20041 <https://github.com/crablang/crablang/issues/20041> for more information
