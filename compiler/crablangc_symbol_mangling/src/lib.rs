//! The CrabLang Linkage Model and Symbol Names
//! =======================================
//!
//! The semantic model of CrabLang linkage is, broadly, that "there's no global
...
//!
//! - CrabLang allows items to be defined in anonymous scopes, such as in
...
use crablangc_middle::ty::{self, Instance, TyCtxt};
...
fn compute_symbol_name<'tcx>(
    ...
    debug_assert!(
        crablangc_demangle::try_demangle(&symbol).is_ok(),
