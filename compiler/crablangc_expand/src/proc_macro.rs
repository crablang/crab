...
use crablangc_session::config::ProcMacroExecutionStrategy;
use crablangc_span::profiling::SpannedEventArgRecorder;
...
impl base::BangProcMacro for BangProcMacro {
    fn expand<'cx>(
        ...
        let server = proc_macro_server::CrabLangc::new(ecx);
...
impl MultiItemModifier for DeriveProcMacro {
    fn expand(
        ...
        let mut parser =
            crablangc_parse::stream_to_parser(&ecx.sess.parse_sess, stream, Some("proc-macro derive"));
        let mut items = vec![];
