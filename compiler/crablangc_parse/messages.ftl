...
parse_invalid_literal_suffix_on_tuple_index = suffixes on a tuple index are invalid
    ...
    .tuple_exception_line_3 = see issue #60210 <https://github.com/crablang/crablang/issues/60210> for more information
...
parse_async_fn_in_2015 = `async fn` is not permitted in CrabLang 2015
    .label = to use `async fn`, switch to CrabLang 2018 or later

parse_async_block_in_2015 = `async` blocks are only allowed in CrabLang 2018 or later
...
parse_extern_item_cannot_be_const = extern items cannot be `const`
    ...
    .note = for more information, visit https://doc.crablang.org/std/keyword.extern.html
...
parse_help_set_edition_standalone = pass `--edition {$edition}` to `crablangc`
parse_note_edition_guide = for more on editions, read https://doc.crablang.org/edition-guide
...
parse_unknown_prefix = prefix `{$prefix}` is unknown
    ...
    .note =  prefixed identifiers and literals are reserved since CrabLang 2021
