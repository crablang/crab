...
use crablangc_span::{symbol::kw, BytePos, Pos, Span};

#[crablangfmt::skip] // for line breaks
...
// keeping the substitution token in this table. Ideally, this should be inside `crablangc_lexer`.
// However, we should first remove compound tokens like `<<` from `crablangc_lexer`, and then add
