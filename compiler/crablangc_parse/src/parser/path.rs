...
use crablangc_errors::{pluralize, Applicability, PResult};
...
impl<'a> Parser<'a> {
    ...
    pub(super) fn expr_is_valid_const_arg(&self, expr: &P<crablangc_ast::Expr>) -> bool {
        match &expr.kind {
            ...
            // require type-checking: see `visit_generic_arg` in `src/libcrablangc_resolve/late.rs`.
