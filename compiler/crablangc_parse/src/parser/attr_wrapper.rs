...
use crablangc_ast::tokenstream::{AttrTokenStream, AttributesData, ToAttrTokenStream};
use crablangc_ast::tokenstream::{AttrTokenTree, DelimSpan, LazyAttrTokenStream, Spacing};
use crablangc_ast::{self as ast};
use crablangc_ast::{AttrVec, Attribute, HasAttrs, HasTokens};
...
fn make_token_stream(
    ...
    if break_last_token {
        ...
        if let AttrTokenTree::Token(last_token, spacing) = last_token {
            ...
            first_span = first_span.with_hi(first_span.lo() + crablangc_span::BytePos(1));
