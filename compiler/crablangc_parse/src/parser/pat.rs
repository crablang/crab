...
use crablangc_ast::mut_visit::{noop_visit_pat, MutVisitor};
...
use crablangc_errors::{Applicability, DiagnosticBuilder, ErrorGuaranteed, IntoDiagnostic, PResult};
use crablangc_session::errors::ExprParenthesesNeeded;
use crablangc_span::source_map::{respan, Span, Spanned};
...
impl<'a> Parser<'a> {
    ...
    ///
    /// Note that after the FCP in <https://github.com/crablang/crablang/issues/81415>,
    ...
    fn parse_pat_allow_top_alt_inner(
        ...
        // suggestions (which bothers crablangfix).
        //
    ...
    pub(super) fn parse_pat_before_ty(
        ...
        if let PatKind::Or(pats) = &pat.kind {
            ...
            if trailing_vert {
                ...
                let pat = ppcrablang::pat_to_string(&pat);
        ...
        if let PatKind::Ident(_, _, sub @ None) = &mut rhs.kind {
            ...
            *sub = Some(lhs);
            ...
            self.sess.emit_err(PatternOnWrongSideOfAt {
                whole_span,
                whole_pat: ppcrablang::pat_to_string(&rhs),
                pattern: lhs_span,
                binding: rhs.span,
            });
        } else {
    ...
    fn ban_pat_range_if_ambiguous(&self, pat: &Pat) {
        ...
        self.sess
            .emit_err(AmbiguousRangePattern { span: pat.span, pat: ppcrablang::pat_to_string(&pat) });
    }
    ...
    pub(super) fn inclusive_range_with_incorrect_end(&mut self) {
        ...
        match tok.kind {
            ...
            token::Gt if no_space => {
                let after_pat = span.with_hi(span.hi() - crablangc_span::BytePos(1)).shrink_to_hi();
    ...
    fn recover_bad_dot_dot(&self) {
        ...
        let token_str = ppcrablang::token_to_string(&self.token);
