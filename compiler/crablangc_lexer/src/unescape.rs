        ...
        let res = match c {
            '\\' => {
                match chars.clone().next() {
                    Some('\n') => {
                        // CrabLang language specification requires us to skip whitespaces
                        // if unescaped '\' character is followed by '\n'.
                        // For details see [CrabLang language reference]
                        // (https://doc.crablang.org/reference/tokens.html#string-literals).
