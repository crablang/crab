...
fn test_unterminated_no_pound() {
    // https://github.com/crablang/crablang/issues/70677
    check_raw_str(
        r#"""#,
...
fn test_valid_shebang() {
    // https://github.com/crablang/crablang/issues/70528
    let input = "#!/usr/bin/crablangrun\nlet x = 5;";
    assert_eq!(strip_shebang(input), Some(18));
}

#[test]
fn test_invalid_shebang_valid_crablang_syntax() {
    // https://github.com/crablang/crablang/issues/70528
...
#[test]
fn test_shebang_valid_crablang_after() {
    let input = "#!/*bin/ami/a/comment*/\npub fn main() {}";
...
fn test_shebang_followed_by_attrib() {
    let input = "#!/bin/crablang-scripts\n#![allow_unused(true)]";
