...
#[cfg(feature="master")]
use crablangc_middle::mir::mono::Visibility;
use crablangc_middle::mir::mono::Linkage;
use crablangc_codegen_ssa::{ModuleCodegen, ModuleKind};
use crablangc_codegen_ssa::base::maybe_create_entry_wrapper;
use crablangc_codegen_ssa::mono_item::MonoItemExt;
use crablangc_codegen_ssa::traits::DebugInfoMethods;
...
pub fn compile_codegen_unit(tcx: TyCtxt<'_>, cgu_name: Symbol, supports_128bit_integers: bool) -> (ModuleCodegen<GccContext>, u64) {
    ...
    fn module_codegen(tcx: TyCtxt<'_>, (cgu_name, supports_128bit_integers): (Symbol, bool)) -> ModuleCodegen<GccContext> {
        ...
        // NOTE: This is needed to compile the file src/intrinsic/archs.rs during a bootstrap of crablangc.
        context.add_command_line_option("-fno-var-tracking-assignments");
        // NOTE: an optimization (https://github.com/crablang/crablangc_codegen_gcc/issues/53).
        context.add_command_line_option("-fno-semantic-interposition");
        // NOTE: CrabLang relies on LLVM not doing TBAA (https://github.com/crablang/unsafe-code-guidelines/issues/292).
        context.add_command_line_option("-fno-strict-aliasing");
        // NOTE: CrabLang relies on LLVM doing wrapping on overflow.
