...
use crablangc_codegen_ssa::traits::{BaseTypeMethods, DerivedTypeMethods, TypeMembershipMethods};
...
impl<'gcc, 'tcx> CodegenCx<'gcc, 'tcx> {
    pub fn type_ix(&self, num_bits: u64) -> Type<'gcc> {
        ...
        // FIXME(antoyo): this is misleading to use the next power of two as crablangc_codegen_ssa
