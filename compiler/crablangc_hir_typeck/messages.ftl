...
hir_typeck_help_set_edition_standalone = pass `--edition {$edition}` to `crablangc`
hir_typeck_note_edition_guide = for more on editions, read https://doc.crablang.org/edition-guide
