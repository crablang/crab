...
use crablangc_infer::infer::{DefineOpaqueTypes, LateBoundRegionConversionTime};
use crablangc_infer::infer::{InferOk, InferResult};
...
use crablangc_middle::ty::{self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitor};
...
use crablangc_trait_selection::traits::error_reporting::ArgKind;
use crablangc_trait_selection::traits::error_reporting::InferCtxtExt as _;
use std::cmp;
use std::iter;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn merge_supplied_sig_with_expectation(
        ...
        // error.
        //
        // [c1]: https://github.com/crablang/crablang/pull/45072#issuecomment-341089706
        // [c2]: https://github.com/crablang/crablang/pull/45072#issuecomment-341096796
        self.commit_if_ok(|_| {
