//! Method lookup: the secret sauce of CrabLang. See the [crablangc dev guide] for more information.
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/method-lookup.html
...
use crablangc_infer::infer::{self, InferOk};
use crablangc_middle::traits::ObligationCause;
use crablangc_middle::ty::subst::{InternalSubsts, SubstsRef};
use crablangc_middle::ty::{self, GenericParamDefKind, Ty, TypeVisitableExt};
use crablangc_span::symbol::Ident;
use crablangc_span::Span;
use crablangc_trait_selection::traits::query::evaluate_obligation::InferCtxtExt;
use crablangc_trait_selection::traits::{self, NormalizeExt};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    /// function definition.
    ///
    /// [full-qualified function call]: https://doc.crablang.org/reference/expressions/call-expr.html#disambiguating-function-calls
    ///
    /// # Arguments
    ///
