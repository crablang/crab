...
use crablangc_hir::GenericArg;
use crablangc_hir_analysis::astconv::generics::{
    check_generic_arg_count_for_call, create_substs_for_generic_args,
};
use crablangc_hir_analysis::astconv::{AstConv, CreateSubstsForGenericArgsCtxt, IsMethodCall};
use crablangc_infer::infer::{self, DefineOpaqueTypes, InferOk};
use crablangc_middle::traits::{ObligationCauseCode, UnifyReceiverContext};
use crablangc_middle::ty::adjustment::{Adjust, Adjustment, PointerCast};
use crablangc_middle::ty::adjustment::{AllowTwoPhase, AutoBorrow, AutoBorrowMutability};
use crablangc_middle::ty::fold::TypeFoldable;
use crablangc_middle::ty::subst::{self, SubstsRef};
use crablangc_middle::ty::{self, GenericParamDefKind, Ty, TyCtxt};
use crablangc_middle::ty::{InternalSubsts, UserSubsts, UserType};
