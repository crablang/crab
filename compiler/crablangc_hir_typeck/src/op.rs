...
use crablangc_errors::{self, struct_span_err, Applicability, Diagnostic};
...
use crablangc_trait_selection::traits::error_reporting::suggestions::TypeErrCtxtExt as _;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn enforce_builtin_binop_types(
        ...
        // (See https://github.com/crablang/crablang/issues/57447.)
    ...
    fn check_overloaded_binop(
        ...
        let lhs_ty = match is_assign {
            ...
            IsAssign::Yes => {
                // crablang/crablang#52126: We have to use strict
...
fn lang_item_for_op(
    ...
    op: Op,
    span: Span,
) -> (crablangc_span::Symbol, Option<hir::def_id::DefId>) {
