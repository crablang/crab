...
pub use crablangc_middle::hir::place::{Place, PlaceBase, PlaceWithHirId, Projection};
...
use crablangc_middle::ty::{self, adjustment, AdtKind, Ty, TyCtxt};
                ...
                match fake_read.base {
                    PlaceBase::Upvar(upvar_id) => {
                        if upvar_is_local_variable(
                            ...
                            //
                            // ```crablang,ignore(cannot-test-this-because-pseudo-code)
                            // let v1 = (0, 1);
                            // let c = || { // fake reads: v1
                            //    let v2 = (0, 1);
