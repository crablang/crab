...
use crablangc_errors::{struct_span_err, Applicability, Diagnostic, ErrorGuaranteed, StashKey};
use crablangc_hir as hir;
use crablangc_hir::def::{self, CtorKind, Namespace, Res};
use crablangc_hir::def_id::DefId;
use crablangc_hir_analysis::autoderef::Autoderef;
use crablangc_infer::{
    infer,
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn confirm_builtin_call(
        ...
        let (fn_sig, def_id) = match *callee_ty.kind() {
            ty::FnDef(def_id, subst) => {
                ...
                // `#[crablangc_evaluate_where_clauses]` trigger special output
                // to let us test the trait evaluation system.
                if self.tcx.has_attr(def_id, sym::crablangc_evaluate_where_clauses) {
    ...
    fn report_invalid_callee(
            ...
            && arg_exprs.is_empty()
        {
            ...
            unit_variant = Some((removal_span, descr, crablangc_hir_pretty::qpath_to_string(qpath)));
        }
