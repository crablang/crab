...
use crablangc_middle::ty::cast::{CastKind, CastTy};
use crablangc_middle::ty::error::TypeError;
use crablangc_middle::ty::{self, Ty, TypeAndMut, TypeVisitableExt, VariantDef};
use crablangc_session::lint;
use crablangc_session::Session;
use crablangc_span::def_id::{DefId, LOCAL_CRATE};
...
impl<'a, 'tcx> CastCheck<'tcx> {
    ...
    fn report_cast_error(&self, fcx: &FnCtxt<'a, 'tcx>, e: CastError) {
        match e {
            ...
            CastError::SizedUnsizedCast => {
                use crablangc_hir_analysis::structured_errors::{
    ...
    pub fn do_check(&self, fcx: &FnCtxt<'a, 'tcx>) -> Result<CastKind, CastError> {
        ...
        use crablangc_middle::ty::cast::IntTy::*;
    ...
    fn lossy_provenance_ptr2int_lint(&self, fcx: &FnCtxt<'a, 'tcx>, t_c: ty::cast::IntTy) {
        fcx.tcx.struct_span_lint_hir(
            ...
            |lint| {
                ...
                let needs_parens = expr_prec < crablangc_ast::util::parser::PREC_POSTFIX;
