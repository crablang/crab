...
use crablangc_errors::{Applicability, Diagnostic, ErrorGuaranteed, MultiSpan};
use crablangc_hir as hir;
use crablangc_hir::def::{CtorOf, DefKind, Res};
use crablangc_hir::def_id::DefId;
use crablangc_hir::lang_items::LangItem;
use crablangc_hir::{ExprKind, GenericArg, Node, QPath};
use crablangc_hir_analysis::astconv::generics::{
    check_generic_arg_count_for_call, create_substs_for_generic_args,
};
use crablangc_hir_analysis::astconv::{
    AstConv, CreateSubstsForGenericArgsCtxt, ExplicitLateBound, GenericArgCountMismatch,
    GenericArgCountResult, IsMethodCall, PathSeg,
};
use crablangc_infer::infer::canonical::{Canonical, OriginalQueryValues, QueryResponse};
use crablangc_infer::infer::error_reporting::TypeAnnotationNeeded::E0282;
use crablangc_infer::infer::{DefineOpaqueTypes, InferResult};
...
use crablangc_middle::ty::{GenericArgKind, SubstsRef, UserSelfTy, UserSubsts};
...
use crablangc_trait_selection::traits::{self, NormalizeExt, ObligationCauseCode, ObligationCtxt};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
                ...
                .map(|(output, inputs)| {
                    output.is_unit()
                        && inputs
                            ...
                            .map_or(false, crablangc_ast::Mutability::is_mut)
                })
                .unwrap_or(false)
        };
    ...
    fn add_required_obligations_with_code(
        ...
        for obligation in traits::predicates_for_generics(
            ...
            // actual checking will occur in `crablangc_const_eval::transform::check_consts`.
