...
use crablangc_errors::{Applicability, Diagnostic, DiagnosticBuilder, ErrorGuaranteed};
use crablangc_hir as hir;
use crablangc_hir::def::CtorKind;
use crablangc_hir::intravisit::Visitor;
use crablangc_hir::lang_items::LangItem;
use crablangc_hir::{is_range_literal, Node};
...
use crablangc_middle::ty::fold::{BottomUpFolder, TypeFolder};
use crablangc_middle::ty::print::{with_forced_trimmed_paths, with_no_trimmed_paths};
use crablangc_middle::ty::relate::TypeRelation;
use crablangc_middle::ty::{self, Article, AssocItem, Ty, TypeAndMut, TypeVisitableExt};
...
use crablangc_trait_selection::traits::error_reporting::method_chain::CollectAllMismatches;
use crablangc_trait_selection::traits::ObligationCause;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn suggest_compatible_variants(
        ...
        if let ty::Adt(expected_adt, substs) = expected.kind() {
            ...
            let suggestions_for = |variant: &_, ctor_kind, field_name| {
                ...
                // This fixes https://github.com/crablang/crablang/issues/101065,
            ...
            |m| {
                self.has_only_self_parameter(m)
                    && self
                        ...
                        // also be `#[crablangc_conversion_suggestion]`, if not for
                        // method-probing false-positives and -negatives (respectively).
                        //
                        // FIXME? Other potential candidate methods: `as_ref` and
                        // `as_mut`?
                        .has_attr(m.def_id, sym::crablangc_conversion_suggestion)
            },
        );
    ...
    fn check_wrong_return_type_due_to_generic_arg(
        ...
        let mut maybe_emit_help = |def_id: hir::def_id::DefId,
                                   callable: crablangc_span::symbol::Ident,
                                   args: &[hir::Expr<'_>],
                                   kind: CallableKind| {
