...
#[derive(Diagnostic)]
#[diag(interface_crablangc_error_fatal)]
pub struct CrabLangcErrorFatal {
    #[primary_span]
    pub span: Span,
}

#[derive(Diagnostic)]
#[diag(interface_crablangc_error_unexpected_annotation)]
pub struct CrabLangcErrorUnexpectedAnnotation {
    #[primary_span]
    pub span: Span,
}
