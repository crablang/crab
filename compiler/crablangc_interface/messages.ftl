...
interface_crablangc_error_fatal =
    fatal error triggered by #[crablangc_error]

interface_crablangc_error_unexpected_annotation =
    unexpected annotation used with `#[crablangc_error(...)]`!
