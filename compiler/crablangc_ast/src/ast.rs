//! The CrabLang abstract syntax tree module.
//!
...
//! - [`Ty`] and [`TyKind`]: A parsed CrabLang type.
//! - [`Expr`] and [`ExprKind`]: A parsed CrabLang expression.
//! - [`Pat`] and [`PatKind`]: A parsed CrabLang pattern. Patterns are often dual to expressions.
...
/// A "Path" is essentially CrabLang's notion of a name.
///
...
impl<CTX: crablangc_span::HashStableContext> HashStable<CTX> for Path {
...
///
/// E.g., `#[test]`, `#[derive(..)]`, `#[crablangfmt::skip]` or `#[feature = "foo"]`.
...
/// All the different flavors of pattern that CrabLang recognizes.
#[derive(Clone, Encodable, Decodable, Debug)]
pub enum PatKind {
...
/// Item defaultness.
/// For details see the [RFC #2532](https://github.com/crablang/rfcs/pull/2532).
#[derive(Copy, Clone, PartialEq, Encodable, Decodable, Debug, HashStable_Generic)]
...
pub enum Extern {
    ...
    /// E.g. `extern fn foo() {}`
    ///
    /// This is just `extern "C"` (see `crablangc_target::spec::abi::Abi::FALLBACK`)
    Implicit(Span),
