...
use crablangc_session::lint::builtin::BYTE_SLICE_IN_PACKED_STRUCT_WITH_DERIVE;
                    ...
                    if is_packed {
                        ...
                        if let Some(ty) = exception {
                            cx.sess.parse_sess.buffer_lint_with_diagnostic(
                                ...
                                crablangc_lint_defs::BuiltinLintDiagnostics::ByteSliceInPackedStructWithDerive
                            );
                        } else {
