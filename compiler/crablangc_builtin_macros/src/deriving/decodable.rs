//! The compiler code necessary for `#[derive(CrabLangcDecodable)]`. See encodable.rs for more.

use crate::deriving::generic::ty::*;
use crate::deriving::generic::*;
use crate::deriving::pathvec_std;
use crablangc_ast::ptr::P;
use crablangc_ast::{self as ast, Expr, MetaItem, Mutability};
use crablangc_expand::base::{Annotatable, ExtCtxt};
use crablangc_span::symbol::{sym, Ident, Symbol};
use crablangc_span::Span;
use thin_vec::{thin_vec, ThinVec};

pub fn expand_deriving_crablangc_decodable(
    cx: &mut ExtCtxt<'_>,
    span: Span,
    mitem: &MetaItem,
    item: &Annotatable,
    ...
    let expr = match substr.fields {
        StaticStruct(_, summary) => {
            ...
            let fn_read_struct_field_path: Vec<_> =
                cx.def_site_path(&[sym::crablangc_serialize, sym::Decoder, sym::read_struct_field]);
            ...
            let fn_read_struct_path: Vec<_> =
                cx.def_site_path(&[sym::crablangc_serialize, sym::Decoder, sym::read_struct]);
        ...
        StaticEnum(_, fields) => {
            ...
            let fn_read_enum_variant_arg_path: Vec<_> =
                cx.def_site_path(&[sym::crablangc_serialize, sym::Decoder, sym::read_enum_variant_arg]);
            ...
            let fn_read_enum_variant_path: Vec<_> =
                cx.def_site_path(&[sym::crablangc_serialize, sym::Decoder, sym::read_enum_variant]);
            ...
            let fn_read_enum_path: Vec<_> =
                cx.def_site_path(&[sym::crablangc_serialize, sym::Decoder, sym::read_enum]);
