...
use crablangc_ast::{BinOpKind, BorrowKind, Expr, ExprKind, MetaItem, Mutability};
        ...
        let expr = cs_fold(
            ...
            |cx, fold| match fold {
                CsFold::Single(field) => {
                    ...
                    // which isn't valid CrabLang syntax. This wouldn't break compilation because these
