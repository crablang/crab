...
use crablangc_ast::{ptr::P, tokenstream::TokenStream};
use crablangc_expand::base::{self, DummyResult};
...
fn handle_array_element(
    cx: &mut base::ExtCtxt<'_>,
    has_errors: &mut bool,
    missing_literals: &mut Vec<crablangc_span::Span>,
    expr: &P<crablangc_ast::Expr>,
) -> Option<u8> {
    match expr.kind {
