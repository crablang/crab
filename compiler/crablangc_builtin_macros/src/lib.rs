...
use crablangc_expand::base::{MacroExpanderFn, ResolverExpand, SyntaxExtensionKind};
use crablangc_expand::proc_macro::BangProcMacro;
...
pub fn register_builtin_macros(resolver: &mut dyn ResolverExpand) {
    ...
    register_derive! {
        ...
        CrabLangcDecodable: decodable::expand_deriving_crablangc_decodable,
        CrabLangcEncodable: encodable::expand_deriving_crablangc_encodable,
    }
