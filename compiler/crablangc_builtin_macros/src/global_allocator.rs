...
use crablangc_ast::expand::allocator::{
    AllocatorKind, AllocatorMethod, AllocatorTy, ALLOCATOR_METHODS,
};
use crablangc_ast::ptr::P;
use crablangc_ast::{self as ast, AttrVec, Expr, FnHeader, FnSig, Generics, Param, StmtKind};
use crablangc_ast::{Fn, ItemKind, Mutability, Stmt, Ty, TyKind, Unsafe};
...
impl AllocFnFactory<'_, '_> {
    ...
    fn attrs(&self) -> AttrVec {
        thin_vec![self.cx.attr_word(sym::crablangc_std_internal_symbol, self.span)]
    }
