...
use crablangc_ast::{self as ast, FnHeader, FnSig, Generics, StmtKind};
use crablangc_ast::{Fn, ItemKind, Stmt, TyKind, Unsafe};
...
fn generate_handler(cx: &ExtCtxt<'_>, handler: Ident, span: Span, sig_span: Span) -> Stmt {
    ...
    let attrs = thin_vec![cx.attr_word(sym::crablangc_std_internal_symbol, span)];
