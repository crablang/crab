...
use crablangc_hir::{HirId, RangeEnd};
use crablangc_index::vec::Idx;
use crablangc_middle::mir;
use crablangc_middle::thir::{FieldPat, Pat, PatKind, PatRange};
use crablangc_middle::ty::layout::IntegerExt;
use crablangc_middle::ty::{self, Ty, TyCtxt, VariantDef};
use crablangc_middle::{middle::stability::EvalResult, mir::interpret::ConstValue};
use crablangc_session::lint;
use crablangc_span::{Span, DUMMY_SP};
use crablangc_target::abi::{FieldIdx, Integer, Size, VariantIdx, FIRST_VARIANT};
            ...
            PatKind::Leaf { subpatterns } | PatKind::Variant { subpatterns, .. } => {
                match pat.ty.kind() {
                    ...
                    ty::Adt(adt, substs) if adt.is_box() => {
                        ...
                        // anyway.
                        // See https://github.com/crablang/crablang/issues/82772 ,
                        // explanation: https://github.com/crablang/crablang/pull/82789#issuecomment-796921977
