...
use crablangc_middle::thir::{FieldPat, Pat, PatKind};
...
impl<'tcx> ConstToPat<'tcx> {
    ...
    fn type_may_have_partial_eq_impl(&self, ty: Ty<'tcx>) -> bool {
        ...
        // Note: To fix crablang/crablang#65466, we could just remove this type
    ...
    fn recur(
        ...
        let kind = match cv.ty().kind() {
            ...
            // const type. See
            // https://github.com/crablang/crablang/pull/70743#discussion_r404701963 for
            // details.
            ...
            // See https://github.com/crablang/crablang/issues/70861 for examples.
            ty::FnPtr(..) | ty::RawPtr(..) => {
                if !self.saw_const_match_error.get()
                    && !self.saw_const_match_lint.get()
                {
