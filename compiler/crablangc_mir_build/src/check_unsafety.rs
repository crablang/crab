...
use crate::errors::*;
use crablangc_middle::thir::visit::{self, Visitor};

use crablangc_hir as hir;
use crablangc_middle::mir::BorrowKind;
use crablangc_middle::thir::*;
use crablangc_middle::ty::print::with_no_trimmed_paths;
use crablangc_middle::ty::{self, ParamEnv, Ty, TyCtxt};
    ...
    fn requires_unsafe(&mut self, span: Span, kind: UnsafeOpKind) {
        ...
        match self.safety_context {
            ...
            SafetyContext::UnsafeBlock { ref mut used, .. } => {
                ...
                // https://github.com/crablang/crablang/issues/71668#issuecomment-1203075594).
                *used = true;
            }
