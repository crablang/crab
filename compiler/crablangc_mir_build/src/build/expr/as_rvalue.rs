...
use crablangc_target::abi::{Abi, FieldIdx, Primitive};
...
use crablangc_middle::mir::Place;
use crablangc_middle::mir::*;
use crablangc_middle::thir::*;
use crablangc_middle::ty::cast::{mir_cast_kind, CastTy};
use crablangc_middle::ty::{self, Ty, UpvarSubsts};
            ...
            ExprKind::Closure(box ClosureExpr {
                ...
                let result = match substs {
                    UpvarSubsts::Generator(substs) => {
                        ...
                        // libcrablangc_mir/transform/deaggregator.rs for details.
