...
use crablangc_middle::thir::{self, *};
use crablangc_middle::ty::{self, CanonicalUserTypeAnnotation, Ty};
...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    /// exhaustive in CrabLang. But during processing we sometimes divide
    ...
    /// ```
    ///
    /// [#29740]: https://github.com/crablang/crablang/issues/29740
    ///
...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    fn bind_and_guard_matched_candidate<'pat>(
        ...
        // crablang/crablang#27282: The `autoref` business deserves some
        // explanation here.
        //
            ...
            && let Some(guard) = &arm.guard
        {
            ...
            let mut guard_span = crablangc_span::DUMMY_SP;
