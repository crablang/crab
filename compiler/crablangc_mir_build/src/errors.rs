...
#[derive(Diagnostic)]
#[diag(mir_build_crablangc_box_attribute_error)]
pub struct CrabLangcBoxAttributeError {
    #[primary_span]
    pub span: Span,
    #[subdiagnostic]
    pub reason: CrabLangcBoxAttrReason,
}

#[derive(Subdiagnostic)]
pub enum CrabLangcBoxAttrReason {
