...
use crablangc_codegen_ssa::coverageinfo::map::{Counter, CounterExpression};
use crablangc_codegen_ssa::traits::{ConstMethods, CoverageInfoMethods};
...
use crablangc_middle::mir::coverage::CodeRegion;
...
///
/// CrabLang Coverage Map generation supports LLVM Coverage Mapping Format version
...
/// bundled with CrabLang's fork of LLVM.
///
/// Consequently, CrabLang's bundled version of Clang also generates Coverage Maps compliant with
/// the same version. Clang's implementation of Coverage Map generation was referenced when
/// implementing this CrabLang version, and though the format documentation is very explicit and
/// detailed, some undocumented details in Clang's implementation (that may or may not be important)
/// were also replicated for CrabLang's Coverage Map.
...
impl CoverageMapGenerator {
    fn new(tcx: TyCtxt<'_>) -> Self {
        ...
        // Since crablangc generates coverage maps with relative paths, the
    ...
    fn write_coverage_mapping<'a>(
        ...
        coverage_mapping_buffer: &CrabLangString,
    ) {
