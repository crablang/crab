...
use crablangc_target::abi::{Size, TagEncoding, VariantIdx, Variants};
...
fn build_enum_variant_part_di_node<'ll, 'tcx>(
    ...
    let stub = StubInfo::new(
        ...
        |cx, variant_part_unique_type_id_str| unsafe {
            ...
            llvm::LLVMCrabLangDIBuilderCreateVariantPart(
                DIB(cx),
                enum_type_di_node,
...
fn build_discr_member_di_node<'ll, 'tcx>(
    ...
    match enum_or_generator_type_and_layout.layout.variants() {
        ...
        &Variants::Multiple { tag_field, .. } => {
            ...
            unsafe {
                Some(llvm::LLVMCrabLangDIBuilderCreateMemberType(
                    DIB(cx),
                    containing_scope,
...
/// `LLVMCrabLangDIBuilderCreateVariantMemberType()`.
fn build_enum_variant_member_di_node<'ll, 'tcx>(
    ...
    unsafe {
        llvm::LLVMCrabLangDIBuilderCreateVariantMemberType(
            DIB(cx),
            variant_part_di_node,
