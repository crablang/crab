...
use crablangc_codegen_ssa::base::collect_debugger_visualizers_transitive;
use crablangc_codegen_ssa::traits::*;
use crablangc_hir::def_id::LOCAL_CRATE;
use crablangc_middle::bug;
use crablangc_session::config::{CrateType, DebugInfo};
use crablangc_span::symbol::sym;
use crablangc_span::DebuggerVisualizerType;
...
pub fn get_or_insert_gdb_debug_scripts_section_global<'ll>(cx: &CodegenCx<'ll, '_>) -> &'ll Value {
    let c_section_var_name = "__crablangc_debug_gdb_scripts_section__\0";
    ...
    section_var.unwrap_or_else(|| {
        ...
        section_contents.extend_from_slice(b"\x01gdb_load_crablang_pretty_printers.py\0");
        ...
        unsafe {
            ...
            llvm::LLVMCrabLangSetLinkage(section_var, llvm::Linkage::LinkOnceODRLinkage);
...
pub fn needs_gdb_debug_scripts_section(cx: &CodegenCx<'_, '_>) -> bool {
    ...
    // To ensure the section `__crablangc_debug_gdb_scripts_section__` will not create
