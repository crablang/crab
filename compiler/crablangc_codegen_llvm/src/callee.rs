...
//! things. Callees are a superset of normal crablang values and sometimes
...
pub fn get_fn<'ll, 'tcx>(cx: &CodegenCx<'ll, 'tcx>, instance: Instance<'tcx>) -> &'ll Value {
    ...
    let llfn = if let Some(llfn) = cx.get_declared_value(sym) {
        ...
        {
            // Fix for https://github.com/crablang/crablang/issues/104453
        ...
        unsafe {
            llvm::LLVMCrabLangSetLinkage(llfn, llvm::Linkage::ExternalLinkage);
            ...
            if cx.should_assume_dso_local(llfn, true) {
                llvm::LLVMCrabLangSetDSOLocal(llfn, true);
            }
        }
