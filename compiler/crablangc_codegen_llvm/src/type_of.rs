...
use crablangc_target::abi::{Abi, Align, FieldsShape};
use crablangc_target::abi::{Int, Pointer, F32, F64};
use crablangc_target::abi::{PointeeInfo, Scalar, Size, TyAbiInterface, Variants};
...
impl<'tcx> LayoutLlvmExt<'tcx> for TyAndLayout<'tcx> {
    ...
    /// Gets the LLVM type corresponding to a CrabLang type, i.e., `crablangc_middle::ty::Ty`.
