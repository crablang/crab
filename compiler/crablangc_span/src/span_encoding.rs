...
// The encoding format for inline spans were obtained by optimizing over crates in crablangc/libstd.
// See https://internals.crablang.org/t/rfc-compiler-refactoring-spans/1357/28
...
///   the code. No crates in `crablangc-perf` need more than 15 bits for `ctxt_or_tag`,
