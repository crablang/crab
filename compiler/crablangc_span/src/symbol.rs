...
use crablangc_data_structures::stable_hasher::{HashStable, StableHasher, ToStableHashKey};
...
// The proc macro code for this is in `compiler/crablangc_macros/src/symbols.rs`.
symbols! {
    ...
    Keywords {
        ...
        // Keywords that are used in stable CrabLang.
        As:                 "as",
        Break:              "break",
        Const:              "const",
        Continue:           "continue",
        ...
        // Keywords that are used in unstable CrabLang or reserved for future use.
        Abstract:           "abstract",
        Become:             "become",
        Box:                "box",
        Do:                 "do",
        ...
        // Edition-specific keywords that are used in stable CrabLang.
        Async:              "async", // >= 2018 Edition only
        Await:              "await", // >= 2018 Edition only
        Dyn:                "dyn", // >= 2018 Edition only

        // Edition-specific keywords that are used in unstable CrabLang or reserved for future use.
    ...
    // Pre-interned symbols that can be referred to with `crablangc_span::sym::*`.
    //
    ...
    Symbols {
        ...
        crablang,
        crablang_2015,
        crablang_2015_preview,
        crablang_2018,
        crablang_2018_preview,
        crablang_2021,
        crablang_2021_preview,
        crablang_2024,
        crablang_2024_preview,
        crablang_begin_unwind,
        crablang_cold_cc,
        crablang_eh_catch_typeinfo,
        crablang_eh_personality,
        crablangc,
        crablangc_allocator,
        crablangc_allocator_zeroed,
        crablangc_allow_const_fn_unstable,
        ...
        crablangc_const_stable,
        crablangc_const_unstable,
        crablangc_conversion_suggestion,
        crablangc_deallocator,
        crablangc_def_path,
        crablangc_default_body_unstable,
        crablangc_deny_explicit_impl,
        crablangc_diagnostic_item,
        crablangc_diagnostic_macros,
        crablangc_dirty,
        crablangc_do_not_const_check,
        crablangc_doc_primitive,
        crablangc_dummy,
        crablangc_dump_env_program_clauses,
        crablangc_dump_program_clauses,
        ...
        crablangc_layout,
        crablangc_layout_scalar_valid_range_end,
        crablangc_layout_scalar_valid_range_start,
        crablangc_legacy_const_generics,
        crablangc_lint_diagnostics,
        crablangc_lint_opt_deny_field_access,
        crablangc_lint_opt_ty,
        crablangc_lint_query_instability,
        crablangc_macro_transparency,
        crablangc_main,
        crablangc_mir,
        ...
        crablangc_partition_codegened,
        crablangc_partition_reused,
        crablangc_pass_by_value,
        crablangc_peek,
        crablangc_peek_definite_init,
        crablangc_peek_liveness,
        crablangc_peek_maybe_init,
        crablangc_peek_maybe_uninit,
        crablangc_polymorphize_error,
        crablangc_private,
        crablangc_proc_macro_decls,
        crablangc_promotable,
        crablangc_reallocator,
        crablangc_regions,
        crablangc_reservation_impl,
        ...
        crablangc_test_marker,
        crablangc_then_this_would_need,
        crablangc_trivial_field_reads,
        crablangc_unsafe_specialization_marker,
        crablangc_variance,
        crablangdoc,
        crablangdoc_internals,
        crablangdoc_missing_doc_code_examples,
        crablangfmt,
...
/// stringification (especially true for proc macro derives written between CrabLang 1.15 and 1.30).
...
/// of `crablangc_index::newtype_index!` means that `Option<Symbol>` only takes up 4 bytes,
/// because `crablangc_index::newtype_index!` reserves the last 256 values for tagging purposes.
///
/// Note that `Symbol` cannot directly be a `crablangc_index::newtype_index!` because it
...
/// For example `sym::crablangfmt` or `sym::u8`.
pub mod sym {
    use super::Symbol;
    ...
    // Used from a macro in `libcrablangc_feature/accepted.rs`
