...
//! lints are all available in `crablangc_lint::builtin`.
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #81670 <https://github.com/crablang/crablang/issues/81670>",
    };
}
...
declare_lint! {
    ...
    /// attributes.
    ///
    /// [issue #57571]: https://github.com/crablang/crablang/issues/57571
    /// [attribute reference]: https://doc.crablang.org/nightly/reference/attributes.html
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub ILL_FORMED_ATTRIBUTE_INPUT,
    Deny,
    "ill-formed attribute inputs that were previously accepted and used in practice",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #57571 <https://github.com/crablang/crablang/issues/57571>",
    };
    crate_level_only
}
...
declare_lint! {
    ...
    /// conflicting hints.
    ///
    /// [`repr` attributes]: https://doc.crablang.org/reference/type-layout.html#representations
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    ///
    /// [issue #68585]: https://github.com/crablang/crablang/issues/68585
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub CONFLICTING_REPR_HINTS,
    Deny,
    "conflicts between `#[repr(..)]` hints that were previously accepted and used in practice",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #68585 <https://github.com/crablang/crablang/issues/68585>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [`macro_rules`]: https://doc.crablang.org/reference/macros-by-example.html
    /// [issue #61053]: https://github.com/crablang/crablang/issues/61053
...
declare_lint! {
    ...
    ///
    /// [`include!`]: https://doc.crablang.org/std/macro.include.html
    ///
    /// ### Example
    ///
    /// ```crablang,ignore (needs separate file)
    /// fn main() {
    ///     include!("foo.txt");
    /// }
    /// ```
    ...
    /// [issue #35560].
    ///
    /// [items]: https://doc.crablang.org/reference/items.html
    /// [expression]: https://doc.crablang.org/reference/expressions.html
    /// [block expression]: https://doc.crablang.org/reference/expressions/block-expr.html
    /// [proc-macros]: https://doc.crablang.org/reference/procedural-macros.html
    /// [issue #35560]: https://github.com/crablang/crablang/issues/35560
...
declare_lint! {
    ...
    /// will [overflow].
    ///
    /// [overflow]: https://doc.crablang.org/reference/expressions/operator-expr.html#overflow
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
...
declare_lint! {
    ...
    @feature_gate = crablangc_span::symbol::sym::must_not_suspend;
}
...
declare_lint! {
    ...
    ///
    /// [2018 edition]: https://doc.crablang.org/edition-guide/crablang-2018/module-system/path-clarity.html#no-more-extern-crate
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (needs extern crate)
    ...
    /// in the library.
    ///
    /// [path]: https://doc.crablang.org/reference/paths.html
    /// [`use`]: https://doc.crablang.org/reference/items/use-declarations.html
    /// [`extern crate`]: https://doc.crablang.org/reference/items/extern-crates.html
...
declare_lint! {
    ...
    ///
    /// [#54503]: https://github.com/crablang/crablang/issues/54503
    pub UNFULFILLED_LINT_EXPECTATIONS,
    Warn,
    "unfulfilled lint expectation",
    @feature_gate = crablangc_span::sym::lint_reasons;
}
...
declare_lint! {
    ...
    /// attribute.
    ///
    /// [attributes]: https://doc.crablang.org/reference/attributes.html
...
declare_lint! {
    ...
    ///
    /// [range patterns]: https://doc.crablang.org/nightly/reference/patterns.html#range-patterns
    ///
    /// ### Example
    ///
    /// ```crablang
...
declare_lint! {
    ...
    ///   above.
    ///
    /// [identifier pattern]: https://doc.crablang.org/reference/patterns.html#identifier-patterns
    /// [path pattern]: https://doc.crablang.org/reference/patterns.html#path-patterns
...
declare_lint! {
    ...
    ///
    /// [`macro_export` attribute]: https://doc.crablang.org/reference/macros-by-example.html#path-based-scope
    pub UNUSED_MACROS,
    Warn,
...
declare_lint! {
    ...
    ///
    /// [`feature` attributes]: https://doc.crablang.org/nightly/unstable-book/
    ///
    /// Note: This lint is currently not functional, see [issue #44232] for
    /// more details.
    ///
    /// [issue #44232]: https://github.com/crablang/crablang/issues/44232
    pub UNUSED_FEATURES,
    Warn,
...
declare_lint! {
    ...
    ///
    /// [`feature` attribute]: https://doc.crablang.org/nightly/unstable-book/
    ///
    /// ### Example
    ///
    /// ```crablang
...
declare_lint! {
    ...
    /// certainly a mistake.
    ///
    /// [`crate_type` attribute]: https://doc.crablang.org/reference/linkage.html
...
declare_lint! {
    ...
    /// [rfc-803]: https://github.com/crablang/rfcs/blob/master/text/0803-type-ascription.md
    /// [rfc-3307]: https://github.com/crablang/rfcs/blob/master/text/3307-de-rfc-type-ascription.md
    pub TRIVIAL_CASTS,
    Allow,
...
declare_lint! {
    ...
    /// details.
    ///
    /// [issue #34537]: https://github.com/crablang/crablang/issues/34537
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub PRIVATE_IN_PUBLIC,
    Warn,
    "detect private items in public interfaces not caught by the old implementation",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #34537 <https://github.com/crablang/crablang/issues/34537>",
    };
}
...
declare_lint! {
    ...
    /// CrabLang's stability guarantees. Using undefined behaviour can cause arbitrary
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #68585 <https://github.com/crablang/crablang/issues/104616>",
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (needs-dependency)
    ...
    ///
    /// [RFC 1977]: https://github.com/crablang/rfcs/blob/master/text/1977-public-private-dependencies.md
    /// [Cargo documentation]: https://doc.crablang.org/nightly/cargo/reference/unstable.html#public-dependency
...
declare_lint! {
    ...
    ///
    /// [issue #36887]: https://github.com/crablang/crablang/issues/36887
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub INVALID_TYPE_PARAM_DEFAULT,
    Deny,
    "type parameter default erroneously allowed in invalid location",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #36887 <https://github.com/crablang/crablang/issues/36887>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [Constant Evaluation]: https://doc.crablang.org/reference/const_eval.html
    /// [`static`]: https://doc.crablang.org/reference/items/static-items.html
    /// [mutable `static`]: https://doc.crablang.org/reference/items/static-items.html#mutable-statics
    /// [`lazy`]: https://doc.crablang.org/nightly/std/lazy/index.html
    /// [`lazy_static`]: https://crates.io/crates/lazy_static
    /// [`once_cell`]: https://crates.io/crates/once_cell
    /// [`atomic`]: https://doc.crablang.org/std/sync/atomic/index.html
    /// [`Mutex`]: https://doc.crablang.org/std/sync/struct.Mutex.html
...
declare_lint! {
    ...
    ///
    /// [identifier]: https://doc.crablang.org/reference/identifiers.html
    /// [identifier patterns]: https://doc.crablang.org/reference/patterns.html#identifier-patterns
    /// [issue #35203]: https://github.com/crablang/crablang/issues/35203
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub PATTERNS_IN_FNS_WITHOUT_BODY,
    Deny,
    "patterns in functions without body were erroneously allowed",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #35203 <https://github.com/crablang/crablang/issues/35203>",
    };
}
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #40107 <https://github.com/crablang/crablang/issues/40107>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #42868]: https://github.com/crablang/crablang/issues/42868
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub LATE_BOUND_LIFETIME_ARGUMENTS,
    Warn,
    "detects generic lifetime arguments in path segments with late bound lifetime parameters",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #42868 <https://github.com/crablang/crablang/issues/42868>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #56484]: https://github.com/crablang/crablang/issues/56484
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub ORDER_DEPENDENT_TRAIT_OBJECTS,
    Deny,
    "trait-object types were treated as different depending on marker-trait order",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #56484 <https://github.com/crablang/crablang/issues/56484>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #56105]: https://github.com/crablang/crablang/issues/56105
    /// [newtypes]: https://doc.crablang.org/book/ch19-04-advanced-types.html#using-the-newtype-pattern-for-type-safety-and-abstraction
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub COHERENCE_LEAK_CHECK,
    Warn,
    "distinct impls distinguished only by the leak-check code",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #56105 <https://github.com/crablang/crablang/issues/56105>",
    };
}
...
declare_lint! {
    ...
    /// documentation.
    ///
    /// [`deprecated` attribute]: https://doc.crablang.org/reference/attributes/diagnostics.html#the-deprecated-attribute
    pub DEPRECATED,
    Warn,
...
declare_lint! {
    ...
    ///
    /// [RFC 2115]: https://github.com/crablang/rfcs/blob/master/text/2115-argument-lifetimes.md
    /// [issue #44752]: https://github.com/crablang/crablang/issues/44752
...
declare_lint! {
    ...
    ///
    /// [arbitrary self types]: https://github.com/crablang/crablang/issues/44874
    /// [issue #46906]: https://github.com/crablang/crablang/issues/46906
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub TYVAR_BEHIND_RAW_POINTER,
    Warn,
    "raw pointer to an inference variable",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #46906 <https://github.com/crablang/crablang/issues/46906>",
...
declare_lint! {
    ...
    ///
    /// [placeholder lifetime]: https://doc.crablang.org/reference/lifetime-elision.html#lifetime-elision-in-functions
...
declare_lint! {
    ...
    /// with [`impl Trait`].
    ///
    /// [`impl Trait`]: https://doc.crablang.org/book/ch10-02-traits.html#traits-as-parameters
    pub BARE_TRAIT_OBJECTS,
    Warn,
    "suggest using `dyn Trait` for trait objects",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "<https://doc.crablang.org/nightly/edition-guide/crablang-2021/warnings-promoted-to-error.html>",
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,edition2015,compile_fail
    ...
    /// ### Explanation
    ///
    /// CrabLang [editions] allow the language to evolve without breaking
    ...
    /// edition.
    ///
    /// [editions]: https://doc.crablang.org/edition-guide/
    /// [`cargo fix`]: https://doc.crablang.org/cargo/commands/cargo-fix.html
    pub ABSOLUTE_PATHS_NOT_STARTING_WITH_CRATE,
    Allow,
    "fully qualified paths that start with a module name \
     instead of `crate`, `self`, or an extern crate name",
     @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #53130 <https://github.com/crablang/crablang/issues/53130>",
        reason: FutureIncompatibilityReason::EditionError(Edition::Edition2018),
     };
}
...
declare_lint! {
    ...
    ///
    /// [issue #41620]: https://github.com/crablang/crablang/issues/41620
    /// [match guard]: https://doc.crablang.org/reference/expressions/match-expr.html#match-guards
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub ILLEGAL_FLOATING_POINT_LITERAL_PATTERN,
    Warn,
    "floating-point literals cannot be used in patterns",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #41620 <https://github.com/crablang/crablang/issues/41620>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [nightly channel]: https://doc.crablang.org/book/appendix-07-nightly-crablang.html
    /// [`feature` attribute]: https://doc.crablang.org/nightly/unstable-book/
    ...
    @future_incompatible = FutureIncompatibleInfo {
        ...
        reference: "issue #48919 <https://github.com/crablang/crablang/issues/48919>",
...
declare_lint! {
    ...
    ///
    /// [irrefutable patterns]: https://doc.crablang.org/reference/patterns.html#refutability
    /// [`if let`]: https://doc.crablang.org/reference/expressions/if-expr.html#if-let-expressions
    /// [`while let`]: https://doc.crablang.org/reference/expressions/loop-expr.html#predicate-pattern-loops
    /// [`let`]: https://doc.crablang.org/reference/statements.html#let-statements
    /// [`loop`]: https://doc.crablang.org/reference/expressions/loop-expr.html#infinite-loops
    /// [RFC 2086]: https://github.com/crablang/rfcs/blob/master/text/2086-allow-if-let-irrefutables.md
...
declare_lint! {
    ...
    ///
    /// [labels]: https://doc.crablang.org/reference/expressions/loop-expr.html#loop-labels
    ///
    /// ### Example
    ///
    /// ```crablang,no_run
...
declare_lint! {
    ...
    /// [where clauses].
    ///
    /// [object safety]: https://doc.crablang.org/reference/items/traits.html#object-safety
    /// [where clauses]: https://doc.crablang.org/reference/items/generics.html#where-clauses
    ///
    /// ### Example
    ///
    /// ```crablang,no_run
    ...
    ///
    /// [issue #51443]: https://github.com/crablang/crablang/issues/51443
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub WHERE_CLAUSES_OBJECT_SAFETY,
    Warn,
    "checks the object safety of where clauses",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #51443 <https://github.com/crablang/crablang/issues/51443>",
    };
}
...
declare_lint! {
    ...
    ///   = note: for more information, see issue #50504 <https://github.com/crablang/crablang/issues/50504>
    /// ```
    ///
    /// ### Explanation
    ///
    ...
    /// more details.
    ///
    /// [issue #50504]: https://github.com/crablang/crablang/issues/50504
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub PROC_MACRO_DERIVE_RESOLUTION_FALLBACK,
    Deny,
    "detects proc macro derives using inaccessible names from parent modules",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #83583 <https://github.com/crablang/crablang/issues/83583>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}
...
declare_lint! {
    ...
    ///
    /// [`macro_use` attribute]: https://doc.crablang.org/reference/macros-by-example.html#the-macro_use-attribute
    /// [`use` import]: https://doc.crablang.org/reference/items/use-declarations.html
    /// [issue #52043]: https://github.com/crablang/crablang/issues/52043
...
declare_lint! {
    ...
    ///
    /// [`macro_export`]: https://doc.crablang.org/reference/macros-by-example.html#path-based-scope
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    ///
    /// [issue #53495]: https://github.com/crablang/crablang/issues/53495
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #52234 <https://github.com/crablang/crablang/issues/52234>",
    };
    crate_level_only
}
...
declare_lint! {
    ...
    ///
    /// [RFC 2093]: https://github.com/crablang/rfcs/blob/master/text/2093-infer-outlives.md
...
declare_lint! {
    ...
    ///
    /// [`PartialEq`]: https://doc.crablang.org/std/cmp/trait.PartialEq.html
    /// [`Eq`]: https://doc.crablang.org/std/cmp/trait.Eq.html
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    ///
    /// [issue #62411]: https://github.com/crablang/crablang/issues/62411
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub INDIRECT_STRUCTURAL_MATCH,
    Warn,
    "constant used in pattern contains value of non-structural-match type in a field or a variant",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #62411 <https://github.com/crablang/crablang/issues/62411>",
    };
}

declare_lint! {
    /// The `deprecated_in_future` lint is internal to crablangc and should not be
    /// used by user code.
    ///
    ...
    ///
    /// [stability documentation]: https://crablangc-dev-guide.crablang.org/stability.html#deprecated
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// Previous versions of CrabLang allowed function pointers and wide raw pointers in patterns.
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #62411 <https://github.com/crablang/crablang/issues/70861>",
    };
}
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// Previous versions of CrabLang accepted constants in patterns, even if those constants' types
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #73448 <https://github.com/crablang/crablang/issues/73448>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [associated items]: https://doc.crablang.org/reference/items/associated-items.html
    /// [enum variants]: https://doc.crablang.org/reference/items/enumerations.html
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    /// ### Explanation
    ///
    /// Previous versions of CrabLang did not allow accessing enum variants
    ...
    ///
    /// [issue #57644]: https://github.com/crablang/crablang/issues/57644
    /// [type aliases]: https://doc.crablang.org/reference/items/type-aliases.html#type-aliases
    /// [RFC 2338]: https://github.com/crablang/rfcs/blob/master/text/2338-type-alias-enum-variants.md
    /// [qualified path]: https://doc.crablang.org/reference/paths.html#qualified-paths
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub AMBIGUOUS_ASSOCIATED_ITEMS,
    Deny,
    "ambiguous associated items",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #57644 <https://github.com/crablang/crablang/issues/57644>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #64266]: https://github.com/crablang/crablang/issues/64266
    /// [`bench` attribute]: https://doc.crablang.org/nightly/unstable-book/library-features/test.html
    /// [stable release channel]: https://doc.crablang.org/book/appendix-07-nightly-crablang.html
    /// [`--cap-lints`]: https://doc.crablang.org/crablangc/lints/levels.html#capping-lints
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub SOFT_UNSTABLE,
    Deny,
    "a feature gate that doesn't break dependent crates",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #64266 <https://github.com/crablang/crablang/issues/64266>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [inline]: https://doc.crablang.org/reference/attributes/codegen.html#the-inline-attribute
    /// [no_sanitize]: https://doc.crablang.org/nightly/unstable-book/language-features/no-sanitize.html
    ///
    /// ### Example
    ///
    /// ```crablang
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (fails on non-x86_64)
    ...
    ///
    /// [register template modifiers]: https://doc.crablang.org/nightly/reference/inline-assembly.html#template-modifiers
...
declare_lint! {
    ...
    /// details.
    ///
    /// [`unsafe fn`]: https://doc.crablang.org/reference/unsafe-functions.html
    /// [`unsafe` block]: https://doc.crablang.org/reference/expressions/block-expr.html#unsafe-blocks
    /// [unsafe]: https://doc.crablang.org/reference/unsafety.html
    /// [RFC #2585]: https://github.com/crablang/rfcs/blob/master/text/2585-unsafe-block-in-unsafe-fn.md
    /// [issue #71668]: https://github.com/crablang/crablang/issues/71668
...
declare_lint! {
    ...
    ///
    /// [`Drop`]: https://doc.crablang.org/std/ops/trait.Drop.html
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    ///
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    /// [issue #73333]: https://github.com/crablang/crablang/issues/73333
    /// [`Copy`]: https://doc.crablang.org/std/marker/trait.Copy.html
    pub CENUM_IMPL_DROP_CAST,
    Deny,
    "a C-like enum implementing Drop is cast",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #73333 <https://github.com/crablang/crablang/issues/73333>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #95228]: https://github.com/crablang/crablang/issues/95228
    /// [`ptr::with_addr`]: https://doc.crablang.org/core/ptr/fn.with_addr
    /// [`ptr::from_exposed_addr`]: https://doc.crablang.org/core/ptr/fn.from_exposed_addr
...
declare_lint! {
    ...
    ///
    /// [issue #95228]: https://github.com/crablang/crablang/issues/95228
    /// [`ptr::addr`]: https://doc.crablang.org/core/ptr/fn.addr
    /// [`ptr::expose_addr`]: https://doc.crablang.org/core/ptr/fn.expose_addr
...
declare_lint! {
    ...
    ///
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    /// [issue #76200]: https://github.com/crablang/crablang/issues/76200
    pub CONST_EVALUATABLE_UNCHECKED,
    Warn,
    "detects a generic constant is used in a type without a emitting a warning",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #76200 <https://github.com/crablang/crablang/issues/76200>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [`fmt::Pointer`]: https://doc.crablang.org/std/fmt/trait.Pointer.html
    ///
    /// ### Example
    ///
    /// ```crablang
...
declare_lint! {
    ...
    "uninhabited static",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #74840 <https://github.com/crablang/crablang/issues/74840>",
    };
}
...
declare_lint! {
    ...
    /// either do not specify an ABI or specify the CrabLang ABI.
    ///
    /// ### Example
    ///
    /// ```crablang
    ...
    ///
    /// #[naked]
    /// pub extern "CrabLang" fn crablang_abi() -> u32 {
    ///     unsafe { asm!("", options(noreturn)); }
    /// }
    /// ```
    ///
    ...
    /// ### Explanation
    ///
    /// The CrabLang ABI is currently undefined. Therefore, naked functions should
    /// specify a non-CrabLang ABI.
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// Previous, CrabLang ignored trailing semicolon in a macro
    ...
    ///
    /// [issue #79813]: https://github.com/crablang/crablang/issues/79813
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub SEMICOLON_IN_EXPRESSIONS_FROM_MACROS,
    Warn,
    "trailing semicolon in macro body used as expression",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #79813 <https://github.com/crablang/crablang/issues/79813>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #79202 <https://github.com/crablang/crablang/issues/79202>",
    };
}
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (can crash on some platforms)
    /// let x = [0; 50000];
    /// let y = x;
    /// ```
    ///
...
declare_lint! {
    ...
    /// crablangc instead of `#![cfg_attr(..., crate_type = "...")]` and
    /// `--crate-name` instead of `#![cfg_attr(..., crate_name = "...")]`.
    pub DEPRECATED_CFG_ATTR_CRATE_TYPE_NAME,
    Deny,
    "detects usage of `#![cfg_attr(..., crate_type/crate_name = \"...\")]`",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #91632 <https://github.com/crablang/crablang/issues/91632>",
    };
}
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (needs external crate)
    ...
    /// ### Explanation
    ///
    /// Previous, CrabLang accepted fields that contain external private zero-sized types,
    ...
    ///
    /// [issue #78586]: https://github.com/crablang/crablang/issues/78586
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #78586 <https://github.com/crablang/crablang/issues/78586>",
    };
}
...
declare_lint! {
    ...
    ///
    /// [issue #65860]: https://github.com/crablang/crablang/issues/65860
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub UNSTABLE_SYNTAX_PRE_EXPANSION,
    Warn,
    "unstable syntax can change at any point in the future, causing a hard error!",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #65860 <https://github.com/crablang/crablang/issues/65860>",
    };
}
...
declare_lint_pass! {
    ...
    HardwiredLints => [
        ...
        CRABLANG_2021_INCOMPATIBLE_CLOSURE_CAPTURES,
        LEGACY_DERIVE_HELPERS,
        PROC_MACRO_BACK_COMPAT,
        CRABLANG_2021_INCOMPATIBLE_OR_PATTERNS,
        LARGE_ASSIGNMENTS,
        CRABLANG_2021_PRELUDE_COLLISIONS,
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// `crablangdoc` does not use doc comments in all positions, and so the doc
    /// comment will be ignored. Try changing it to a normal comment with `//`
    /// to avoid the warning.
    pub UNUSED_DOC_COMMENTS,
    Warn,
    "detects doc comments that aren't used by crablangdoc"
}

declare_lint! {
    /// The `crablang_2021_incompatible_closure_captures` lint detects variables that aren't completely
    /// captured in CrabLang 2021, such that the `Drop` order of their fields may differ between
    /// CrabLang 2018 and 2021.
    ///
    ...
    ///
    /// ```crablang,edition2018,compile_fail
    ...
    /// ### Explanation
    ///
    /// In the above example, only `fptr.0` is captured in CrabLang 2021.
    ...
    pub CRABLANG_2021_INCOMPATIBLE_CLOSURE_CAPTURES,
    Allow,
    "detects closures affected by CrabLang 2021 changes",
    @future_incompatible = FutureIncompatibleInfo {
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// Historically, CrabLang implicitly selected C as the ABI for extern
...
declare_lint! {
    ...
    ///
    /// [issue #82730]: https://github.com/crablang/crablang/issues/82730
    pub INVALID_DOC_ATTRIBUTES,
    Warn,
    "detects invalid `#[doc(...)]` attributes",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #82730 <https://github.com/crablang/crablang/issues/82730>",
    };
}
...
declare_lint! {
    ...
    ///    = warning: this was previously accepted by the compiler but is being phased out; it will become a hard error in a future release!
    ///    = note: for more information, see issue #83125 <https://github.com/crablang/crablang/issues/83125>
    ///    = note: the `time-macros-impl` crate will stop compiling in futures version of CrabLang. Please update to the latest version of the `time` crate to avoid breakage
    ...
    ///
    /// [issue #83125]: https://github.com/crablang/crablang/issues/83125
    /// [future-incompatible]: ../index.md#future-incompatible-lints
    pub PROC_MACRO_BACK_COMPAT,
    Deny,
    "detects usage of old versions of certain proc-macro crates",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #83125 <https://github.com/crablang/crablang/issues/83125>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}

declare_lint! {
    /// The `crablang_2021_incompatible_or_patterns` lint detects usage of old versions of or-patterns.
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    ...
    /// ### Explanation
    ///
    /// In CrabLang 2021, the `pat` matcher will match additional patterns, which include the `|` character.
    pub CRABLANG_2021_INCOMPATIBLE_OR_PATTERNS,
    Allow,
    "detects usage of old versions of or-patterns",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "<https://doc.crablang.org/nightly/edition-guide/crablang-2021/or-patterns-macro-rules.html>",
        reason: FutureIncompatibilityReason::EditionError(Edition::Edition2021),
    };
}

declare_lint! {
    /// The `crablang_2021_prelude_collisions` lint detects the usage of trait methods which are ambiguous
    /// with traits added to the prelude in future editions.
    ///
    /// ### Example
    ///
    /// ```crablang,compile_fail
    /// #![deny(crablang_2021_prelude_collisions)]
    ///
    /// trait Foo {
    ...
    ///     // `TryInto` has been added to the CrabLang prelude in 2021 edition.
    ///     println!("{x}");
    /// }
    /// ```
    ///
    ...
    /// ### Explanation
    ///
    /// In CrabLang 2021, one of the important introductions is the [prelude changes], which add
    ...
    ///
    /// [prelude changes]: https://blog.crablang.org/inside-crablang/2021/03/04/planning-crablang-2021.html#prelude-changes
    pub CRABLANG_2021_PRELUDE_COLLISIONS,
    Allow,
    "detects the usage of trait methods which are ambiguous with traits added to the \
        prelude in future editions",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "<https://doc.crablang.org/nightly/edition-guide/crablang-2021/prelude.html>",
        reason: FutureIncompatibilityReason::EditionError(Edition::Edition2021),
    };
}

declare_lint! {
    /// The `crablang_2021_prefixes_incompatible_syntax` lint detects identifiers that will be parsed as a
    /// prefix instead in CrabLang 2021.
    ///
    /// ### Example
    ///
    /// ```crablang,edition2018,compile_fail
    /// #![deny(crablang_2021_prefixes_incompatible_syntax)]
    ///
    /// macro_rules! m {
    ///     (z $x:expr) => ();
    /// }
    ...
    /// ### Explanation
    ///
    /// In CrabLang 2015 and 2018, `z"hey"` is two tokens: the identifier `z`
    /// followed by the string literal `"hey"`. In CrabLang 2021, the `z` is
    /// considered a prefix for `"hey"`.
    ///
    /// This lint suggests to add whitespace between the `z` and `"hey"` tokens
    /// to keep them separated in CrabLang 2021.
    // Allow this lint -- crablangdoc doesn't yet support threading edition into this lint's parser.
    #[allow(crablangdoc::invalid_crablang_codeblocks)]
    pub CRABLANG_2021_PREFIXES_INCOMPATIBLE_SYNTAX,
    Allow,
    "identifiers that will be parsed as a prefix in CrabLang 2021",
    @future_incompatible = FutureIncompatibleInfo {
        reference: "<https://doc.crablang.org/nightly/edition-guide/crablang-2021/reserving-syntax.html>",
        reason: FutureIncompatibilityReason::EditionError(Edition::Edition2021),
    };
    crate_level_only
}
...
declare_lint! {
    ...
    /// targets other than x86, but CrabLang doesn't really see a similar need to introduce a similar
    /// hack across many more targets.
    ///
    /// ### Example
    ///
    /// ```crablang,ignore (needs specific targets)
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #87678 <https://github.com/crablang/crablang/issues/87678>",
    };
}
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// In CrabLang, loops can have a label, and `break` expressions can refer to that label to
...
declare_lint! {
    ...
    /// ### Example
    ///
    /// ```crablang,ignore (needs separate crate)
    /// // crate A
    /// #[non_exhaustive]
    /// pub enum Bar {
    ///     A,
...
declare_lint! {
    ...
    ///
    /// [issue #90979]: https://github.com/crablang/crablang/issues/90979
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        ...
        reference: "issue #93367 <https://github.com/crablang/crablang/issues/93367>",
    };
}
...
declare_lint! {
    ...
    /// ### Explanation
    ///
    /// CrabLang formatting strings can refer to named arguments by their position, but this usage is
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #105572 <https://github.com/crablang/crablang/issues/105572>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
}
...
declare_lint! {
    ...
    @future_incompatible = FutureIncompatibleInfo {
        reference: "issue #107457 <https://github.com/crablang/crablang/issues/107457>",
        reason: FutureIncompatibilityReason::FutureReleaseErrorReportNow,
    };
    report_in_external_macro
}
