...
use crablangc_hir::is_range_literal;
use crablangc_hir::lang_items::LangItem;
use crablangc_hir::{AsyncGeneratorKind, GeneratorKind, Node};
...
use crablangc_infer::infer::{InferOk, LateBoundRegionConversionTime};
use crablangc_middle::hir::map;
use crablangc_middle::ty::error::TypeError::{self, Sorts};
...
use crablangc_span::{BytePos, DesugaringKind, ExpnKind, MacroKind, Span, DUMMY_SP};
...
use crablangc_middle::ty::print::{with_forced_trimmed_paths, with_no_trimmed_paths};
                ...
                || ref_inner_ty_satisfies_pred
            {
                if let Ok(snippet) = self.tcx.sess.source_map().span_to_snippet(span) {
                    ...
                    if has_custom_message {
                        ...
                        err.message =
                            vec![(crablangc_errors::DiagnosticMessage::Str(msg), Style::NoStyle)];
                    }
                    err.span_label(
                        span,
                        format!(
                ...
                if self.tcx.sess.is_nightly_build() && is_const_fn {
                    err.help(
                        "create an inline `const` block, see RFC #2920 \
                         <https://github.com/crablang/rfcs/pull/2920> for more information",
                    );
                }
            }
                    ...
                    if !is_upvar_tys_infer_tuple {
                        ...
                        match ty.kind() {
                            ...
                            ty::GeneratorWitness(bound_tys) => {
                                ...
                                // FIXME: this is kind of an unusual format for crablangc, can we make it more clear?
