...
use crablangc_ast::{MetaItem, NestedMetaItem};
use crablangc_attr as attr;
use crablangc_data_structures::fx::FxHashMap;
use crablangc_errors::{struct_span_err, ErrorGuaranteed};
use crablangc_hir as hir;
use crablangc_hir::def_id::DefId;
use crablangc_middle::ty::SubstsRef;
use crablangc_middle::ty::{self, GenericParamDefKind, TyCtxt};
use crablangc_parse_format::{ParseMode, Parser, Piece, Position};
...
impl<'tcx> TypeErrCtxtExt<'tcx> for TypeErrCtxt<'_, 'tcx> {
    fn impl_similar_to(
        ...
        tcx.has_attr(impl_def_id_and_substs.0, sym::crablangc_on_unimplemented)
...
/// For the `#[crablangc_on_unimplemented]` attribute
#[derive(Default)]
...
impl<'tcx> OnUnimplementedDirective {
    ...
    pub fn of_item(tcx: TyCtxt<'tcx>, item_def_id: DefId) -> Result<Option<Self>, ErrorGuaranteed> {
        let Some(attr) = tcx.get_attr(item_def_id, sym::crablangc_on_unimplemented) else {
            return Ok(None);
        };
