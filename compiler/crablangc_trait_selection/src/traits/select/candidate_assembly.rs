...
//! candidates. See the [crablangc dev guide] for more details.
//!
//! [crablangc dev guide]:https://crablangc-dev-guide.crablang.org/traits/resolution.html#candidate-assembly

use hir::def_id::DefId;
use hir::LangItem;
use crablangc_hir as hir;
use crablangc_infer::traits::ObligationCause;
use crablangc_infer::traits::{Obligation, SelectionError, TraitObligation};
