...
use crablangc_errors::{DelayDm, FatalError, MultiSpan};
use crablangc_hir as hir;
use crablangc_hir::def_id::DefId;
use crablangc_middle::ty::subst::{GenericArg, InternalSubsts};
use crablangc_middle::ty::{
    self, EarlyBinder, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable, TypeVisitor,
};
use crablangc_middle::ty::{ToPredicate, TypeVisitableExt};
use crablangc_session::lint::builtin::WHERE_CLAUSES_OBJECT_SAFETY;
    ...
    tcx.struct_span_lint_hir(
        ...
        |err| {
            ...
            err.span_note(
                ...
                <https://doc.crablang.org/reference/items/traits.html#object-safety>",
            );
            if node.is_some() {
...
/// is stabilized, see tracking issue <https://github.com/crablang/crablang/issues/43561>).
...
fn receiver_is_dispatchable<'tcx>(
    ...
    let unsized_self_ty: Ty<'tcx> =
        tcx.mk_ty_param(u32::MAX, Symbol::intern("CrabLangaceansAreAwesome"));
