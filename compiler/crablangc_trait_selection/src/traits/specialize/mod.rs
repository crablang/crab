...
//!
//! See the [crablangc dev guide] for a bit more detail on how specialization
//! fits together with the rest of the trait machinery.
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/traits/specialization.html
...
use crablangc_errors::{error_code, DelayDm, Diagnostic};
use crablangc_hir::def_id::{DefId, LocalDefId};
use crablangc_middle::ty::{self, ImplSubject, Ty, TyCtxt, TypeVisitableExt};
use crablangc_middle::ty::{InternalSubsts, SubstsRef};
use crablangc_session::lint::builtin::COHERENCE_LEAK_CHECK;
use crablangc_session::lint::builtin::ORDER_DEPENDENT_TRAIT_OBJECTS;
