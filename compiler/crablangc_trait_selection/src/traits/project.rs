...
use crablangc_infer::infer::at::At;
use crablangc_infer::infer::resolve::OpportunisticRegionResolver;
use crablangc_infer::infer::DefineOpaqueTypes;
use crablangc_infer::traits::ImplSourceBuiltinData;
use crablangc_middle::traits::select::OverflowError;
use crablangc_middle::ty::fold::{TypeFoldable, TypeFolder, TypeSuperFoldable};
use crablangc_middle::ty::visit::{MaxUniverse, TypeVisitable, TypeVisitableExt};
use crablangc_middle::ty::{self, Term, ToPredicate, Ty, TyCtxt};
use crablangc_span::symbol::sym;

use std::collections::BTreeMap;

pub use crablangc_middle::traits::Reveal;
    ...
    let _ = selcx.infcx.commit_if_ok(|_| {
        ...
        let eligible = match &impl_source {
            ...
            super::ImplSource::UserDefined(impl_data) => {
                ...
                // `crablangc_ty_utils::instance::resolve_associated_item()`.
                let node_item =
