...
use crablangc_infer::traits::util::PredicateSet;
use crablangc_infer::traits::ImplSource;
use crablangc_middle::ty::visit::TypeVisitableExt;
use crablangc_middle::ty::InternalSubsts;
use crablangc_middle::ty::{self, GenericParamDefKind, ToPredicate, Ty, TyCtxt, VtblEntry};
...
fn vtable_entries<'tcx>(
    ...
    if tcx.has_attr(trait_ref.def_id(), sym::crablangc_dump_vtable) {
