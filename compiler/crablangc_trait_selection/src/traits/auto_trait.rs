//! Support code for crablangdoc and external tools.
...
use crablangc_middle::ty::{ImplPolarity, Region, RegionVid};
...
impl<'tcx> AutoTraitFinder<'tcx> {
    ...
    /// This result is intended for use by crablangdoc and other such consumers.
    ///
    ...
    pub fn find_auto_trait_generics<A>(
        ...
        //
        // The problem is this: most of crablangc, including SelectionContext and traits::project,
