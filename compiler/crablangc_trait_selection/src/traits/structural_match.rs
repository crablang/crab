...
use crablangc_middle::ty::{self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable, TypeVisitor};
...
///
/// The reason we do this search is CrabLang currently require all ADTs
/// reachable from a constant's type to implement the
/// structural-match traits, which essentially say that
/// the implementation of `PartialEq::eq` behaves *equivalently* to a
/// comparison against the unfolded structure.
///
/// For more background on why CrabLang has this requirement, and issues
/// that arose when the requirement was not enforced completely, see
/// CrabLang RFC 1445, crablang/crablang#61188, and crablang/crablang#62307.
...
impl<'tcx> TypeVisitor<TyCtxt<'tcx>> for Search<'tcx> {
    ...
    fn visit_ty(&mut self, ty: Ty<'tcx>) -> ControlFlow<Self::BreakTy> {
        ...
        let (adt_def, substs) = match *ty.kind() {
            ...
            {
                // crablang/crablang#62336: ignore type of contents
                // for empty array.
                return ControlFlow::Continue(());
            }
        ...
        // crablang/crablang#55028 and crablang/crablang#55837; but also
