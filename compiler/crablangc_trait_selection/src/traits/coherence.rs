//! See CrabLangc Dev Guide chapters on [trait-resolution] and [trait-specialization] for more info on
//! how this works.
//!
//! [trait-resolution]: https://crablangc-dev-guide.crablang.org/traits/resolution.html
//! [trait-specialization]: https://crablangc-dev-guide.crablang.org/traits/specialization.html
...
use crablangc_hir::def_id::{DefId, CRATE_DEF_ID, LOCAL_CRATE};
use crablangc_infer::infer::{DefineOpaqueTypes, DefiningAnchor, InferCtxt, TyCtxtInferExt};
use crablangc_infer::traits::util;
use crablangc_middle::traits::specialization_graph::OverlapMode;
use crablangc_middle::ty::fast_reject::{DeepRejectCtxt, TreatParams};
use crablangc_middle::ty::visit::{TypeVisitable, TypeVisitableExt};
use crablangc_middle::ty::{self, ImplSubject, Ty, TyCtxt, TypeVisitor};
...
pub fn add_placeholder_note(err: &mut Diagnostic) {
    err.note(
        "this behavior recently changed as a result of a bug fix; \
         see crablang/crablang#56105 for details",
    );
}
