...
use crablangc_infer::infer::{DefineOpaqueTypes, InferCtxt, InferOk};
use crablangc_infer::traits::query::Fallible;
use crablangc_infer::traits::{
...
impl<'a, 'tcx> ObligationCtxt<'a, 'tcx> {
    ...
    pub fn assumed_wf_types(
        ...
        for ty in assumed_wf_types {
            // FIXME(@lcnr): crablangc currently does not check wf for types
