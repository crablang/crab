...
/// section of the [crablangc-dev-guide][c].
///
/// [c]: https://crablangc-dev-guide.crablang.org/solve/canonicalization.html
use super::{CanonicalGoal, Certainty, EvalCtxt, Goal};
use crate::solve::canonicalize::{CanonicalizeMode, Canonicalizer};
use crate::solve::{CanonicalResponse, QueryResult, Response};
use crablangc_infer::infer::canonical::query_response::make_query_region_constraints;
use crablangc_infer::infer::canonical::CanonicalVarValues;
use crablangc_infer::infer::canonical::{CanonicalExt, QueryRegionConstraints};
use crablangc_middle::traits::query::NoSolution;
use crablangc_middle::traits::solve::{ExternalConstraints, ExternalConstraintsData};
use crablangc_middle::ty::{self, GenericArgKind};
