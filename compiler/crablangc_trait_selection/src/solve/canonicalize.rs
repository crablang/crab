...
use crablangc_middle::infer::canonical::Canonical;
use crablangc_middle::infer::canonical::CanonicalTyVarKind;
use crablangc_middle::infer::canonical::CanonicalVarInfo;
use crablangc_middle::infer::canonical::CanonicalVarInfos;
use crablangc_middle::infer::canonical::CanonicalVarKind;
use crablangc_middle::ty::BoundRegionKind::BrAnon;
use crablangc_middle::ty::BoundTyKind;
use crablangc_middle::ty::TyCtxt;
use crablangc_middle::ty::TypeVisitableExt;
use crablangc_middle::ty::{self, Ty};
use crablangc_middle::ty::{TypeFoldable, TypeFolder, TypeSuperFoldable};
...
impl<'a, 'tcx> Canonicalizer<'a, 'tcx> {
    ...
    fn finalize(self) -> (ty::UniverseIndex, CanonicalVarInfos<'tcx>) {
        ...
        // See the crablangc-dev-guide section about how we deal with universes
