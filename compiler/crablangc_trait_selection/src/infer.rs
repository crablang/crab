...
use crablangc_middle::infer::canonical::{Canonical, CanonicalQueryResponse, QueryResponse};
use crablangc_middle::traits::query::Fallible;
use crablangc_middle::ty::{self, Ty, TyCtxt, TypeFoldable, TypeVisitableExt};
use crablangc_middle::ty::{GenericArg, ToPredicate};
use crablangc_span::DUMMY_SP;

use std::fmt::Debug;

pub use crablangc_infer::infer::*;
