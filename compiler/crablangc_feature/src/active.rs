...
// See https://crablangc-dev-guide.crablang.org/feature-gates.html#feature-gates for more
...
declare_features! (
    ...
    /// Allows using the `crablang-intrinsic`'s "ABI".
    ...
    /// Allows using `crablangc_*` attributes (RFC 572).
    (active, crablangc_attrs, "1.0.0", None, None),
    ...
    /// crablangc_strict_coherence value.
    ...
    /// Allows using `#[crablangc_allow_const_fn_unstable]`.
    /// This is an attribute on `const fn` for the same
    /// purpose as `#[allow_internal_unstable]`.
    (active, crablangc_allow_const_fn_unstable, "1.49.0", Some(69399), None),
    /// Allows using compiler's own crates.
    (active, crablangc_private, "1.0.0", Some(27812), None),
    /// Allows using internal crablangdoc features like `doc(keyword)`.
    (active, crablangdoc_internals, "1.58.0", Some(90418), None),
    /// Allows using the `crablangdoc::missing_doc_code_examples` lint
    (active, crablangdoc_missing_doc_code_examples, "1.31.0", Some(101730), None),
    ...
    /// Allows using the `crablang-call` ABI.
    ...
    /// Allow conditional compilation depending on crablang version
    ...
    /// Tells crablangdoc to automatically generate `#[doc(cfg(...))]`.
    ...
    /// casts in safe CrabLang to `dyn Trait` for such a `Trait` is also forbidden.
    ...
    (incomplete, return_type_notation, "CURRENT_CRABLANGC_VERSION", Some(109417), None),
    /// Allows `extern "crablang-cold"`.
    (active, crablang_cold_cc, "1.63.0", Some(97544), None),
    ...
    (active, transmute_generic_consts, "CURRENT_CRABLANGC_VERSION", Some(109929), None),
    ...
    /// Enables crablangc to generate code that instructs libstd to NOT ignore SIGPIPE.
