...
declare_features! (
    ...
    (removed, box_syntax, "CURRENT_CRABLANGC_VERSION", Some(49733), None, Some("replaced with `#[crablangc_box]`")),
    /// Allows capturing disjoint fields in a closure/generator (RFC 2229).
    (removed, capture_disjoint_fields, "1.49.0", Some(53488), None, Some("stabilized in CrabLang 2021")),
    ...
    (removed, doc_keyword, "1.28.0", Some(51315), None,
     Some("merged into `#![feature(crablangdoc_internals)]`")),
    ...
    (removed, link_args, "1.53.0", Some(29596), None,
     Some("removed in favor of using `-C link-arg=ARG` on command line, \
           which is available from cargo build scripts with `cargo:crablangc-link-arg` now")),
    ...
    (removed, plugin_registrar, "1.54.0", Some(29597), None,
     Some("a __crablangc_plugin_registrar symbol must now be defined instead")),
    ...
    (removed, crablangc_diagnostic_macros, "1.38.0", None, None, None),
