...
declare_features! (
    ...
    /// Allows the use of `#[cfg(doctest)]`, set when crablangdoc is collecting doctests.
    ...
    /// Allows crablangc to inject a default alloc_error_handler
    ...
    (accepted, movbe_target_feature, "CURRENT_CRABLANGC_VERSION", Some(44839), None),
