...
use crablangc_data_structures::{base_n, flock};
use crablangc_errors::ErrorGuaranteed;
use crablangc_fs_util::{link_or_copy, try_canonicalize, LinkOrCopy};
...
/// See [`crablangc_interface::queries::dep_graph`].
///
/// If this function returns an error, it may leave behind an invalid session directory.
/// The garbage collection will take care of it.
///
/// [`crablangc_interface::queries::dep_graph`]: ../../crablangc_interface/struct.Queries.html#structfield.dep_graph
...
// See https://github.com/crablang/crablang/issues/86929.
