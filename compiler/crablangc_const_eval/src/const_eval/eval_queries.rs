...
use crablangc_middle::mir::pretty::display_allocation;
...
use crablangc_target::abi::{self, Abi};
...
const NOTE_ON_UNDEFINED_BEHAVIOR_ERROR: &str = "The rules on what exactly is undefined behavior aren't clear, \
     so this check might be overzealous. Please open an issue on the crablangc \
...
pub fn eval_to_const_value_raw_provider<'tcx>(
    tcx: TyCtxt<'tcx>,
    key: ty::ParamEnvAnd<'tcx, GlobalId<'tcx>>,
) -> ::crablangc_middle::mir::interpret::EvalToConstValueResult<'tcx> {
...
pub fn eval_to_allocation_raw_provider<'tcx>(
    tcx: TyCtxt<'tcx>,
    key: ty::ParamEnvAnd<'tcx, GlobalId<'tcx>>,
) -> ::crablangc_middle::mir::interpret::EvalToAllocationRawResult<'tcx> {
    assert!(key.param_env.is_const());
    ...
    if cfg!(debug_assertions) {
        ...
        // https://crablang.zulipchat.com/#narrow/stream/146212-t-compiler.2Fconst-eval/
