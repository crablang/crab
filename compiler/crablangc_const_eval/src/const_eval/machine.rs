...
use crablangc_hir::{LangItem, CRATE_HIR_ID};
use crablangc_middle::mir;
use crablangc_middle::mir::interpret::PointerArithmetic;
use crablangc_middle::ty::layout::{FnAbiOf, TyAndLayout};
use crablangc_middle::ty::{self, Ty, TyCtxt};
use crablangc_session::lint::builtin::INVALID_ALIGNMENT;
use std::borrow::Borrow;
use std::hash::Hash;
use std::ops::ControlFlow;

use crablangc_data_structures::fx::FxIndexMap;
use crablangc_data_structures::fx::IndexEntry;
use std::fmt;

use crablangc_ast::Mutability;
use crablangc_hir::def_id::DefId;
use crablangc_middle::mir::AssertMessage;
...
impl<'mir, 'tcx: 'mir> CompileTimeEvalContext<'mir, 'tcx> {
    ...
    /// All `#[crablangc_do_not_const_check]` functions should be hooked here.
