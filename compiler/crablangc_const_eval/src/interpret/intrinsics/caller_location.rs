...
impl<'mir, 'tcx: 'mir, M: Machine<'mir, 'tcx>> InterpCx<'mir, 'tcx, M> {
    ...
    pub(crate) fn alloc_caller_location(
        ...
        // This can fail if crablangc runs out of memory right here. Trying to emit an error would be
        ...
        let file = if loc_details.file {
            ...
            // See https://github.com/crablang/crablang/pull/89920#discussion_r730012398
