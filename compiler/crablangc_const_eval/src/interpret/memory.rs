...
use crablangc_middle::mir::display_allocation;
use crablangc_middle::ty::{self, Instance, ParamEnv, Ty, TyCtxt};
use crablangc_target::abi::{Align, HasDataLayout, Size};
...
impl<'mir, 'tcx: 'mir, M: Machine<'mir, 'tcx>> InterpCx<'mir, 'tcx, M> {
    ...
    fn get_alloc_raw_mut(
        ...
        // <https://crablang.github.io/rfcs/2094-nll.html#problem-case-3-conditional-control-flow-across-functions>
