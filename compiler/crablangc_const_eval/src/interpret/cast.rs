...
use crablangc_apfloat::{Float, FloatConvert};
use crablangc_middle::mir::interpret::{InterpResult, PointerArithmetic, Scalar};
use crablangc_middle::mir::CastKind;
use crablangc_middle::ty::adjustment::PointerCast;
use crablangc_middle::ty::layout::{IntegerExt, LayoutOf, TyAndLayout};
use crablangc_middle::ty::{self, FloatTy, Ty, TypeAndMut};
...
impl<'mir, 'tcx: 'mir, M: Machine<'mir, 'tcx>> InterpCx<'mir, 'tcx, M> {
    ...
    pub fn cast_from_int_like(
        ...
        Ok(match *cast_ty.kind() {
            ...
            // Casts to bool are not permitted by crablangc, no need to handle them here.
        ...
        F: Float + Into<Scalar<M::Provenance>> + FloatConvert<Single> + FloatConvert<Double>,
    {
        ...
        match *dest_ty.kind() {
            ...
            Uint(t) => {
                ...
                // (https://doc.crablang.org/nightly/nightly-crablangc/crablangc_apfloat/trait.Float.html#method.to_i128_r).
