...
use crablangc_target::abi::{self, Abi, VariantIdx};
...
// FIXME: Working around https://github.com/crablang/crablang/issues/54385
    ...
    M: Machine<'mir, 'tcx, Provenance = Prov>,
{
    ...
    pub fn operand_field(
        ...
        // codegen does as good as we can (see `extract_field` in `crablangc_codegen_ssa/src/mir/operand.rs`).
    ...
    pub fn mplace_downcast(
        ...
        // see https://github.com/crablang/crablang/issues/93688#issuecomment-1032929496.)
    ...
    pub fn operand_index(
        ...
        match base.layout.fields {
            abi::FieldsShape::Array { stride, count: _ } => {
                ...
                if index >= len {
                    // This can only be reached in ConstProp and non-crablangc-MIR.
    ...
    pub fn place_projection(
        ...
        use crablangc_middle::mir::ProjectionElem::*;
        Ok(match proj_elem {
            OpaqueCast(ty) => {
