...
pub trait Machine<'mir, 'tcx>: Sized {
    ...
    /// (This is to support functions like `__crablang_maybe_catch_panic` that neither find a MIR
...
pub macro compile_time_machine(<$mir: lifetime, $tcx: lifetime>) {
    ...
    type MemoryMap =
        crablangc_data_structures::fx::FxIndexMap<AllocId, (MemoryKind<Self::MemoryKind>, Allocation)>;
