...
use crablangc_middle::mir::interpret::{InterpResult, Scalar};
...
impl<'mir, 'tcx: 'mir, M: Machine<'mir, 'tcx>> InterpCx<'mir, 'tcx, M> {
    ...
    fn binary_int_op(
        ...
        if bin_op == Shl || bin_op == Shr {
            ...
            // <https://github.com/crablang/crablang/blob/c274e4969f058b1c644243181ece9f829efa7594/compiler/crablangc_codegen_ssa/src/base.rs#L315-L317>.
            // The overflow check is also ignorant to the sign:
            // <https://github.com/crablang/crablang/blob/c274e4969f058b1c644243181ece9f829efa7594/compiler/crablangc_codegen_ssa/src/mir/rvalue.rs#L728>.
            ...
            // <https://github.com/crablang/crablang/blob/c274e4969f058b1c644243181ece9f829efa7594/compiler/crablangc_codegen_ssa/src/common.rs#L131-L158>
