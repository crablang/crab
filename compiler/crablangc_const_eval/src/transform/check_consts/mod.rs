...
use crablangc_middle::ty::{self, PolyFnSig, TyCtxt};
...
pub fn crablangc_allow_const_fn_unstable(
    tcx: TyCtxt<'_>,
    def_id: LocalDefId,
    feature_gate: Symbol,
) -> bool {
...
pub fn is_const_stable_const_fn(tcx: TyCtxt<'_>, def_id: DefId) -> bool {
    ...
    // A function is only const-stable if it has `#[crablangc_const_stable]` or it the trait it belongs
    // to is const-stable.
