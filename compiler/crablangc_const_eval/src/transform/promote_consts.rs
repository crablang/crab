...
use crablangc_middle::mir::traversal::ReversePostorderIter;
use crablangc_middle::mir::visit::{MutVisitor, MutatingUseContext, PlaceContext, Visitor};
use crablangc_middle::mir::*;
use crablangc_middle::ty::subst::InternalSubsts;
use crablangc_middle::ty::{self, List, TyCtxt, TypeVisitableExt};
...
impl<'tcx> Validator<'_, 'tcx> {
            ...
            Some((place_base, elem)) => {
                ...
                match elem {
                    ProjectionElem::Deref => {
                        ...
                        // https://github.com/crablang/crablang/pull/74945#discussion_r463063247
    ...
    fn validate_call(
        ...
        // Everywhere else, we require `#[crablangc_promotable]` on the callee.
        ...
        if !promote_all_const_fn {
            if let ty::FnDef(def_id, _) = *fn_ty.kind() {
                ...
                // functions without `#[crablangc_promotable]`.
