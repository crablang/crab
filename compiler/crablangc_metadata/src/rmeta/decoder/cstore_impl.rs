...
use crablangc_attr::Deprecation;
use crablangc_hir::def::{CtorKind, DefKind, Res};
use crablangc_hir::def_id::{CrateNum, DefId, DefIdMap, LOCAL_CRATE};
use crablangc_hir::definitions::{DefKey, DefPath, DefPathHash};
use crablangc_middle::arena::ArenaAllocatable;
use crablangc_middle::metadata::ModChild;
use crablangc_middle::middle::exported_symbols::ExportedSymbol;
use crablangc_middle::middle::stability::DeprecationEntry;
...
use crablangc_session::cstore::CrateStore;
use crablangc_session::{Session, StableCrateId};
use crablangc_span::hygiene::{ExpnHash, ExpnId};
use crablangc_span::symbol::{kw, Symbol};
...
macro_rules! provide_one {
    ...
    ($tcx:ident, $def_id:ident, $other:ident, $cdata:ident, $name:ident => $compute:block) => {
        fn $name<'tcx>(
            ...
            let cdata = crablangc_data_structures::sync::MappedReadGuard::map(CStore::from_tcx($tcx), |c| {
...
provide! { tcx, def_id, other, cdata,
    ...
    exported_symbols => {
        ...
        // FIXME crablang/crablang#64319, crablang/crablang#64872: We want
        // to block export of generics from dylibs, but we must fix
        // crablang/crablang#65890 before we can do that robustly.
...
impl CStore {
    ...
    /// See <https://github.com/crablang/crablang/pull/85889> for context.
