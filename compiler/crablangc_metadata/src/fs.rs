...
use crablangc_session::output::filename_for_metadata;
use crablangc_session::{MetadataKind, Session};
...
/// We use a temp directory here to avoid races between concurrent crablangc processes,
...
pub fn encode_and_write_metadata(tcx: TyCtxt<'_>) -> (EncodedMetadata, bool) {
    ...
    // To avoid races with another crablangc process scanning the output directory,
