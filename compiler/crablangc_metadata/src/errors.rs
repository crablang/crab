...
use crablangc_errors::{error_code, ErrorGuaranteed, IntoDiagnostic};
...
#[derive(Diagnostic)]
#[diag(metadata_crablangc_lib_required)]
#[help]
pub struct CrabLangcLibRequired<'a> {
    pub crate_name: Symbol,
    pub kind: &'a str,
}
...
#[derive(Diagnostic)]
#[diag(metadata_incompatible_crablangc, code = "E0514")]
#[note(metadata_found_crate_versions)]
#[help]
pub struct IncompatibleCrabLangc {
    #[primary_span]
    pub span: Span,
    pub crate_name: Symbol,
    pub add_info: String,
...
impl IntoDiagnostic<'_> for CannotFindCrate {
    ...
    fn into_diagnostic(
            ...
            && self.locator_triple != TargetTriple::from_triple(config::host_triple())
        {
            ...
            // NOTE: this suggests using crablangup, even though the user may not have it installed.
        ...
        } else if self.crate_name.as_str().starts_with("crablangc_") {
