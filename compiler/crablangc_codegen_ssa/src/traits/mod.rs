//! Interface of a CrabLang codegen backend
//!
//! This crate defines all the traits that have to be implemented by a codegen backend in order to
//! use the backend-agnostic codegen code in `crablangc_codegen_ssa`.
//!
...
use crablangc_middle::ty::layout::{HasParamEnv, HasTyCtxt};
use crablangc_target::spec::HasTargetSpec;
