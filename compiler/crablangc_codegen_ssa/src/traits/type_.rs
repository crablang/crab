...
use crablangc_target::abi::call::{ArgAbi, CastTarget, FnAbi, Reg};
use crablangc_target::abi::{AddressSpace, Integer};
...
pub trait LayoutTypeMethods<'tcx>: Backend<'tcx> {
    /// The backend type used for a crablang type when it's in memory,
    ...
    /// The backend type used for a crablang type when it's in an SSA register.
    ///
