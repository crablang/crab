...
codegen_ssa_use_cargo_directive = use the `cargo:crablangc-link-lib` directive to specify the native libraries to link with Cargo (see https://doc.crablang.org/cargo/reference/build-scripts.html#cargocrablangc-link-libkindname)
