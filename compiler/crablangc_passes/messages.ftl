...
-passes_see_issue =
    see issue #{$issue} <https://github.com/crablang/crablang/issues/{$issue}> for more information
...
passes_doc_inline_only_use =
    ...
    .note = read <https://doc.crablang.org/nightly/crablangdoc/the-doc-attribute.html#inline-and-no_inline> for more information
...
passes_attr_crate_level =
    ...
    .note = read <https://doc.crablang.org/nightly/crablangdoc/the-doc-attribute.html#at-the-crate-level> for more information
...
passes_allow_incoherent_impl =
    `crablangc_allow_incoherent_impl` attribute should be applied to impl items.
    .label = the only currently supported targets are inherent methods

passes_has_incoherent_inherent_impl =
    `crablangc_has_incoherent_inherent_impls` attribute should be applied to types or traits.
...
passes_link =
    attribute should be applied to an `extern` block with non-CrabLang ABI
    .warn = {-passes_previously_accepted}
...
passes_crablangc_layout_scalar_valid_range_not_struct =
    attribute should be applied to a struct
    .label = not a struct

passes_crablangc_layout_scalar_valid_range_arg =
    expected exactly one integer literal argument

passes_crablangc_legacy_const_generics_only =
    #[crablangc_legacy_const_generics] functions must only have const generics
    .label = non-const generic parameter

passes_crablangc_legacy_const_generics_index =
    #[crablangc_legacy_const_generics] must have one index for each generic parameter
    .label = generic parameters

passes_crablangc_legacy_const_generics_index_exceed =
...
passes_crablangc_legacy_const_generics_index_negative =
    arguments should be non-negative integers

passes_crablangc_dirty_clean =
...
passes_crablangc_allow_const_fn_unstable =
    attribute should be applied to `const fn`
    .label = not a `const fn`

passes_crablangc_std_internal_symbol =
...
passes_crablangc_lint_opt_ty =
    `#[crablangc_lint_opt_ty]` should be applied to a struct
    .label = not a struct

passes_crablangc_lint_opt_deny_field_access =
    `#[crablangc_lint_opt_deny_field_access]` should be applied to a field
    .label = not a field
...
passes_undefined_naked_function_abi =
    CrabLang ABI is unsupported in naked functions
...
passes_multiple_crablangc_main =
    multiple functions with a `#[crablangc_main]` attribute
    .first = first `#[crablangc_main]` function
    .additional = additional `#[crablangc_main]` function
...
passes_no_main_function =
    ...
    .teach_note = If you don't know the basics of CrabLang, you can go look to the CrabLang Book to get started: https://doc.crablang.org/book/
...
passes_trait_impl_const_stable =
    ...
    .note = see issue #67792 <https://github.com/crablang/crablang/issues/67792> for more information
...
passes_missing_const_err =
    attributes `#[crablangc_const_unstable]` and `#[crablangc_const_stable]` require the function or method to be `const`
