...
pub struct MustUseNoEffect {
    ...
    pub target: crablangc_hir::Target,
}
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_layout_scalar_valid_range_not_struct)]
pub struct CrabLangcLayoutScalarValidRangeNotStruct {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub span: Span,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_layout_scalar_valid_range_arg)]
pub struct CrabLangcLayoutScalarValidRangeArg {
    #[primary_span]
    pub attr_span: Span,
}

#[derive(Diagnostic)]
#[diag(passes_crablangc_legacy_const_generics_only)]
pub struct CrabLangcLegacyConstGenericsOnly {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub param_span: Span,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_legacy_const_generics_index)]
pub struct CrabLangcLegacyConstGenericsIndex {
    #[primary_span]
    pub attr_span: Span,
    #[label]
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_legacy_const_generics_index_exceed)]
pub struct CrabLangcLegacyConstGenericsIndexExceed {
    #[primary_span]
    #[label]
    pub span: Span,
    pub arg_count: usize,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_legacy_const_generics_index_negative)]
pub struct CrabLangcLegacyConstGenericsIndexNegative {
    #[primary_span]
    pub invalid_args: Vec<Span>,
}

#[derive(Diagnostic)]
#[diag(passes_crablangc_dirty_clean)]
pub struct CrabLangcDirtyClean {
    #[primary_span]
    pub span: Span,
}
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_allow_const_fn_unstable)]
pub struct CrabLangcAllowConstFnUnstable {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub span: Span,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_std_internal_symbol)]
pub struct CrabLangcStdInternalSymbol {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub span: Span,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_lint_opt_ty)]
pub struct CrabLangcLintOptTy {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub span: Span,
...
#[derive(Diagnostic)]
#[diag(passes_crablangc_lint_opt_deny_field_access)]
pub struct CrabLangcLintOptDenyFieldAccess {
    #[primary_span]
    pub attr_span: Span,
    #[label]
    pub span: Span,
...
impl IntoDiagnostic<'_> for InvalidAttrAtCrateLevel {
    ...
    fn into_diagnostic(
        self,
        handler: &'_ crablangc_errors::Handler,
...
#[derive(Diagnostic)]
#[diag(passes_multiple_crablangc_main, code = "E0137")]
pub struct MultipleCrabLangcMain {
    #[primary_span]
    pub span: Span,
    #[label(passes_first)]
    pub first: Span,
...
impl<'a> IntoDiagnostic<'a> for NoMainErr {
    ...
    ) -> crablangc_errors::DiagnosticBuilder<'a, ErrorGuaranteed> {
        let mut diag = handler.struct_span_err_with_code(
            DUMMY_SP,
