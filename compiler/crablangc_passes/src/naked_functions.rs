...
use crablangc_hir::{ExprKind, InlineAsmOperand, StmtKind};
use crablangc_middle::ty::query::Providers;
use crablangc_middle::ty::TyCtxt;
use crablangc_session::lint::builtin::UNDEFINED_NAKED_FUNCTION_ABI;
...
/// Checks that function uses non-CrabLang ABI.
