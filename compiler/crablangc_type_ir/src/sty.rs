...
use crablangc_data_structures::stable_hasher::HashStable;
...
#[crablangc_diagnostic_item = "IrTyKind"]
pub enum TyKind<I: Interner> {
    ...
    /// An unsized FFI type that is opaque to CrabLang. Written as `extern type T`.
    Foreign(I::DefId),
    ...
    ///
    /// See the `crablangc-dev-guide` for more details about
    /// [higher-ranked trait bounds][1] and [canonical queries][2].
    ///
    /// [1]: https://crablangc-dev-guide.crablang.org/traits/hrtb.html
    /// [2]: https://crablangc-dev-guide.crablang.org/traits/canonical-queries.html
...
/// to index into internal NLL data structures. See `crablangc_const_eval::borrow_check`
...
///
/// There are two kinds of placeholder regions in crablangc: `ReFree` and
...
/// by the [crablangc dev guide].
///
/// [1]: https://smallcultfollowing.com/babysteps/blog/2013/10/29/intermingled-parameter-lists/
/// [2]: https://smallcultfollowing.com/babysteps/blog/2013/11/04/intermingled-parameter-lists/
/// [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/traits/hrtb.html
    ...
    I::PlaceholderRegion: HashStable<CTX>,
{
    ...
    fn hash_stable(
        &self,
        hcx: &mut CTX,
        hasher: &mut crablangc_data_structures::stable_hasher::StableHasher,
    ) {
