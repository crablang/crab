...
pub(crate) fn producer() -> String {
    format!(
        "cg_clif (crablangc {}, cranelift {})",
        crablangc_interface::util::crablangc_version_str().unwrap_or("unknown version"),
...
impl DebugContext {
    pub(crate) fn new(tcx: TyCtxt<'_>, isa: &dyn TargetIsa) -> Self {
...

        {
            ...
            root.set(gimli::DW_AT_language, AttributeValue::Language(gimli::DW_LANG_CrabLang));
