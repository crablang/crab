...
impl DebugContext {
    pub(crate) fn get_span_loc(
        ...
        // Based on https://github.com/crablang/crablang/blob/e369d87b015a84653343032833d65d0545fd3f26/src/libcrablangc_codegen_ssa/mir/mod.rs#L116-L131
        ...
        let span = if tcx.should_collapse_debuginfo(span) {
            ...
            crablangc_span::hygiene::walk_chain(span, function_span.ctxt())
        };
