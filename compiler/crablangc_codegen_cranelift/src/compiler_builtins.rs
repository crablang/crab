...
builtin_functions! {
    ...
    fn __crablang_u128_addo(a: u128, b: u128) -> (u128, bool);
    fn __crablang_i128_addo(a: i128, b: i128) -> (i128, bool);
    fn __crablang_u128_subo(a: u128, b: u128) -> (u128, bool);
    fn __crablang_i128_subo(a: i128, b: i128) -> (i128, bool);
    fn __crablang_u128_mulo(a: u128, b: u128) -> (u128, bool);
    fn __crablang_i128_mulo(a: i128, b: i128) -> (i128, bool);
    ...
    // newer glibc resolve dlsym("malloc") to libc.so despite the override in the crablangc binary to
