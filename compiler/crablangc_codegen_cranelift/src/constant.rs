        ...
        ConstValue::Scalar(x) => match x {
            Scalar::Int(int) => {
                if fx.clif_type(layout.ty).is_some() {
                    ...
                    place.to_ptr().store(fx, val, MemFlags::tcrablanged());
                    place.to_cvalue(fx)
                }
            }
...
pub(crate) fn data_id_for_alloc_id(
    ...
    alloc_id: AllocId,
    mutability: crablangc_hir::Mutability,
) -> DataId {
...
fn data_id_for_static(
    ...
    if let Some(import_linkage) = attrs.import_linkage {
        ...
        let linkage = if import_linkage == crablangc_middle::mir::mono::Linkage::ExternalWeak
            || import_linkage == crablangc_middle::mir::mono::Linkage::WeakAny
        {
            Linkage::Preemptible
        } else {
            Linkage::Import
        ...
        // Comment copied from https://github.com/crablang/crablang/blob/45060c2a66dfd667f88bd8b94261b28a58d85bd5/src/libcrablangc_codegen_llvm/consts.rs#L141
        ...
        let ref_name = format!("_crablang_extern_with_linkage_{}", symbol_name);
    ...
    } else if attrs.linkage == Some(crablangc_middle::mir::mono::Linkage::ExternalWeak)
        || attrs.linkage == Some(crablangc_middle::mir::mono::Linkage::WeakAny)
    {
        Linkage::Preemptible
    } else {
        Linkage::Import
...
pub(crate) fn mir_operand_get_const_val<'tcx>(
    ...
    match operand {
        ...
        // FIXME(crablang/crablang#85105): Casts like `IMM8 as u32` result in the const being stored
