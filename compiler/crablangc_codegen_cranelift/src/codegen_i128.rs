    ...
    match bin_op {
        ...
        BinOp::Add | BinOp::Sub | BinOp::Mul => {
            ...
            let name = match (bin_op, is_signed) {
                (BinOp::Add, false) => "__crablang_u128_addo",
                (BinOp::Add, true) => "__crablang_i128_addo",
                (BinOp::Sub, false) => "__crablang_u128_subo",
                (BinOp::Sub, true) => "__crablang_i128_subo",
                (BinOp::Mul, false) => "__crablang_u128_mulo",
                _ => unreachable!(),
            };
        ...
        BinOp::Div | BinOp::Rem => {
            ...
            if fx.tcx.sess.target.is_like_windows {
                ...
                ret_place.to_ptr().store(fx, ret, MemFlags::tcrablanged());
