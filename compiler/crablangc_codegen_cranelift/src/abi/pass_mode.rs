...
use crablangc_target::abi::call::{
    ArgAbi, ArgAttributes, ArgExtension as CrabLangcArgExtension, CastTarget, PassMode, Reg, RegKind,
};
...
fn apply_arg_attrs_to_abi_param(mut param: AbiParam, arg_attrs: ArgAttributes) -> AbiParam {
    match arg_attrs.arg_ext {
        CrabLangcArgExtension::None => {}
        CrabLangcArgExtension::Zext => param.extension = ArgumentExtension::Uext,
        CrabLangcArgExtension::Sext => param.extension = ArgumentExtension::Sext,
    }
    param
}
