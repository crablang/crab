...
extern crate crablangc_fs_util;
extern crate crablangc_hir;
extern crate crablangc_incremental;
...
// This prevents duplicating functions and statics that are already part of the host crablangc process.
...
mod prelude {
    pub(crate) use crablangc_span::{FileNameDisplayPreference, Span};

    pub(crate) use crablangc_hir::def_id::{DefId, LOCAL_CRATE};
    pub(crate) use crablangc_middle::bug;
    pub(crate) use crablangc_middle::mir::{self, *};
    pub(crate) use crablangc_middle::ty::layout::{self, LayoutOf, TyAndLayout};
    pub(crate) use crablangc_middle::ty::{
        self, FloatTy, Instance, InstanceDef, IntTy, ParamEnv, Ty, TyCtxt, TypeAndMut,
        TypeFoldable, TypeVisitableExt, UintTy,
    };
    pub(crate) use crablangc_target::abi::{Abi, FieldIdx, Scalar, Size, VariantIdx, FIRST_VARIANT};

    pub(crate) use crablangc_data_structures::fx::FxHashMap;

    pub(crate) use crablangc_index::vec::Idx;
...
impl CodegenBackend for CraneliftCodegenBackend {
    fn locale_resource(&self) -> &'static str {
        // FIXME(crablang/crablang#100717) - cranelift codegen backend is not yet translated
        ""
    }
    ...
    fn target_features(&self, _sess: &Session, _allow_unstable: bool) -> Vec<crablangc_span::Symbol> {
        vec![]
    }
    ...
    fn codegen_crate(
        ...
        match config.codegen_mode {
            ...
            CodegenMode::Jit | CodegenMode::JitLazy => {
                ...
                #[cfg(not(feature = "jit"))]
                tcx.sess.fatal("jit support was disabled when compiling crablangc_codegen_cranelift");
            }
        }
    }
    ...
    fn link(
        ...
        use crablangc_codegen_ssa::back::link::link_binary;
...
/// This is the entrypoint for a hot plugged crablangc_codegen_cranelift
#[no_mangle]
