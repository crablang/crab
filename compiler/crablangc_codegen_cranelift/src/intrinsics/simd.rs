    ...
    match intrinsic {
            ...
            let indexes = {
                ...
                (0..ret_lane_count)
                    .map(|i| {
                        ...
                        let idx = crablangc_middle::mir::interpret::read_target_uint(
        ...
        sym::simd_gather => {
            ...
            for lane_idx in 0..ptr_lane_count {
                ...
                let res = fx.bcx.ins().load(lane_clif_ty, MemFlags::tcrablanged(), ptr_lane, 0);
        ...
        sym::simd_scatter => {
            ...
            for lane_idx in 0..ptr_lane_count {
                ...
                fx.bcx.switch_to_block(if_enabled);
                fx.bcx.ins().store(MemFlags::tcrablanged(), val_lane, ptr_lane, 0);
