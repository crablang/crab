//! Codegen of intrinsics. This includes `extern "crablang-intrinsic"`, `extern "platform-intrinsic"`
...
use crablangc_middle::ty::layout::{HasParamEnv, ValidityRequirement};
use crablangc_middle::ty::print::{with_no_trimmed_paths, with_no_visible_paths};
...
fn codegen_regular_intrinsic_call<'tcx>(
    ...
    match intrinsic {
        ...
        _ if intrinsic.as_str().starts_with("atomic_load") => {
            ...
            let val = fx.bcx.ins().atomic_load(clif_ty, MemFlags::tcrablanged(), ptr);
        ...
        _ if intrinsic.as_str().starts_with("atomic_store") => {
            ...
            fx.bcx.ins().atomic_store(MemFlags::tcrablanged(), val, ptr);
        }
        _ if intrinsic.as_str().starts_with("atomic_xchg") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Xchg, ptr, new);
        ...
        _ if intrinsic.as_str().starts_with("atomic_cxchg") => {
            ...
            let old = fx.bcx.ins().atomic_cas(MemFlags::tcrablanged(), ptr, test_old, new);
        ...
        _ if intrinsic.as_str().starts_with("atomic_xadd") => {
            ...
            let old =
                fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Add, ptr, amount);
        ...
        _ if intrinsic.as_str().starts_with("atomic_xsub") => {
            ...
            let old =
                fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Sub, ptr, amount);
        ...
        _ if intrinsic.as_str().starts_with("atomic_and") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::And, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_or") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Or, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_xor") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Xor, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_nand") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Nand, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_max") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Smax, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_umax") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Umax, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_min") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Smin, ptr, src);
        ...
        _ if intrinsic.as_str().starts_with("atomic_umin") => {
            ...
            let old = fx.bcx.ins().atomic_rmw(ty, MemFlags::tcrablanged(), AtomicRmwOp::Umin, ptr, src);
        ...
        sym::raw_eq => {
            ...
            let is_eq_value = if size == Size::ZERO {
                ...
                // Can't use `tcrablanged` for these loads; they could be unaligned.
