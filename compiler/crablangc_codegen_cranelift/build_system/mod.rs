...
pub fn main() {
    ...
    let bootstrap_host_compiler = Compiler::bootstrap_with_triple(
        std::env::var("HOST_TRIPLE")
            ...
            .unwrap_or_else(|| crablangc_info::get_host_triple()),
    );
    ...
    env::set_var("CRABLANGC", "crablangc_should_be_set_explicitly");
    env::set_var("CRABLANGDOC", "crablangdoc_should_be_set_explicitly");
