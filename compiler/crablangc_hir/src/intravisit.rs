...
//!
//! This order consistency is required in a few places in crablangc, for
//! example generator inference, and possibly also HIR borrowck.

use crate::hir::*;
use crablangc_ast::walk_list;
use crablangc_ast::{Attribute, Label};
...
/// An abstract representation of the HIR `crablangc_middle::hir::map::Map`.
pub trait Map<'hir> {
