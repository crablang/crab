...
use crablangc_ast::util::parser::ExprPrecedence;
use crablangc_ast::{Attribute, FloatTy, IntTy, Label, LitKind, TraitObjectSyntax, UintTy};
pub use crablangc_ast::{BindingAnnotation, BorrowKind, ByRef, ImplPolarity, IsAuto};
pub use crablangc_ast::{CaptureBy, Movability, Mutability};
...
use crablangc_data_structures::sorted_map::SortedMap;
use crablangc_error_messages::MultiSpan;
...
use crablangc_span::{def_id::LocalDefId, BytePos, Span, DUMMY_SP};
...
/// A `Path` is essentially CrabLang's notion of a name; for instance,
...
///
/// For more details, see the [crablangc dev guide].
///
...
// NOTE: `IntoDiagnosticArg` impl for `ConstContext` lives in `crablangc_errors`
...
impl Expr<'_> {
    ...
    pub fn is_place_expr(&self, mut allow_projections_from: impl FnMut(&Self) -> bool) -> bool {
        match self.kind {
            ...
            // operand. See:
            // https://github.com/crablang/rfcs/blob/master/text/0803-type-ascription.md#type-ascription-and-temporaries
...
pub enum ExprKind<'hir> {
    ...
    ///
    /// [`type_dependent_def_id`]: ../../crablangc_middle/ty/struct.TypeckResults.html#method.type_dependent_def_id
    ...
    Err(crablangc_span::ErrorGuaranteed),
}
...
///
/// [`qpath_res`]: ../../crablangc_middle/ty/struct.TypeckResults.html#method.qpath_res
#[derive(Debug, HashStable_Generic)]
pub enum QPath<'hir> {
