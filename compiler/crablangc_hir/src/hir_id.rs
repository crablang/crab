...
use crablangc_data_structures::stable_hasher::{HashStable, StableHasher, StableOrd, ToStableHashKey};
use crablangc_span::{def_id::DefPathHash, HashStableContext};
...
impl crablangc_index::vec::Idx for OwnerId {
    #[inline]
...
impl HirId {
    ...
    pub fn index(self) -> (usize, usize) {
        (
            crablangc_index::vec::Idx::index(self.owner.def_id),
            crablangc_index::vec::Idx::index(self.local_id),
        )
    }
}
...
crablangc_data_structures::define_stable_id_collections!(HirIdMap, HirIdSet, HirIdMapEntry, HirId);
