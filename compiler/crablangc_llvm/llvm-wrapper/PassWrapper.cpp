...
extern "C" bool LLVMCrabLangHasFeature(LLVMTargetMachineRef TM,
                                   const char *Feature) {
...
enum class LLVMCrabLangCodeModel {
  Tiny,
  Small,
  Kernel,
  Medium,
...
#endif
fromCrabLang(LLVMCrabLangCodeModel Model) {
  switch (Model) {
  case LLVMCrabLangCodeModel::Tiny:
    return CodeModel::Tiny;
  case LLVMCrabLangCodeModel::Small:
    return CodeModel::Small;
  case LLVMCrabLangCodeModel::Kernel:
    return CodeModel::Kernel;
  case LLVMCrabLangCodeModel::Medium:
    return CodeModel::Medium;
  case LLVMCrabLangCodeModel::Large:
    return CodeModel::Large;
  case LLVMCrabLangCodeModel::None:
#if LLVM_VERSION_LT(16, 0)
    return None;
#else
    return std::nullopt;
...
enum class LLVMCrabLangCodeGenOptLevel {
  None,
  Less,
  Default,
  Aggressive,
...
static CodeGenOpt::Level fromCrabLang(LLVMCrabLangCodeGenOptLevel Level) {
  switch (Level) {
  case LLVMCrabLangCodeGenOptLevel::None:
    return CodeGenOpt::None;
  case LLVMCrabLangCodeGenOptLevel::Less:
    return CodeGenOpt::Less;
  case LLVMCrabLangCodeGenOptLevel::Default:
    return CodeGenOpt::Default;
  case LLVMCrabLangCodeGenOptLevel::Aggressive:
...
enum class LLVMCrabLangPassBuilderOptLevel {
  O0,
  O1,
  O2,
  O3,
...
static OptimizationLevel fromCrabLang(LLVMCrabLangPassBuilderOptLevel Level) {
  switch (Level) {
  case LLVMCrabLangPassBuilderOptLevel::O0:
    return OptimizationLevel::O0;
  case LLVMCrabLangPassBuilderOptLevel::O1:
    return OptimizationLevel::O1;
  case LLVMCrabLangPassBuilderOptLevel::O2:
    return OptimizationLevel::O2;
  case LLVMCrabLangPassBuilderOptLevel::O3:
    return OptimizationLevel::O3;
  case LLVMCrabLangPassBuilderOptLevel::Os:
    return OptimizationLevel::Os;
  case LLVMCrabLangPassBuilderOptLevel::Oz:
...
enum class LLVMCrabLangRelocModel {
  Static,
  PIC,
  DynamicNoPic,
  ROPI,
...
static Reloc::Model fromCrabLang(LLVMCrabLangRelocModel CrabLangReloc) {
  switch (CrabLangReloc) {
  case LLVMCrabLangRelocModel::Static:
    return Reloc::Static;
  case LLVMCrabLangRelocModel::PIC:
    return Reloc::PIC_;
  case LLVMCrabLangRelocModel::DynamicNoPic:
    return Reloc::DynamicNoPIC;
  case LLVMCrabLangRelocModel::ROPI:
    return Reloc::ROPI;
  case LLVMCrabLangRelocModel::RWPI:
    return Reloc::RWPI;
  case LLVMCrabLangRelocModel::ROPIRWPI:
    return Reloc::ROPI_RWPI;
  }
  report_fatal_error("Bad RelocModel.");
}

#ifdef LLVM_CRABLANGLLVM
...
extern "C" void LLVMCrabLangPrintTargetCPUs(LLVMTargetMachineRef TM) {
...
extern "C" size_t LLVMCrabLangGetTargetFeaturesCount(LLVMTargetMachineRef TM) {
  const TargetMachine *Target = unwrap(TM);
  const MCSubtargetInfo *MCInfo = Target->getMCSubtargetInfo();
...
extern "C" void LLVMCrabLangGetTargetFeature(LLVMTargetMachineRef TM, size_t Index,
...
extern "C" void LLVMCrabLangPrintTargetCPUs(LLVMTargetMachineRef) {
  printf("Target CPU help is not supported by this LLVM version.\n\n");
}

extern "C" size_t LLVMCrabLangGetTargetFeaturesCount(LLVMTargetMachineRef) {
  return 0;
}

extern "C" void LLVMCrabLangGetTargetFeature(LLVMTargetMachineRef, const char**, const char**) {}
#endif

extern "C" const char* LLVMCrabLangGetHostCPUName(size_t *len) {
  StringRef Name = sys::getHostCPUName();
  *len = Name.size();
  return Name.data();
}

extern "C" LLVMTargetMachineRef LLVMCrabLangCreateTargetMachine(
    const char *TripleStr, const char *CPU, const char *Feature,
    const char *ABIStr, LLVMCrabLangCodeModel CrabLangCM, LLVMCrabLangRelocModel CrabLangReloc,
    LLVMCrabLangCodeGenOptLevel CrabLangOptLevel, bool UseSoftFloat,
  ...
  auto OptLevel = fromCrabLang(CrabLangOptLevel);
  auto RM = fromCrabLang(CrabLangReloc);
  auto CM = fromCrabLang(CrabLangCM);
  ...
  if (TheTarget == nullptr) {
    LLVMCrabLangSetLastError(Error.c_str());
    return nullptr;
  }
...
extern "C" void LLVMCrabLangDisposeTargetMachine(LLVMTargetMachineRef TM) {
  delete unwrap(TM);
}

// Unfortunately, the LLVM C API doesn't provide a way to create the
// TargetLibraryInfo pass, so we use this method to do so.
extern "C" void LLVMCrabLangAddLibraryInfo(LLVMPassManagerRef PMR, LLVMModuleRef M,
...
extern "C" void LLVMCrabLangSetLLVMOptions(int Argc, char **Argv) {
  // Initializing the command-line options more than once is not allowed. So,
  // check if they've already been initialized. (This could happen if we're
  // being called from crablangpkg, for example). If the arguments change, then
...
enum class LLVMCrabLangFileType {
  AssemblyFile,
  ObjectFile,
};

static CodeGenFileType fromCrabLang(LLVMCrabLangFileType Type) {
  switch (Type) {
  case LLVMCrabLangFileType::AssemblyFile:
    return CGFT_AssemblyFile;
  case LLVMCrabLangFileType::ObjectFile:
...
LLVMCrabLangWriteOutputFile(LLVMTargetMachineRef Target, LLVMPassManagerRef PMR,
                        LLVMModuleRef M, const char *Path, const char *DwoPath,
                        LLVMCrabLangFileType CrabLangFileType) {
  llvm::legacy::PassManager *PM = unwrap<llvm::legacy::PassManager>(PMR);
  auto FileType = fromCrabLang(CrabLangFileType);
  ...
  if (ErrorInfo != "") {
    LLVMCrabLangSetLastError(ErrorInfo.c_str());
  ...
  // wish this was written in CrabLang?
  LLVMDisposePassManager(PMR);
  return LLVMCrabLangResult::Success;
}

extern "C" typedef void (*LLVMCrabLangSelfProfileBeforePassCallback)(void*, // LlvmSelfProfiler
                                                      const char*,      // pass name
                                                      const char*);     // IR name
extern "C" typedef void (*LLVMCrabLangSelfProfileAfterPassCallback)(void*); // LlvmSelfProfiler

std::string LLVMCrabLangwrappedIrGetName(const llvm::Any &WrappedIr) {
...
void LLVMSelfProfileInitializeCallbacks(
    ...
    LLVMCrabLangSelfProfileBeforePassCallback BeforePassCallback,
    LLVMCrabLangSelfProfileAfterPassCallback AfterPassCallback) {
  PIC.registerBeforeNonSkippedPassCallback([LlvmSelfProfiler, BeforePassCallback](
                                           StringRef Pass, llvm::Any Ir) {
    std::string PassName = Pass.str();
    std::string IrName = LLVMCrabLangwrappedIrGetName(Ir);
...
enum class LLVMCrabLangOptStage {
  PreLinkNoLTO,
  PreLinkThinLTO,
  PreLinkFatLTO,
  ThinLTO,
...
struct LLVMCrabLangSanitizerOptions {
...
extern "C" LLVMCrabLangResult
LLVMCrabLangOptimize(
    LLVMModuleRef ModuleRef,
    LLVMTargetMachineRef TMRef,
    LLVMCrabLangPassBuilderOptLevel OptLevelCrabLang,
    LLVMCrabLangOptStage OptStage,
    bool NoPrepopulatePasses, bool VerifyIR, bool UseThinLTOBuffers,
    bool MergeFunctions, bool UnrollLoops, bool SLPVectorize, bool LoopVectorize,
    bool DisableSimplifyLibCalls, bool EmitLifetimeMarkers,
    LLVMCrabLangSanitizerOptions *SanitizerOptions,
  ...
  OptimizationLevel OptLevel = fromCrabLang(OptLevelCrabLang);
  ...
  if (LLVMPluginsLen) {
    ...
    for (auto PluginPath: Plugins) {
      ...
      if (!Plugin) {
        LLVMCrabLangSetLastError(("Failed to load pass plugin" + PluginPath.str()).c_str());
        return LLVMCrabLangResult::Failure;
      }
  ...
  if (!NoPrepopulatePasses) {
    ...
    bool IsLTO = OptStage == LLVMCrabLangOptStage::ThinLTO || OptStage == LLVMCrabLangOptStage::FatLTO;
    if (OptLevel == OptimizationLevel::O0 && !IsLTO) {
      ...
      for (const auto &C : PipelineStartEPCallbacks)
        PB.registerPipelineStartEPCallback(C);
      if (OptStage != LLVMCrabLangOptStage::PreLinkThinLTO) {
        for (const auto &C : OptimizerLastEPCallbacks)
          PB.registerOptimizerLastEPCallback(C);
      }

      switch (OptStage) {
      case LLVMCrabLangOptStage::PreLinkNoLTO:
        MPM = PB.buildPerModuleDefaultPipeline(OptLevel, DebugPassManager);
        break;
      case LLVMCrabLangOptStage::PreLinkThinLTO:
        ...
        for (const auto &C : OptimizerLastEPCallbacks)
          C(MPM, OptLevel);
        break;
      case LLVMCrabLangOptStage::PreLinkFatLTO:
        MPM = PB.buildLTOPreLinkDefaultPipeline(OptLevel);
        NeedThinLTOBufferPasses = false;
        break;
      case LLVMCrabLangOptStage::ThinLTO:
        // FIXME: Does it make sense to pass the ModuleSummaryIndex?
        // It only seems to be needed for C++ specific optimizations.
        MPM = PB.buildThinLTODefaultPipeline(OptLevel, nullptr);
        break;
      case LLVMCrabLangOptStage::FatLTO:
  ...
  if (ExtraPassesLen) {
    if (auto Err = PB.parsePassPipeline(MPM, StringRef(ExtraPasses, ExtraPassesLen))) {
      ...
      LLVMCrabLangSetLastError(ErrMsg.c_str());
      return LLVMCrabLangResult::Failure;
    }
  }
...
class CrabLangAssemblyAnnotationWriter : public AssemblyAnnotationWriter {
  DemangleFn Demangle;
  std::vector<char> Buf;

public:
  CrabLangAssemblyAnnotationWriter(DemangleFn Demangle) : Demangle(Demangle) {}
...
extern "C" LLVMCrabLangResult
LLVMCrabLangPrintModule(LLVMModuleRef M, const char *Path, DemangleFn Demangle) {
  std::string ErrorInfo;
  std::error_code EC;
  raw_fd_ostream OS(Path, EC, sys::fs::OF_None);
  if (EC)
  ...
  CrabLangAssemblyAnnotationWriter AAW(Demangle);
...
extern "C" void LLVMCrabLangPrintPasses() {
  PassBuilder PB;
  PB.printPassNames(outs());
}

extern "C" void LLVMCrabLangRunRestrictionPass(LLVMModuleRef M, char **Symbols,
                                           size_t Len) {
...
extern "C" void
LLVMCrabLangSetDataLayoutFromTargetMachine(LLVMModuleRef Module,
                                       LLVMTargetMachineRef TMR) {
  TargetMachine *Target = unwrap(TMR);
  unwrap(Module)->setDataLayout(Target->createDataLayout());
}

extern "C" void LLVMCrabLangSetModulePICLevel(LLVMModuleRef M) {
  unwrap(M)->setPICLevel(PICLevel::Level::BigPIC);
}

extern "C" void LLVMCrabLangSetModulePIELevel(LLVMModuleRef M) {
  unwrap(M)->setPIELevel(PIELevel::Level::Large);
}

extern "C" void LLVMCrabLangSetModuleCodeModel(LLVMModuleRef M,
                                           LLVMCrabLangCodeModel Model) {
  auto CM = fromCrabLang(Model);
  if (!CM)
    return;
  unwrap(M)->setCodeModel(*CM);
}

// Here you'll find an implementation of ThinLTO as used by the CrabLang compiler
...
struct LLVMCrabLangThinLTOData {
  ...
  LLVMCrabLangThinLTOData() : Index(/* HaveGVs = */ false) {}
};

// Just an argument to the `LLVMCrabLangCreateThinLTOData` function below.
struct LLVMCrabLangThinLTOModule {
...
extern "C" LLVMCrabLangThinLTOData*
LLVMCrabLangCreateThinLTOData(LLVMCrabLangThinLTOModule *modules,
                          int num_modules,
                          const char **preserved_symbols,
                          int num_symbols) {
  auto Ret = std::make_unique<LLVMCrabLangThinLTOData>();
...
extern "C" void
LLVMCrabLangFreeThinLTOData(LLVMCrabLangThinLTOData *Data) {
  delete Data;
}
...
// so crablangc can save off the intermediate bytecode between each step.
...
extern "C" bool
LLVMCrabLangPrepareThinLTORename(const LLVMCrabLangThinLTOData *Data, LLVMModuleRef M,
  ...
  if (error) {
    LLVMCrabLangSetLastError("renameModuleForThinLTO failed");
    return false;
  }
  return true;
}
...
extern "C" bool
LLVMCrabLangPrepareThinLTOResolveWeak(const LLVMCrabLangThinLTOData *Data, LLVMModuleRef M) {
  Module &Mod = *unwrap(M);
...
extern "C" bool
LLVMCrabLangPrepareThinLTOInternalize(const LLVMCrabLangThinLTOData *Data, LLVMModuleRef M) {
  Module &Mod = *unwrap(M);
  const auto &DefinedGlobals = Data->ModuleToDefinedGVSummaries.lookup(Mod.getModuleIdentifier());
...
extern "C" bool
LLVMCrabLangPrepareThinLTOImport(const LLVMCrabLangThinLTOData *Data, LLVMModuleRef M,
                             LLVMTargetMachineRef TM) {
  Module &Mod = *unwrap(M);
  TargetMachine &Target = *unwrap(TM);
  ...
  if (!Result) {
    LLVMCrabLangSetLastError(toString(Result.takeError()).c_str());
    return false;
  }
  return true;
}
...
// optimize all codegen-units for one compilation in crablangc. To be compatible
// with the LTO support above we need to serialize the modules plus their
// ThinLTO summary into memory.
//
// This structure is basically an owned version of a serialize module, with
// a ThinLTO summary attached.
struct LLVMCrabLangThinLTOBuffer {
  std::string data;
};

extern "C" LLVMCrabLangThinLTOBuffer*
LLVMCrabLangThinLTOBufferCreate(LLVMModuleRef M, bool is_thin) {
  auto Ret = std::make_unique<LLVMCrabLangThinLTOBuffer>();
  {
...
extern "C" void
LLVMCrabLangThinLTOBufferFree(LLVMCrabLangThinLTOBuffer *Buffer) {
  delete Buffer;
}

extern "C" const void*
LLVMCrabLangThinLTOBufferPtr(const LLVMCrabLangThinLTOBuffer *Buffer) {
  return Buffer->data.data();
}

extern "C" size_t
LLVMCrabLangThinLTOBufferLen(const LLVMCrabLangThinLTOBuffer *Buffer) {
...
LLVMCrabLangParseBitcodeForLTO(LLVMContextRef Context,
                           const char *data,
                           size_t len,
                           const char *identifier) {
...
extern "C" const char*
LLVMCrabLangGetBitcodeSliceFromObjectData(const char *data,
                                      size_t len,
                                      size_t *out_len) {
  *out_len = 0;
  ...
  if (!BitcodeOrError) {
    LLVMCrabLangSetLastError(toString(BitcodeOrError.takeError()).c_str());
    return nullptr;
  }
...
extern "C" void
LLVMCrabLangThinLTOGetDICompileUnit(LLVMModuleRef Mod,
                                DICompileUnit **A,
                                DICompileUnit **B) {
  Module *M = unwrap(Mod);
  DICompileUnit **Cur = A;
...
// the comment in `back/lto.rs` for why this exists.
extern "C" void
LLVMCrabLangThinLTOPatchDICompileUnit(LLVMModuleRef Mod, DICompileUnit *Unit) {
  Module *M = unwrap(Mod);
...
extern "C" void
LLVMCrabLangComputeLTOCacheKey(CrabLangStringRef KeyOut, const char *ModId, LLVMCrabLangThinLTOData *Data) {
  SmallString<40> Key;
  ...
  LLVMCrabLangStringWriteImpl(KeyOut, Key.c_str(), Key.size());
}
