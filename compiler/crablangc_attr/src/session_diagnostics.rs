...
#[derive(Diagnostic)]
#[diag(attr_crablangc_promotable_pairing, code = "E0717")]
pub(crate) struct CrabLangcPromotablePairing {
    #[primary_span]
    pub span: Span,
}

#[derive(Diagnostic)]
#[diag(attr_crablangc_allowed_unstable_pairing, code = "E0789")]
pub(crate) struct CrabLangcAllowedUnstablePairing {
    #[primary_span]
    pub span: Span,
}
