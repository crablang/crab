...
attr_crablangc_promotable_pairing =
    `crablangc_promotable` attribute must be paired with either a `crablangc_const_unstable` or a `crablangc_const_stable` attribute

attr_crablangc_allowed_unstable_pairing =
    `crablangc_allowed_through_unstable_modules` attribute must be paired with a `stable` attribute
