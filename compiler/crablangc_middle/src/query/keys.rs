...
use crablangc_hir::hir_id::{HirId, OwnerId};
use crablangc_query_system::query::{DefaultCacheSelector, SingleCacheSelector, VecCacheSelector};
...
pub trait Key: Sized {
    ...
    //
    //      r-a issue: <https://github.com/crablang/crablang-analyzer/issues/13693>
    type CacheSelector;
