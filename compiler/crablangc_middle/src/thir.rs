//! THIR datatypes and definitions. See the [crablangc dev guide] for more info.
//!
...
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/thir.html
...
use crablangc_index::newtype_index;
use crablangc_index::vec::IndexVec;
use crablangc_middle::middle::region;
use crablangc_middle::mir::interpret::AllocId;
use crablangc_middle::mir::{self, BinOp, BorrowKind, FakeReadCause, Mutability, UnOp};
use crablangc_middle::ty::adjustment::PointerCast;
use crablangc_middle::ty::subst::SubstsRef;
use crablangc_middle::ty::{self, AdtDef, FnSig, Ty, UpvarSubsts};
use crablangc_middle::ty::{CanonicalUserType, CanonicalUserTypeAnnotation};
