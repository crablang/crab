...
use crablangc_session::DataTypeKind;
use crablangc_span::symbol::sym;
use crablangc_target::abi::{ReprOptions, VariantIdx, FIRST_VARIANT};
...
/// Moreover, CrabLang only allows recursive data types through indirection.
///
