...
use crate::ty::query;
use crablangc_data_structures::sync::{self, Lock};
...
/// This is the implicit state of crablangc. It contains the current
    ...
    F: FnOnce() -> R,
{
    TLV.with(|tlv| {
        ...
        let _reset = crablangc_data_structures::OnDrop(move || tlv.set(old));
        f()
    })
}
