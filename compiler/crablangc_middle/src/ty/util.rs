...
use crablangc_apfloat::Float as _;
...
use crablangc_target::abi::{Integer, IntegerType, Size, TargetDataLayout};
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn bound_explicit_item_bounds(
        self,
        def_id: DefId,
    ) -> ty::EarlyBinder<&'tcx [(ty::Predicate<'tcx>, crablangc_span::Span)]> {
    ...
    pub fn generator_layout_and_saved_local_names(
        ...
        IndexVec<mir::GeneratorSavedLocal, Option<crablangc_span::Symbol>>,
    ) {
        let tcx = self;
    ...
    pub fn def_kind_descr(self, def_kind: DefKind, def_id: DefId) -> &'static str {
        match def_kind {
            ...
            DefKind::Generator => match self.generator_kind(def_id).unwrap() {
                crablangc_hir::GeneratorKind::Async(..) => "async closure",
                crablangc_hir::GeneratorKind::Gen => "generator",
            },
    ...
    pub fn def_kind_descr_article(self, def_kind: DefKind, def_id: DefId) -> &'static str {
        match def_kind {
            ...
            DefKind::Generator => match self.generator_kind(def_id).unwrap() {
                crablangc_hir::GeneratorKind::Async(..) => "an",
                crablangc_hir::GeneratorKind::Gen => "a",
            },
            _ => def_kind.article(),
        }
    }
...
impl<'tcx> Ty<'tcx> {
    ...
    pub fn numeric_max_val(self, tcx: TyCtxt<'tcx>) -> Option<ty::Const<'tcx>> {
        let val = match self.kind() {
            ...
            ty::Float(fty) => Some(match fty {
                ty::FloatTy::F32 => crablangc_apfloat::ieee::Single::INFINITY.to_bits(),
                ty::FloatTy::F64 => crablangc_apfloat::ieee::Double::INFINITY.to_bits(),
            }),
            _ => None,
        };
    ...
    /// the attribute `crablangc_insignificant_dtor`.
    ///
...
pub fn is_intrinsic(tcx: TyCtxt<'_>, def_id: LocalDefId) -> bool {
    matches!(tcx.fn_sig(def_id).skip_binder().abi(), Abi::CrabLangIntrinsic | Abi::PlatformIntrinsic)
}
