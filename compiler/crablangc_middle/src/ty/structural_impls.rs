...
//! `TypeVisitable` traits for various types in the CrabLang compiler. Most are
...
CloneLiftImpls! {
    ...
    u64,
    String,
    crablangc_type_ir::DebruijnIndex,
}
...
TrivialTypeTraversalAndLiftImpls! {
    ::crablangc_target::abi::FieldIdx,
    ::crablangc_target::abi::VariantIdx,
    crate::middle::region::Scope,
    crate::ty::FloatTy,
    ::crablangc_ast::InlineAsmOptions,
    ::crablangc_ast::InlineAsmTemplatePiece,
    ::crablangc_ast::NodeId,
    ::crablangc_span::symbol::Symbol,
    ::crablangc_hir::def::Res,
    ::crablangc_hir::def_id::DefId,
    ::crablangc_hir::def_id::LocalDefId,
    ::crablangc_hir::HirId,
    ::crablangc_hir::MatchSource,
    ::crablangc_hir::Mutability,
    ::crablangc_hir::Unsafety,
    ::crablangc_target::asm::InlineAsmRegOrRegClass,
    ::crablangc_target::spec::abi::Abi,
