...
pub struct TraitDef {
    ...
    /// If `true`, then this trait had the `#[crablangc_paren_sugar]`
    ...
    /// If `true`, then this trait has to `#[crablangc_coinductive]` attribute or
    ...
    /// If `true`, then this trait has the `#[crablangc_skip_array_during_method_dispatch]`
    ...
    /// List of functions from `#[crablangc_must_implement_one_of]` attribute one of which
    /// must be implemented.
...
pub enum TraitSpecializationKind {
    ...
    /// Applies to traits with the `crablangc_unsafe_specialization_marker`
    /// attribute.
    Marker,
    ...
    /// Applies to traits with the `crablangc_specialization_trait` attribute.
    AlwaysApplicable,
}
