...
use crablangc_data_structures::sharded::{IntoPointer, ShardedHashMap};
use crablangc_data_structures::stable_hasher::{HashStable, StableHasher};
use crablangc_data_structures::steal::Steal;
use crablangc_data_structures::sync::{self, Lock, Lrc, MappedReadGuard, ReadGuard, WorkerLocal};
...
use crablangc_query_system::dep_graph::DepNodeIndex;
...
pub trait OnDiskCache<'tcx>: crablangc_data_structures::sync::Sync {
...
///
/// [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/ty.html
#[derive(Copy, Clone)]
#[crablangc_diagnostic_item = "TyCtxt"]
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    /// `crablangc_layout_scalar_valid_range` attribute.
    ...
    pub fn layout_scalar_valid_range(self, def_id: DefId) -> (Bound<u128>, Bound<u128>) {
        let get = |name| {
            ...
            ) = attr.meta_item_list().as_deref()
            {
                ...
                self.sess
                    .delay_span_bug(attr.span, "invalid crablangc_layout_scalar_valid_range attribute");
                Bound::Unbounded
            }
        };
        (
            get(sym::crablangc_layout_scalar_valid_range_start),
            get(sym::crablangc_layout_scalar_valid_range_end),
        )
    }
    ...
    pub fn lang_items(self) -> &'tcx crablangc_hir::lang_items::LanguageItems {
        self.get_lang_items(())
    }
    ...
    pub fn features(self) -> &'tcx crablangc_feature::Features {
        self.features_query(())
    }

    pub fn def_key(self, id: DefId) -> crablangc_hir::definitions::DefKey {
    ...
    pub fn def_path(self, id: DefId) -> crablangc_hir::definitions::DefPath {
    ...
    #[inline]
    pub fn def_path_hash(self, def_id: DefId) -> crablangc_hir::definitions::DefPathHash {
...
impl<'tcx> TyCtxt<'tcx> {
    pub fn iter_local_def_id(self) -> impl Iterator<Item = LocalDefId> + 'tcx {
        ...
        std::iter::from_generator(|| {
            ...
            while i < { definitions.read().num_definitions() } {
                let local_def_index = crablangc_span::def_id::DefIndex::from_usize(i);
    ...
    pub fn def_path_table(self) -> &'tcx crablangc_hir::definitions::DefPathTable {
    ...
    pub fn def_path_hash_to_def_index_map(
        self,
    ) -> &'tcx crablangc_hir::def_path_hash_map::DefPathHashMap {
        // Create a dependency to the crate to be sure we re-execute this when the amount of
        // definitions change.
    ...
    pub fn local_crate_exports_generics(self) -> bool {
        ...
        self.sess.crate_types().iter().any(|crate_type| {
            match crate_type {
                ...
                // FIXME crablang/crablang#64319, crablang/crablang#64872:
                // We want to block export of generics from dylibs,
                // but we must fix crablang/crablang#65890 before we can
                // do that robustly.
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn signature_unclosure(
        ...
        sig.map_bound(|s| {
            ...
            self.mk_fn_sig(params, s.output(), s.c_variadic, unsafety, abi::Abi::CrabLang)
        })
    }
        ...
        if self.is_const_fn_raw(def_id) {
            match self.lookup_const_stability(def_id) {
                Some(stability) if stability.is_const_unstable() => {
                    // has a `crablangc_const_unstable` attribute, check whether the user enabled the
    ...
    pub fn trait_solver_next(self) -> bool {
        self.sess.opts.unstable_opts.trait_solver == crablangc_session::config::TraitSolver::Next
    }
