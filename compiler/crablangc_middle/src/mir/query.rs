...
use crablangc_index::bit_set::BitMatrix;
...
impl UnsafetyViolationDetails {
    pub fn description_and_note(&self) -> (&'static str, &'static str) {
        ...
        match self {
            ...
            InitializingTypeWith => (
                "initializing type with `crablangc_layout_scalar_valid_range` attr",
            ...
            UseOfExternStatic => (
                ...
                "extern statics are not controlled by the CrabLang type system: invalid data, \
...
/// `crablangc_const_eval/src/transform/check_consts/qualifs.rs`. See that file for more information on each
/// `Qualif`.
...
crablangc_data_structures::static_assert_size!(ConstraintCategory<'_>, 16);

/// Outlives-constraints can be categorized to determine whether and why they
/// are interesting (for error reporting). Order of variants indicates sort
/// order of the category, thereby influencing diagnostic output.
///
/// See also `crablangc_const_eval::borrow_check::constraints`.
