...
/// Represents a constant value in CrabLang. `Scalar` and `Slice` are optimizations for
...
///
/// These variants would be private if there was a convenient way to achieve that in CrabLang.
