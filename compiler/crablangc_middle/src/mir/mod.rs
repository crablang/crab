//! MIR datatypes and passes. See the [crablangc dev guide] for more info.
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/mir/index.html
...
use crablangc_hir::def::{CtorKind, Namespace};
use crablangc_hir::def_id::{DefId, LocalDefId, CRATE_DEF_ID};
use crablangc_hir::{self, GeneratorKind, ImplicitSelfKind};
use crablangc_hir::{self as hir, HirId};
use crablangc_session::Session;
use crablangc_target::abi::{FieldIdx, Size, VariantIdx};

use polonius_engine::Atom;
pub use crablangc_ast::Mutability;
...
pub struct Body<'tcx> {
    ...
    ///
    /// This is used for the "crablang-call" ABI.
    ...
    ///
    /// This is only `Some` if the function that this body comes from was annotated with `crablangc_custom_mir`.
...
crablangc_index::newtype_index! {
    ...
    ///
    /// Read more about basic blocks in the [crablangc-dev-guide][guide-mir].
    ///
    /// [CFG]: https://crablangc-dev-guide.crablang.org/appendix/background.html#cfg
    /// [data-flow analyses]:
    ///     https://crablangc-dev-guide.crablang.org/appendix/background.html#what-is-a-dataflow-analysis
    /// [`CriticalCallEdges`]: ../../crablangc_const_eval/transform/add_call_guards/enum.AddCallGuards.html#variant.CriticalCallEdges
    /// [guide-mir]: https://crablangc-dev-guide.crablang.org/mir/
    #[derive(HashStable)]
    #[debug_format = "bb{}"]
...
impl<'tcx> BasicBlockData<'tcx> {
    ...
    where
        ...
        I: iter::TcrablangedLen<Item = Statement<'tcx>>,
    {
...
/// this does not necessarily mean that they are `==` in CrabLang. In
