...
pub fn trigger_delay_span_bug(tcx: TyCtxt<'_>, key: crablangc_hir::def_id::DefId) {
    tcx.sess.delay_span_bug(
        tcx.def_span(key),
        "delayed span bug triggered by #[crablangc_error(delay_span_bug_from_inside_query)]",
    );
}
