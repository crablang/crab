...
use crablangc_attr::{InlineAttr, InstructionSetAttr, OptimizeAttr};
...
pub struct CodegenFnAttrs {
    ...
    /// `#[export_name]` is for CrabLang-defined functions.
    ...
    /// The `#[linkage = "..."]` attribute on CrabLang-defined items and the value we found.
...
bitflags! {
    ...
    pub struct CodegenFnAttrFlags: u32 {
        ...
        /// the hot path.
        const COLD                      = 1 << 0;
        /// `#[crablangc_allocator]`: a hint to LLVM that the pointer returned from this
        ...
        /// as its symbol.
        const NO_MANGLE                 = 1 << 5;
        /// `#[crablangc_std_internal_symbol]`: an indicator that this symbol is a
        /// "weird symbol" for the standard library in that it has slightly
        /// different linkage, visibility, and reachability rules.
        const CRABLANGC_STD_INTERNAL_SYMBOL = 1 << 6;
        ...
        /// #[cmse_nonsecure_entry]: with a TcrablangZone-M extension, declare a
        ...
        /// `#[crablangc_deallocator]`: a hint to LLVM that the function only deallocates memory.
        const DEALLOCATOR               = 1 << 17;
        /// `#[crablangc_reallocator]`: a hint to LLVM that the function only reallocates memory.
        const REALLOCATOR               = 1 << 18;
        /// `#[crablangc_allocator_zeroed]`: a hint to LLVM that the function only allocates zeroed memory.
