//! Trait Resolution. See the [crablangc dev guide] for more information on how this works.
//!
//! [crablangc dev guide]: https://crablangc-dev-guide.crablang.org/traits/resolution.html
...
use crablangc_span::def_id::{LocalDefId, CRATE_DEF_ID};
...
pub use self::chalk::{ChalkEnvironmentAndGoal, CrabLangInterner as ChalkCrabLangInterner};
...
pub enum ObligationCauseCode<'tcx> {
    ...
    ExprItemObligation(DefId, crablangc_hir::HirId, usize),

    /// Combines `ExprItemObligation` and `BindingObligation`.
    ExprBindingObligation(DefId, Span, crablangc_hir::HirId, usize),
