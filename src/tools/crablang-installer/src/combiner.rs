    ...
    pub fn run(self) -> Result<()> {
            ...
            .filter(|s| !s.is_empty())
        {
            ...
            for component in pkg_components.split_whitespace() {
                ...
                // move it, but crablangbuild wants to reuse the unpacked package
        ...
        let version = package_dir.join("crablang-installer-version");
        writeln!(
            create_new_file(version)?,
            "{}",
            crate::CRABLANG_INSTALLER_VERSION
        )
