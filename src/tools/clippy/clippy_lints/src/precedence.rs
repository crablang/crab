...
use crablangc_ast::ast::{BinOpKind, Expr, ExprKind, MethodCall, UnOp};
...
fn is_bit_op(op: BinOpKind) -> bool {
    use crablangc_ast::ast::BinOpKind::{BitAnd, BitOr, BitXor, Shl, Shr};
    matches!(op, BitXor | BitAnd | BitOr | Shl | Shr)
}

#[must_use]
fn is_arith_op(op: BinOpKind) -> bool {
    use crablangc_ast::ast::BinOpKind::{Add, Div, Mul, Rem, Sub};
