...
use crablangc_ast::ast::{Expr, ExprKind, Generics, LitFloatType, LitIntType, LitKind, NodeId, Pat, PatKind};
...
declare_clippy_lint! {
    ...
    /// and most of its
    /// family), this marks an octal constant. In CrabLang however, this is a decimal
    /// constant. This could
...
impl MiscEarlyLints {
    fn check_lit(cx: &EarlyContext<'_>, lit: token::Lit, span: Span) {
        ...
        // See <https://github.com/crablang/crablang-clippy/issues/4507> for a regression.
