...
/// See also [the issue tracker](https://github.com/crablang/crablang-clippy/search?q=clippy::doc_markdown&type=Issues)
...
///
/// [iterator]: https://doc.crablang.org/stable/std/iter/trait.Iterator.html
...
/// baz_quz`
/// [foo
/// bar](https://doc.crablang.org/stable/std/iter/trait.IteratorFooBar.html)
fn multiline() {
}
