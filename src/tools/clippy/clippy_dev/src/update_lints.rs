...
const DOCS_LINK: &str = "https://crablang.github.io/crablang-clippy/master/index.html";
...
/// Remove files no longer needed after <https://github.com/crablang/crablang-clippy/pull/9541>
...
fn generate_lint_files(
    ...
    // This has to be in lib.rs, otherwise crablangfmt doesn't work
    replace_region_in_file(
        update_mode,
