This document outlines processes regarding management of crablangfmt.

# Stabilising an Option

In this Section, we describe how to stabilise an option of the crablangfmt's configuration.
...
E.g., https://github.com/crablang/crablangfmt/commit/5274b49caa1a7db6ac10c76bf1a3d5710ccef569
...
## 5. Create a PR to crablang/crablang to update the crablangfmt submodule
