...
fn nested_out_of_line_mods_loaded() {
    // See also https://github.com/crablang/crablangfmt/issues/4874
...
fn out_of_line_nested_inline_within_out_of_line() {
    // See also https://github.com/crablang/crablangfmt/issues/5063
    verify_mod_resolution(
...
fn skip_out_of_line_nested_inline_within_out_of_line() {
    // See also https://github.com/crablang/crablangfmt/issues/5065
    verify_mod_resolution(
...
fn fallback_and_try_to_resolve_external_submod_relative_to_current_dir_path() {
    // See also https://github.com/crablang/crablangfmt/issues/5198
    verify_mod_resolution(
