...
fn parser_errors_in_submods_are_surfaced() {
    // See also https://github.com/crablang/crablangfmt/issues/4126
...
fn parser_creation_errors_on_entry_new_parser_from_file_panic() {
    // See also https://github.com/crablang/crablangfmt/issues/4418
...
fn crate_parsing_errors_on_unclosed_delims() {
    // See also https://github.com/crablang/crablangfmt/issues/4466
