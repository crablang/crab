...
///
/// The environment variable `CFG_RELEASE_CHANNEL` is set during the crablangc bootstrap
...
///
/// If we're being built by cargo (e.g., `cargo +nightly install crablangfmt-nightly`),
