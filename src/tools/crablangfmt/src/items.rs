...
use crablangc_span::{symbol, BytePos, Span, DUMMY_SP};
...
pub(crate) fn format_trait(
    ...
    if let ast::ItemKind::Trait(trait_kind) = &item.kind {
        ...
        // FIXME(#2055): crablangfmt fails to format when there are comments between trait bounds.
        if !bounds.is_empty() {
...
pub(crate) fn rewrite_type_alias<'a, 'b>(
    ...
    // https://crablangc-dev-guide.crablang.org/opaque-types-type-alias-impl-trait.html
    // https://github.com/crablang-dev-tools/fmt-rfcs/blob/master/guide/items.md#type-aliases
...
// https://github.com/crablang/crablangfmt/issues/4373
// https://github.com/crablang/crablangfmt/issues/5027
struct OpaqueType<'a> {
...
impl Rewrite for ast::Param {
    fn rewrite(&self, context: &RewriteContext<'_>, shape: Shape) -> Option<String> {
        ...
        // in the presence of certain macros - https://github.com/crablang/crablangfmt/issues/4936
