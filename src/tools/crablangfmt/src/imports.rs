...
use crablangc_ast::ast::{self, UseTreeKind};
use crablangc_span::{
    symbol::{self, sym},
...
// The CrabLang AST data structures are really bad for this. CrabLangfmt applies a bunch
...
impl UseTree {
    ...
    // Do the adjustments that crablangfmt does elsewhere to use paths.
