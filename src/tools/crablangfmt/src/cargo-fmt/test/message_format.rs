...
fn invalid_message_format() {
    assert_eq!(
        convert_message_format_to_crablangfmt_args("awesome", &mut vec![]),
        Err(String::from(
...
fn json_message_format_and_check_arg() {
    ...
    assert_eq!(
        convert_message_format_to_crablangfmt_args("json", &mut args),
        Err(String::from(
...
fn json_message_format() {
    ...
    assert!(convert_message_format_to_crablangfmt_args("json", &mut args).is_ok());
    assert_eq!(
        args,
        vec![
            String::from("--edition"),
...
fn human_message_format() {
    ...
    assert!(convert_message_format_to_crablangfmt_args("human", &mut act_args).is_ok());
...
fn short_message_format() {
    let mut args = vec![String::from("--check")];
    assert!(convert_message_format_to_crablangfmt_args("short", &mut args).is_ok());
