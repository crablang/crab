...
use crablangc_ast::token::Delimiter;
...
const SPECIAL_CASE_MACROS: &[(&str, usize)] = &[
    // format! like macros
    // From the CrabLang Standard Library.
    ("eprint!", 0),
    ("eprintln!", 0),
    ("format!", 0),
    ("format_args!", 0),
...
macro_rules! impl_into_overflowable_item_for_crablangfmt_types {
...
impl_into_overflowable_item_for_crablangfmt_types!([MacroArg], [SegmentParam, TuplePatField]);
