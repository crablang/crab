...
#![doc(
    html_logo_url = "https://www.crablang.org/logos/crablang-logo-128x128-blk-v2.png",
...
/// <div crablangbindgen accessor></div>
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct ContradictAccessors {
    ///<foo>no leading spaces here</foo>
    pub mBothAccessors: ::std::os::raw::c_int,
    /// <div crablangbindgen accessor="false"></div>
    pub mNoAccessors: ::std::os::raw::c_int,
    /// <div crablangbindgen accessor="unsafe"></div>
    pub mUnsafeAccessors: ::std::os::raw::c_int,
    /// <div crablangbindgen accessor="immutable"></div>
