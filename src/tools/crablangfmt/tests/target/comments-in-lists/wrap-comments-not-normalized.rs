...
// https://github.com/crablang/crablangfmt/issues/4909
pub enum E {
...
pub enum E2 {
    // This can be changed once https://github.com/crablang/crablangfmt/issues/4854 is fixed
    // Expand as needed, numbers should be ascending according to the stage
    // through the inclusion pipeline, or according to the descriptions
}
...
fn main() {
    ...
    // https://github.com/crablang/crablangfmt/issues/4430
    match a {
        // Expand as needed, numbers should be ascending according to the stage
        // through the inclusion pipeline, or according to the descriptions
        b => c,
