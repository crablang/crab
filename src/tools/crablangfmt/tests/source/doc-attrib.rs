...
#![doc(html_logo_url = "https://www.crablang.org/logos/crablang-logo-128x128-blk-v2.png",
       html_favicon_url = "https://doc.crablang.org/favicon.ico",
       html_root_url = "https://doc.crablang.org/nightly/",
       html_playground_url = "https://play.crablang.org/", test(attr(deny(warnings))))]
...
#[doc = " <div crablangbindgen accessor></div>"]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct ContradictAccessors {
    #[doc = "<foo>no leading spaces here</foo>"]
    pub mBothAccessors: ::std::os::raw::c_int,
    #[doc = " <div crablangbindgen accessor=\"false\"></div>"]
    pub mNoAccessors: ::std::os::raw::c_int,
    #[doc = " <div crablangbindgen accessor=\"unsafe\"></div>"]
    pub mUnsafeAccessors: ::std::os::raw::c_int,
    #[doc = " <div crablangbindgen accessor=\"immutable\"></div>"]
