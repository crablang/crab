...
CrabLangfmt is designed to be very configurable. You can create a TOML file called `crablangfmt.toml` or `.crablangfmt.toml`, place it in the project or any other parent directory and it will apply the options in that file. If none of these directories contain such a file, both your home directory and a directory called `crablangfmt` in your [global config directory](https://docs.rs/dirs/4.0.0/dirs/fn.config_dir.html) (e.g. `.config/crablangfmt/`) are checked as well.

A possible content of `crablangfmt.toml` or `.crablangfmt.toml` might look like this:
...
To enable unstable options, set `unstable_features = true` in `crablangfmt.toml` or pass `--unstable-features` to crablangfmt.

# Configuration Options

Below you find a detailed visual guide on all the supported configuration options of crablangfmt:
...
- **Stable**: No (tracking issue: [#3368](https://github.com/crablang/crablangfmt/issues/3368))
...
- **Stable**: No (tracking issue: [#3382](https://github.com/crablang/crablangfmt/issues/3382))

### Example
Original Code (crablangfmt will not change it with the default value of `0`):
...
- **Stable**: No (tracking issue: [#3381](https://github.com/crablang/crablangfmt/issues/3381))
...
- **Stable**: No (tracking issue: [#3376](https://github.com/crablang/crablangfmt/issues/3376))
...
- **Stable**: No (tracking issue: [#3385](https://github.com/crablang/crablangfmt/issues/3385))
...
- **Stable**: No (tracking issue: [#3369](https://github.com/crablang/crablangfmt/issues/3369))
...
- **Stable**: No (tracking issue: [#3349](https://github.com/crablang/crablangfmt/issues/3349))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3384](https://github.com/crablang/crablangfmt/issues/3384))
...
- **Stable**: No (tracking issue: [#3377](https://github.com/crablang/crablangfmt/issues/3377))
...
CrabLangfmt is able to pick up the edition used by reading the `Cargo.toml` file if executed
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3356](https://github.com/crablang/crablangfmt/issues/3356))
...
- **Default value** : 0
- **Possible values**: any positive integer
- **Stable**: No (tracking issue: [#3372](https://github.com/crablang/crablangfmt/issues/3372))
...
Error if CrabLangfmt is unable to get all lines within `max_width`, except for comments and string
literals. If this happens, then it is a bug in CrabLangfmt. You might be able to work around the bug by
refactoring your code to avoid long/complex expressions, usually by extracting a local variable or
using a shorter name.

- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3391](https://github.com/crablang/crablangfmt/issues/3391))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3392](https://github.com/crablang/crablangfmt/issues/3392))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3358](https://github.com/crablang/crablangfmt/issues/3358))
...
- **Stable**: No (tracking issue: [#3374](https://github.com/crablang/crablangfmt/issues/3374))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3348](https://github.com/crablang/crablangfmt/issues/3348))
...
- **Default value**: `100`
- **Possible values**: any positive integer that is less than or equal to the value specified for [`max_width`](#max_width)
- **Stable**: No (tracking issue: [#5359](https://github.com/crablang/crablangfmt/issues/5359))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#5080](https://github.com/crablang/crablangfmt/issues/5080))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3354](https://github.com/crablang/crablangfmt/issues/3354))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3355](https://github.com/crablang/crablangfmt/issues/3355))
...
crablangfmt will not format any macro invocation for macros with names set in this list.
Including the special value "*" will prevent any macro invocations from being formatted.

Note: This option does not have any impact on how crablangfmt formats macro definitions.

- **Default value**: `[]`
- **Possible values**: a list of macro name idents, `["name_0", "name_1", ..., "*"]`
- **Stable**: No (tracking issue: [#5346](https://github.com/crablang/crablangfmt/issues/5346))

#### `[]` (default):

crablangfmt will follow its standard approach to formatting macro invocations.

No macro invocations will be skipped based on their name. More information about crablangfmt's standard macro invocation formatting behavior can be found in [#5437](https://github.com/crablang/crablangfmt/discussions/5437).
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3353](https://github.com/crablang/crablangfmt/issues/3353))
...
- **Stable**: No (tracking issue: [#5081](https://github.com/crablang/crablangfmt/issues/5081))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3390](https://github.com/crablang/crablangfmt/issues/3390))
...
- **Stable**: No (tracking issue: [#3395](https://github.com/crablang/crablangfmt/issues/3395))
...
If you want to ignore every file under the directory where you put your crablangfmt.toml:
...
- **Stable**: No (tracking issue: [#3360](https://github.com/crablang/crablangfmt/issues/3360))
...
- **Stable**: No (tracking issue: [#3361](https://github.com/crablang/crablangfmt/issues/3361))
...
- **Default value**: `"Block"`
- **Possible values**: `"Block"`, `"Visual"`
- **Stable**: No (tracking issue: [#3346](https://github.com/crablang/crablangfmt/issues/3346))
...
- **Default value**: 0
- **Possible values**: any positive integer
- **Stable**: No (tracking issue: [#3343](https://github.com/crablang/crablangfmt/issues/3343))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3373](https://github.com/crablang/crablangfmt/issues/3373))
...
Note that crablangfmt will not modify the granularity of imports containing comments if doing so could potentially lose or misplace said comments.

- **Default value**: `Preserve`
- **Possible values**: `Preserve`, `Crate`, `Module`, `Item`, `One`
- **Stable**: No (tracking issue: [#4991](https://github.com/crablang/crablangfmt/issues/4991))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3350](https://github.com/crablang/crablangfmt/issues/3350))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3351](https://github.com/crablang/crablangfmt/issues/3351))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3370](https://github.com/crablang/crablangfmt/issues/3370))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3363](https://github.com/crablang/crablangfmt/issues/3363))
...
- **Stable**: No (tracking issue: [#5083](https://github.com/crablang/crablangfmt/issues/5083))
...
Require a specific version of crablangfmt. If you want to make sure that the
specific version of crablangfmt is used in your CI, use this option.

- **Default value**: `CARGO_PKG_VERSION`
- **Possible values**: any published version (e.g. `"0.3.8"`)
- **Stable**: No (tracking issue: [#3386](https://github.com/crablang/crablangfmt/issues/3386))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3389](https://github.com/crablang/crablangfmt/issues/3389))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3366](https://github.com/crablang/crablangfmt/issues/3366))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3365](https://github.com/crablang/crablangfmt/issues/3365))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3367](https://github.com/crablang/crablangfmt/issues/3367))
...
- **Default value** : 0
- **Possible values**: any non-negative integer
- **Stable**: No (tracking issue: [#3371](https://github.com/crablang/crablangfmt/issues/3371))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3357](https://github.com/crablang/crablangfmt/issues/3357))
...
- **Stable**: No (tracking issue: [#3379](https://github.com/crablang/crablangfmt/issues/3379))
...
- **Default value**: `true`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3378](https://github.com/crablang/crablangfmt/issues/3378))
...
- **Stable**: No (tracking issue: [#3364](https://github.com/crablang/crablangfmt/issues/3364))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3387](https://github.com/crablang/crablangfmt/issues/3387))
...
with CrabLangfmt 1.0. Other versions are only backwards compatible within a major
version number.

- **Default value**: `One`
- **Possible values**: `One`, `Two`
- **Stable**: No (tracking issue: [#3383](https://github.com/crablang/crablangfmt/issues/3383))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3359](https://github.com/crablang/crablangfmt/issues/3359))
...
- **Default value**: `false`
- **Possible values**: `true`, `false`
- **Stable**: No (tracking issue: [#3347](https://github.com/crablang/crablangfmt/issues/3347))
