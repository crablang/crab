/**
 * This file mirrors `crates/crablang-analyzer/src/lsp_ext.rs` declarations.
 */

import * as lc from "vscode-languageclient";

// crablang-analyzer overrides
...
// crablang-analyzer extensions

export const analyzerStatus = new lc.RequestType<AnalyzerStatusParams, string, void>(
    "crablang-analyzer/analyzerStatus"
);
export const cancelFlycheck = new lc.NotificationType0("crablang-analyzer/cancelFlycheck");
export const clearFlycheck = new lc.NotificationType0("crablang-analyzer/clearFlycheck");
export const expandMacro = new lc.RequestType<ExpandMacroParams, ExpandedMacro | null, void>(
    "crablang-analyzer/expandMacro"
);
export const memoryUsage = new lc.RequestType0<string, void>("crablang-analyzer/memoryUsage");
export const openServerLogs = new lc.NotificationType0("crablang-analyzer/openServerLogs");
export const relatedTests = new lc.RequestType<lc.TextDocumentPositionParams, TestInfo[], void>(
    "crablang-analyzer/relatedTests"
);
export const reloadWorkspace = new lc.RequestType0<null, void>("crablang-analyzer/reloadWorkspace");

export const runFlycheck = new lc.NotificationType<{
    textDocument: lc.TextDocumentIdentifier | null;
}>("crablang-analyzer/runFlycheck");
export const shuffleCrateGraph = new lc.RequestType0<null, void>("crablang-analyzer/shuffleCrateGraph");
export const syntaxTree = new lc.RequestType<SyntaxTreeParams, string, void>(
    "crablang-analyzer/syntaxTree"
);
export const viewCrateGraph = new lc.RequestType<ViewCrateGraphParams, string, void>(
    "crablang-analyzer/viewCrateGraph"
);
export const viewFileText = new lc.RequestType<lc.TextDocumentIdentifier, string, void>(
    "crablang-analyzer/viewFileText"
);
export const viewHir = new lc.RequestType<lc.TextDocumentPositionParams, string, void>(
    "crablang-analyzer/viewHir"
);
export const viewMir = new lc.RequestType<lc.TextDocumentPositionParams, string, void>(
    "crablang-analyzer/viewMir"
);
export const viewItemTree = new lc.RequestType<ViewItemTreeParams, string, void>(
    "crablang-analyzer/viewItemTree"
);
