...
export const log = new (class {
    ...
    private readonly output = vscode.window.createOutputChannel("CrabLang Analyzer Client");
...
export type CrabLangDocument = vscode.TextDocument & { languageId: "crablang" };
export type CrabLangEditor = vscode.TextEditor & { document: CrabLangDocument };

export function isCrabLangDocument(document: vscode.TextDocument): document is CrabLangDocument {
    ...
    return document.languageId === "crablang" && document.uri.scheme === "file";
}

export function isCargoTomlDocument(document: vscode.TextDocument): document is CrabLangDocument {
...
export function isCrabLangEditor(editor: vscode.TextEditor): editor is CrabLangEditor {
    return isCrabLangDocument(editor.document);
}
