...
struct FlycheckActor {
    ...
    /// run `cargo check` without blocking. Currently the CrabLang standard library
...
impl CargoActor {
    ...
    fn run(self) -> io::Result<(bool, String)> {
        ...
        let process_line = |line: &str, error: &mut String| {
            // Try to deserialize a message from Cargo or CrabLangc.
