...
//! checking algorithm.
//!
//! It is modeled on the crablangc module `crablangc_mir_build::thir::pattern`.
...
/// Close relative to `crablangc_mir_build::thir::pattern::PatKind`
#[derive(Clone, Debug, PartialEq)]
...
impl<'a> PatCtxt<'a> {
    ...
    pub(crate) fn lower_pattern(&mut self, pat: PatId) -> Pat {
        ...
        // More info https://github.com/crablang/crablang/issues/42640#issuecomment-313535089
