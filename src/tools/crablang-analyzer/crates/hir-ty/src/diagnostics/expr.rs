    ...
    fn validate_match(
        ...
        for arm in arms {
            if let Some(pat_ty) = self.infer.type_of_pat.get(arm.pat) {
                ...
                // block here.
                //
                // When comparing the types, we also have to consider that crablangc
        ...
        // https://github.com/crablang/crablang/blob/f31622a50/compiler/crablangc_mir_build/src/thir/pattern/check_match.rs#L200
