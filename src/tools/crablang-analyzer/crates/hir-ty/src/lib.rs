...
/// generic arguments) in crablang-analyzer is that the ordering within *is* significant - the generic
...
pub enum ConstScalar {
    ...
    /// Case of an unknown value that crablangc might know but we don't
    // FIXME: this is a hack to get around chalk not being able to represent unevaluatable
    // constants
    // https://github.com/crablang/crablang-analyzer/pull/8813#issuecomment-840679177
    // https://crablang.zulipchat.com/#narrow/stream/144729-wg-traits/topic/Handling.20non.20evaluatable.20constants'.20equality/near/238386348
    Unknown,
}
