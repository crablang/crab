...
use hir_def::{
    adt::VariantData,
    layout::{Integer, IntegerExt, Layout, LayoutCalculator, LayoutError, CrabLangcEnumVariantIdx},
...
pub(crate) fn struct_variant_idx() -> CrabLangcEnumVariantIdx {
    CrabLangcEnumVariantIdx(LocalEnumVariantId::from_raw(RawIdx::from(0)))
}
...
pub fn layout_of_adt_query(
    ...
    if is_union {
        ...
        cx.layout_of_struct_or_enum(
            ...
            // The code that do it in crablangc:
...
fn layout_scalar_valid_range(db: &dyn HirDatabase, def: AdtId) -> (Bound<u128>, Bound<u128>) {
    ...
    (get("crablangc_layout_scalar_valid_range_start"), get("crablangc_layout_scalar_valid_range_end"))
}
