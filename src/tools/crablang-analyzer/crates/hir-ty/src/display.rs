    ...
    fn hir_fmt(
        ...
        match self.kind(Interner) {
            ...
            TyKind::AssociatedType(assoc_type_id, parameters) => {
                ...
                // Use placeholder associated types when the target is test (https://crablang.github.io/chalk/book/clauses/type_equality.html#placeholder-associated-types)
...
fn write_bounds_like_dyn_trait(
    ...
    // corresponding to surface CrabLang) for types that can occur in
    // actual CrabLang. It will have weird results if the predicates
    ...
    for p in predicates.iter() {
        match p.skip_binders() {
            WhereClause::Implemented(trait_ref) => {
                ...
                // possible in actual CrabLang, and hence don't print it
                f.start_location_link(trait_.into());
            ...
            WhereClause::AliasEq(AliasEq { ty, alias }) => {
                // in types in actual CrabLang, these will always come
