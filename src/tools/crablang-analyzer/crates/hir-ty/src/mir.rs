...
/// An operand in MIR represents a "value" in CrabLang, the definition of which is undecided and part of
/// the memory model. One proposal for a definition of values can be found [on UCG][value-def].
///
/// [value-def]: https://github.com/crablang/unsafe-code-guidelines/blob/master/wip/value-domain.md
///
...
/// something we can even decide without knowing more about CrabLang's memory model?
///
...
pub enum Operand {
    ...
    ///
    /// [UCG#188]: https://github.com/crablang/unsafe-code-guidelines/issues/188
    Move(Place),
...
pub enum Terminator {
    ...
    ///
    /// Like function calls, the exact semantics of returns in CrabLang are unclear. Returning very
    ...
    /// glue is special - this would be part of CrabLang's memory model. (**FIXME**: due we have an
    ...
    /// [#71117].
    ///
    /// [#71117]: https://github.com/crablang/crablang/issues/71117
    Call {
...
pub enum Rvalue {
    ...
    ///
    /// [#74836]: https://github.com/crablang/crablang/issues/74836
    ...
    ///   same type and return a value of the same type as their LHS. Like in CrabLang, the RHS is
    ///   truncated as needed.
    ...
    /// [#91095]: https://github.com/crablang/crablang/issues/91095
    ...
    /// is guaranteed (via nature of the mir_opt `Derefer` in crablangc_mir_transform/src/deref_separator)
