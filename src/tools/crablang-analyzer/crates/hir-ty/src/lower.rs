...
impl<'a> TyLoweringContext<'a> {
    ...
    /// `create_substs_for_ast_path` and `def_to_ty` in crablangc.
    pub(super) fn substs_from_path(
        ...
        let (segment, generic_def) = match resolved {
            ...
            ValueTyDefId::EnumVariantId(var) => {
                ...
                // preferred). See also `def_ids_for_path_segments` in crablangc.
            ...
            TypeBound::Path(path, TraitBoundModifier::None) => {
                ...
                bindings
                    ...
                    .filter(|tr| {
                        ...
                        // - `T: ~const Drop` has a special meaning in CrabLang 1.61 that we don't implement.
                    ...
                    (WhereClause::AliasEq(lhs), WhereClause::AliasEq(rhs)) => {
                        match (&lhs.alias, &rhs.alias) {
                            (AliasTy::Projection(lhs_proj), AliasTy::Projection(rhs_proj)) => {
                                ...
                                // multiple bounds for an associated type in the correct CrabLang code,
...
/// like `T::Item`.
///
/// See the analogous query in crablangc and its comment:
/// <https://github.com/crablang/crablang/blob/9150f844e2624eb013ec78ca08c1d416e6644026/src/libcrablangc_typeck/astconv.rs#L46>
