...
pub const DEFAULT_LINTS: &[Lint] = &[
    ...
    Lint {
        ...
        description: r##"detects calling `into_iter` on arrays in CrabLang 2015 and 2018"##,
    },
    Lint {
    ...
    Lint {
        label: "crablang_2018_compatibility",
    ...
    Lint {
        label: "crablang_2021_compatibility",
        description: r##"lint group for: ellipsis-inclusive-range-patterns, bare-trait-objects, crablang-2021-incompatible-closure-captures, crablang-2021-incompatible-or-patterns, crablang-2021-prelude-collisions, crablang-2021-prefixes-incompatible-syntax, array-into-iter, non-fmt-panics"##,
    },
    Lint {
        label: "crablang_2021_incompatible_closure_captures",
        description: r##"detects closures affected by CrabLang 2021 changes"##,
    },
    Lint {
        label: "crablang_2021_incompatible_or_patterns",
        description: r##"detects usage of old versions of or-patterns"##,
    },
    Lint {
        label: "crablang_2021_prefixes_incompatible_syntax",
        description: r##"identifiers that will be parsed as a prefix in CrabLang 2021"##,
    },
    Lint {
        label: "crablang_2021_prelude_collisions",
    ...
    Lint {
        ...
        description: r##"detects doc comments that aren't used by crablangdoc"##,
    },
...
pub const CRABLANGDOC_LINTS: &[Lint] = &[
    Lint {
        label: "crablangdoc::all",
        description: r##"lint group for: crablangdoc::broken-intra-doc-links, crablangdoc::private-intra-doc-links, crablangdoc::missing-doc-code-examples, crablangdoc::private-doc-tests, crablangdoc::invalid-codeblock-attributes, crablangdoc::invalid-crablang-codeblocks, crablangdoc::invalid-html-tags, crablangdoc::bare-urls, crablangdoc::missing-crate-level-docs"##,
    },
    Lint { label: "crablangdoc::bare_urls", description: r##"detects URLs that are not hyperlinks"## },
    Lint {
        label: "crablangdoc::broken_intra_doc_links",
        description: r##"failures in resolving intra-doc link targets"##,
    },
    Lint {
        label: "crablangdoc::invalid_codeblock_attributes",
        description: r##"codeblock attribute looks a lot like a known one"##,
    },
    Lint {
        label: "crablangdoc::invalid_html_tags",
        description: r##"detects invalid HTML tags in doc comments"##,
    },
    Lint {
        label: "crablangdoc::invalid_crablang_codeblocks",
        description: r##"codeblock could not be parsed as valid CrabLang or is empty"##,
    },
    Lint {
        label: "crablangdoc::missing_crate_level_docs",
        description: r##"detects crates with no crate-level documentation"##,
    },
    Lint {
        label: "crablangdoc::missing_doc_code_examples",
        description: r##"detects publicly-exported items without code samples in their documentation"##,
    },
    Lint {
        label: "crablangdoc::private_doc_tests",
        description: r##"detects code samples in docs of private items not documented by crablangdoc"##,
    },
    Lint {
        label: "crablangdoc::private_intra_doc_links",
        description: r##"linking from a public item to a private one"##,
    },
];
pub const CRABLANGDOC_LINT_GROUPS: &[LintGroup] = &[LintGroup {
    lint: Lint {
        label: "crablangdoc::all",
        description: r##"lint group for: crablangdoc::broken-intra-doc-links, crablangdoc::private-intra-doc-links, crablangdoc::missing-doc-code-examples, crablangdoc::private-doc-tests, crablangdoc::invalid-codeblock-attributes, crablangdoc::invalid-crablang-codeblocks, crablangdoc::invalid-html-tags, crablangdoc::bare-urls, crablangdoc::missing-crate-level-docs"##,
    },
    children: &[
        "crablangdoc::broken_intra_doc_links",
        "crablangdoc::private_intra_doc_links",
        "crablangdoc::missing_doc_code_examples",
        "crablangdoc::private_doc_tests",
        "crablangdoc::invalid_codeblock_attributes",
        "crablangdoc::invalid_crablang_codeblocks",
        "crablangdoc::invalid_html_tags",
        "crablangdoc::bare_urls",
        "crablangdoc::missing_crate_level_docs",
    ],
}];
...
[#60553]: https://github.com/crablang/crablang/issues/60553
...
[#72016]: https://github.com/crablang/crablang/issues/72016
...
[`Send`]: https://doc.crablang.org/std/marker/trait.Send.html
[`Sync`]: https://doc.crablang.org/std/marker/trait.Sync.html
...
languages (such as C++) into CrabLang frames and from CrabLang into other languages.
...
defined in CrabLang. The may be called both from within CrabLang and via FFI.
...
[#77443]: https://github.com/crablang/crablang/issues/77443
...
it is possible that new panic strategies may be added to CrabLang in the
future.
...
[#53120]: https://github.com/crablang/crablang/issues/53120
...
[`Default::default()`]: https://doc.crablang.org/nightly/std/default/trait.Default.html#tymethod.default
...
[#83701]: https://github.com/crablang/crablang/issues/83701
...
[`Fn*`]: https://doc.crablang.org/std/ops/trait.Fn.html
...
[#54185]: https://github.com/crablang/crablang/issues/54185
...
#![feature(lang_items, box_syntax, start, libc, core_intrinsics, crablangc_private)]
#![no_std]
use core::intrinsics;
...
#[lang = "panic_impl"] extern fn crablang_begin_panic(info: &PanicInfo) -> ! { unsafe { intrinsics::abort() } }
...
[#70173]: https://github.com/crablang/crablang/issues/70173

------------------------

For extremely low-level manipulations and performance reasons, one
might wish to control the CPU directly. CrabLang supports using inline
...
The last section, `options` is specific to CrabLang. The format is comma
...
This modifier is supposed to supersede the `static-nobundle` linking kind defined by [RFC 1717](https://github.com/crablang/rfcs/pull/1717).
...
`+verbatim` means that crablangc itself won't add any target-specified library prefixes or suffixes (like `lib` or `.a`) to the library name, and will try its best to ask for the same thing from the linker.

For `ld`-like linkers crablangc will use the `-l:filename` syntax (note the colon) when passing the library, so the linker won't add any prefixes or suffixes as well.
...
This RFC changes the behavior of `raw-dylib` linking kind specified by [RFC 2627](https://github.com/crablang/rfcs/pull/2627). The `.dll` suffix (or other target-specified suffixes for other targets) is now added automatically.
...
#![feature(box_syntax, crablangc_private)]
...
lints](https://github.com/crablang/crablang/blob/master/src/libcrablangc_session/lint/builtin.rs)
...
"##,
    ...
    Lint {
        label: "crablangc_attrs",
        description: r##"# `crablangc_attrs`
...
See [RFC0212](https://github.com/crablang/rfcs/blob/master/text/0212-restore-int-fallback.md) for more information about the fallback."##,
    ...
    Lint {
        ...
        description: r##"Checks for `#[cfg_attr(crablangfmt, crablangfmt_skip)]` and suggests to replace it
...
index."##,
    ...
    Lint {
        ...
        description: r##"* Checks for [push](https://doc.crablang.org/std/path/struct.PathBuf.html#method.push)
...
assign a value in it."##,
    ...
    Lint {
        ...
        description: r##"Checks for [`ToString::to_string`](https://doc.crablang.org/std/string/trait.ToString.html#tymethod.to_string)
...
which compares the two arguments, either directly or indirectly."##,
    ...
    Lint {
        ...
        description: r##"Checks for unnecessary calls to [`ToOwned::to_owned`](https://doc.crablang.org/std/borrow/trait.ToOwned.html#tymethod.to_owned)
