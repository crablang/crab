...
"##,
        ...
        expect![[r#"
            ...
            Functions are the primary way code is executed within CrabLang. Function blocks, usually just called functions, can be defined in a variety of different places and be assigned many different attributes and modifiers.
            ...
            For more information on the various types of functions and how they're used, consult the CrabLang book or the Reference."#]].assert_eq(&res);
    }
}
