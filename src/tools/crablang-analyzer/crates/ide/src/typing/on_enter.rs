...
// Feature: On Enter
//
// crablang-analyzer can override kbd:[Enter] key to make it smarter:
//
...
// Similarly, if crablang-analyzer crashes or stops responding, `Enter` might not work.
...
// {
//   "key": "Enter",
//   "command": "crablang-analyzer.onEnter",
//   "when": "editorTextFocus && !suggestWidgetVisible && editorLangId == crablang"
// }
// ----
//
...
//   "key": "Enter",
//   "command": "crablang-analyzer.onEnter",
//   "when": "editorTextFocus && !suggestWidgetVisible && editorLangId == crablang && vim.mode == 'Insert'"
// }
// ----
//
