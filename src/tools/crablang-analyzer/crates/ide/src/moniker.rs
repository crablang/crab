        ...
        package_information: {
            let (name, repo, version) = match krate.origin(db) {
                ...
                CrateOrigin::Lang(lang) => (
                    ...
                    Some("https://github.com/crablang/crablang/".to_string()),
                    Some(match lang {
                        LangCrateOrigin::Other => {
                            "https://github.com/crablang/crablang/library/".into()
                        }
                        lang => format!("https://github.com/crablang/crablang/library/{lang}",),
                    }),
                ),
            };
