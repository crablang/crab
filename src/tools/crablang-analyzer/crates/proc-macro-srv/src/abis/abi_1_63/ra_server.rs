//! CrabLangc proc-macro server implementation with tt
//!
...
// CrabLangc Server Ident has to be `Copyable`
...
impl server::Group for CrabLangAnalyzer {
    fn new(
        &mut self,
...
impl server::Punct for CrabLangAnalyzer {
...
impl server::Ident for CrabLangAnalyzer {
...
impl server::Literal for CrabLangAnalyzer {
...
impl server::Diagnostic for CrabLangAnalyzer {
...
impl server::MultiSpan for CrabLangAnalyzer {
...
mod tests {
    ...
    fn test_ra_server_literals() {
        let mut srv = CrabLangAnalyzer { ident_interner: IdentInterner::default() };
