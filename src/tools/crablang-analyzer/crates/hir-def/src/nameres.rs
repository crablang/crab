...
pub struct DefMap {
    ...
    /// Unstable features of CrabLang enabled with `#![feature(A, B)]`.
    unstable_features: FxHashSet<SmolStr>,
    /// #[crablangc_coherence_is_core]
    crablangc_coherence_is_core: bool,
...
impl DefMap {
    ...
    fn empty(krate: CrateId, edition: Edition, module_data: ModuleData) -> DefMap {
        ...
        DefMap {
            ...
            diagnostics: Vec::new(),
            crablangc_coherence_is_core: false,
        }
    }
    ...
    pub fn is_crablangc_coherence_is_core(&self) -> bool {
        self.crablangc_coherence_is_core
    }
