...
pub struct FunctionData {
    ...
    pub crablangc_allow_incoherent_impl: bool,
    flags: FnFlags,
}
...
impl FunctionData {
    pub(crate) fn fn_data_query(db: &dyn DefDatabase, func: FunctionId) -> Arc<FunctionData> {
        ...
        let legacy_const_generics_indices = attrs
            .by_key("crablangc_legacy_const_generics")
            .tt_values()
            .next()
            .map(parse_crablangc_legacy_const_generics)
            .unwrap_or_default();
        let crablangc_allow_incoherent_impl = attrs.by_key("crablangc_allow_incoherent_impl").exists();
...
fn parse_crablangc_legacy_const_generics(tt: &crate::tt::Subtree) -> Box<[u32]> {
...
pub struct TypeAliasData {
    ...
    pub visibility: RawVisibility,
    pub is_extern: bool,
    pub crablangc_has_incoherent_inherent_impls: bool,
    pub crablangc_allow_incoherent_impl: bool,
...
impl TypeAliasData {
    pub(crate) fn type_alias_data_query(
        ...
        let crablangc_has_incoherent_inherent_impls =
            attrs.by_key("crablangc_has_incoherent_inherent_impls").exists();
        let crablangc_allow_incoherent_impl = attrs.by_key("crablangc_allow_incoherent_impl").exists();
...
pub struct TraitData {
    ...
    pub visibility: RawVisibility,
    /// Whether the trait has `#[crablang_skip_array_during_method_dispatch]`. `hir_ty` will ignore
...
impl TraitData {
    ...
    pub(crate) fn trait_data_with_diagnostics_query(
        ...
        let skip_array_during_method_dispatch =
            attrs.by_key("crablangc_skip_array_during_method_dispatch").exists();
        let crablangc_has_incoherent_inherent_impls =
            attrs.by_key("crablangc_has_incoherent_inherent_impls").exists();
...
pub struct Macro2Data {
    ...
    /// Derive helpers, if this is a derive crablangc_builtin_macro
...
impl Macro2Data {
    pub(crate) fn macro2_data_query(db: &dyn DefDatabase, makro: Macro2Id) -> Arc<Macro2Data> {
        ...
        let helpers = item_tree
            ...
            .by_key("crablangc_builtin_macro")
            .tt_values()
            .next()
...
impl ConstData {
    pub(crate) fn const_data_query(db: &dyn DefDatabase, konst: ConstId) -> Arc<ConstData> {
        ...
        let crablangc_allow_incoherent_impl = item_tree
            .attrs(db, loc.container.module(db).krate(), ModItem::from(loc.id.value).into())
            .by_key("crablangc_allow_incoherent_impl")
            .exists();
