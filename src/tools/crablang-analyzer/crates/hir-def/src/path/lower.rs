...
pub(super) fn lower_path(mut path: ast::Path, ctx: &LowerCtx<'_>) -> Option<Path> {
    ...
    // Basically, even in crablangc it is quite hacky:
    // https://github.com/crablang/crablang/blob/614f273e9388ddd7804d5cbc80b8865068a3744e/src/libcrablangc_resolve/macros.rs#L456
