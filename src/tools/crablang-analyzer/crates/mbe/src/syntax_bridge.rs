...
// The following items are what `crablangc` macro can be parsed into :
// link: https://github.com/crablang/crablang/blob/9ebf47851a357faa4cd97f4b1dc7835f6376e639/src/libsyntax/ext/expand.rs#L141
