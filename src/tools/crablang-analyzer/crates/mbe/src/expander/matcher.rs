//! An NFA-based parser, which is porting from crablangc mbe parsing code
//!
//! See <https://github.com/crablang/crablang/blob/70b18bc2cbac4712020019f5bf57c00905373205/compiler/crablangc_expand/src/mbe/macro_parser.rs>
//! Here is a quick intro to how the parser works, copied from crablangc:
//!
...
//! a CrabLang non-terminal like `$e:expr`, and `next_items` with threads that are waiting
//! on a particular token. Most of the logic concerns moving the · through the
//! repetitions indicated by Kleene stars. The rules for moving the · without
//! consuming any input are called epsilon transitions. It only advances or calls
//! out to the real CrabLang parser when no `cur_items` threads remain.
//!
//! Example:
//!
//! ```text, ignore
...
fn match_loop(pattern: &MetaTemplate, src: &tt::Subtree) -> Match {
    ...
    loop {
        ...
        //
        // Another possibility is that we need to call out to parse some crablang nonterminal
...
fn match_meta_var(kind: MetaVarKind, input: &mut TtIter<'_>) -> ExpandResult<Option<Fragment>> {
    let fragment = match kind {
        ...
        //
        // https://doc.crablang.org/edition-guide/crablang-2021/or-patterns-macro-rules.html
        ...
        MetaVarKind::Expr => {
            ...
            // crablangc [explicitly checks the next token][1].
            // [0]: https://github.com/crablang/crablang/issues/86730
            // [1]: https://github.com/crablang/crablang/blob/f0c4da499/compiler/crablangc_expand/src/mbe/macro_parser.rs#L576
