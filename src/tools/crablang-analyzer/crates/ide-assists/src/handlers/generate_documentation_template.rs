...
//
// Generates a crablangdoc example when editing an item's documentation.
//
// ```
// /// Adds two numbers.$0
...
/// Helper function to transform lines of documentation into a CrabLang code documentation
