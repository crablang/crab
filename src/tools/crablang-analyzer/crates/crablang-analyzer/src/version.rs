//! Code for representing crablang-analyzer's release version number.

use std::fmt;

/// Information about the git repository where crablang-analyzer was built from.
...
pub struct VersionInfo {
    /// crablang-analyzer's version, such as "1.57.0", "1.58.0-beta.1", "1.59.0-nightly", etc.
    pub version: &'static str,
    /// The release channel we were built for (stable/beta/nightly/dev).
    ///
    /// `None` if not built via crablangbuild.
