...
use crate::config::{Config, CrabLangfmtConfig};
...
pub fn server_capabilities(config: &Config) -> ServerCapabilities {
    ServerCapabilities {
        ...
        document_range_formatting_provider: match config.crablangfmt() {
            CrabLangfmtConfig::CrabLangfmt { enable_range_formatting: true, .. } => Some(OneOf::Left(true)),
...
/// Parses client capabilities and returns all completion resolve capabilities crablang-analyzer supports.
