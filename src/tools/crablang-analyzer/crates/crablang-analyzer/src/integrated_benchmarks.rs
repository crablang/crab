//! Fully integrated benchmarks for crablang-analyzer, which load real cargo
//! projects.
//!
...
//!
//! Note that "crablang-analyzer: Run" action does not allow running a single test
//! in release mode in VS Code. There's however "crablang-analyzer: Copy Run Command Line"
