...
/// See https://github.com/crablang/crablang-analyzer/pull/12010
///
...
pub(super) fn patch_json_for_outdated_configs(json: &mut Value) {
    ...
    patch! {
        ...
        cargo.useCrabLangcWrapperForBuildScripts -> cargo.buildScripts.useCrabLangcWrapper;
        ...
        crablangcSource -> crablangc.source;
        crablangfmt.enableRangeFormatting -> crablangfmt.rangeFormatting.enable;
    }
