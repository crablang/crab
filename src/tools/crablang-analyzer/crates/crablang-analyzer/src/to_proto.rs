//! Conversion of crablang-analyzer specific types to lsp_types equivalents.
use std::{
    iter::once,
    path,
...
pub(crate) mod command {
    ...
    pub(crate) fn show_references(
        ...
        lsp_types::Command {
            title,
            command: "crablang-analyzer.showReferences".into(),
            arguments: Some(vec![
                to_value(uri).unwrap(),
    ...
    pub(crate) fn run_single(runnable: &lsp_ext::Runnable, title: &str) -> lsp_types::Command {
        lsp_types::Command {
            ...
            command: "crablang-analyzer.runSingle".into(),
    ...
    pub(crate) fn debug_single(runnable: &lsp_ext::Runnable) -> lsp_types::Command {
        lsp_types::Command {
            title: "Debug".into(),
            command: "crablang-analyzer.debugSingle".into(),
            arguments: Some(vec![to_value(runnable).unwrap()]),
        }
    }
    ...
    pub(crate) fn goto_location(
        ...
        Some(lsp_types::Command {
            ...
            command: "crablang-analyzer.gotoLocation".into(),
    ...
    pub(crate) fn trigger_parameter_hints() -> lsp_types::Command {
        lsp_types::Command {
            ...
            command: "crablang-analyzer.triggerParameterHints".into(),
            arguments: None,
        }
    }
}
