...
impl flags::Scip {
    pub fn run(self) -> Result<()> {
        ...
        cargo_config.sysroot = Some(CrabLangLibSource::Discover);

        let no_progress = &|s| (eprintln!("crablang-analyzer: Loading {s}"));
        ...
        let metadata = scip_types::Metadata {
            ...
            tool_info: Some(scip_types::ToolInfo {
                name: "crablang-analyzer".to_owned(),
...
"#,
            "crablang-analyzer cargo foo 0.1.0 example_mod/func().",
        );
    }
...
"#,
            "crablang-analyzer cargo foo 0.1.0 module/MyTrait#func().",
        );
    }
    ...
    "#,
            "crablang-analyzer cargo foo 0.1.0 module/MyTrait#MY_CONST.",
        );
    }
    ...
    "#,
            ...
            "crablang-analyzer cargo foo 0.1.0 module/MyTrait#[MyType]",
        );
    }
    ...
    "#,
            ...
            "crablang-analyzer cargo foo 0.1.0 module/MyStruct#MyTrait#func().",
        );
    }
    ...
    "#,
            "crablang-analyzer cargo foo 0.1.0 St#a.",
        );
    }
    ...
    "#,
            "crablang-analyzer cargo main . foo/Bar#",
        );
    }
