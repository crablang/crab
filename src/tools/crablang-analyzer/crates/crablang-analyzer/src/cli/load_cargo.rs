...
// Note: Since this type is used by external tools that use crablang-analyzer as a library
...
// Note: Since this function is used by external tools that use crablang-analyzer as a library
// what otherwise would be `pub(crate)` has to be `pub` here instead.
...
mod tests {
    ...
    #[test]
    fn test_loading_crablang_analyzer() {
