//! The most high-level integrated tests for crablang-analyzer.
//!
...
#[cfg(not(feature = "in-crablang-tree"))]
mod sourcegen;
mod support;
mod testdir;
mod tidy;
...
use crablang_analyzer::lsp_ext::{OnEnter, Runnables, RunnablesParams};
use serde_json::json;
    ...
    for i in 0..10 {
        server.notification::<DidOpenTextDocument>(DidOpenTextDocumentParams {
            text_document: TextDocumentItem {
                ...
                language_id: "crablang".to_string(),
                version: 0,
                text: "/// Docs\nfn foo() {}".to_string(),
            },
        });
...
fn main() {
    ...
    .unwrap();
    println!("cargo:crablangc-cfg=atom_cfg");
    println!("cargo:crablangc-cfg=featlike=\"set\"");
    println!("cargo:rerun-if-changed=build.rs");
}
//- /src/main.rs
#[crablangc_builtin_macro] macro_rules! include {}
#[crablangc_builtin_macro] macro_rules! include_str {}
#[crablangc_builtin_macro] macro_rules! concat {}
#[crablangc_builtin_macro] macro_rules! env {}
...
#[test]
// FIXME: Re-enable once we can run proc-macro tests on crablang/crablang-analyzer again
#[cfg(any())]
...
"###,
    ...
    .with_config(serde_json::json!({
        ...
        "procMacro": {
            "enable": true,
            "server": PathBuf::from(env!("CARGO_BIN_EXE_crablang-analyzer")),
        }
    }))
    .root("foo")
    .root("bar")
