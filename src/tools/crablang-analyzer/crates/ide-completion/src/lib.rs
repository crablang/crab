...
//
// In addition to usual reference completion, crablang-analyzer provides some ✨magic✨
// completions as well:
//
...
// ```
//
// And the auto import completions, enabled with the `crablang-analyzer.completion.autoimport.enable` setting and the corresponding LSP client capabilities.
