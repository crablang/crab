...
use ide_db::{
    generated::lints::{
        Lint, CLIPPY_LINTS, CLIPPY_LINT_GROUPS, DEFAULT_LINTS, FEATURES, CRABLANGDOC_LINTS,
    },
...
/// <https://doc.crablang.org/reference/attributes.html#built-in-attributes-index>
