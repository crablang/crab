//! Completes environment variables defined by Cargo (https://doc.crablang.org/cargo/reference/environment-variables.html)
use hir::Semantics;
...
const CARGO_DEFINED_VARS: &[(&str, &str)] = &[
    ...
    ("CARGO_PKG_CRABLANG_VERSION","The CrabLang version from the manifest of your package. Note that this is the minimum CrabLang version supported by the package, not the current CrabLang version"),
