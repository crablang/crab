...
mod lint {
    ...
    #[test]
    fn lint_crablangdoc_unqualified() {
        check_edit(
            "crablangdoc::bare_urls",
            r#"#[allow($0)] struct Test;"#,
            r#"#[allow(crablangdoc::bare_urls)] struct Test;"#,
        );
    }

    #[test]
    fn lint_crablangdoc_qualified() {
        check_edit(
            "bare_urls",
            r#"#[allow(crablangdoc::$0)] struct Test;"#,
            r#"#[allow(crablangdoc::bare_urls)] struct Test;"#,
        );
    }
