...
"#,
    ...
    fn completes_macro_call_if_cursor_at_bang_token() {
        // Regression test for https://github.com/crablang/crablang-analyzer/issues/9904
...
"#,
    ...
    fn complete_missing_macro_arg() {
        // Regression test for https://github.com/crablang/crablang-analyzer/issues/14246
        check_edit(
            "BAR",
            r#"
macro_rules! foo {
