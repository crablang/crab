...
//
// crablang-analyzer allows the user to define custom (postfix)-snippets that may depend on items to be accessible for the current scope to be applicable.
//
// A custom snippet can be defined by adding it to the `crablang-analyzer.completion.snippets.custom` object respectively.
//
// [source,json]
// ----
// {
//   "crablang-analyzer.completion.snippets.custom": {
//     "thread spawn": {
//       "prefix": ["spawn", "tspawn"],
//       "body": [
//         "thread::spawn(move || {",
...
//
// For the VSCode editor, crablang-analyzer also ships with a small set of defaults which can be removed
