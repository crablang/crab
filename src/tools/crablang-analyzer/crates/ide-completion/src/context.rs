...
impl<'a> CompletionContext<'a> {
    pub(super) fn new(
        ...
        if original_token.kind() == T![:] {
            ...
            // special casing this as per discussion in https://github.com/crablang/crablang-analyzer/pull/13611#discussion_r1031845205
            // and https://github.com/crablang/crablang-analyzer/pull/13611#discussion_r1032812751
            if prev_token
                .prev_token()
