//! In crablang-analyzer, syntax trees are transient objects.
//!
...
use crate::{syntax_node::CrabLanguage, AstNode, SyntaxNode};

/// A "pointer" to a [`SyntaxNode`], via location in the source code.
pub type SyntaxNodePtr = rowan::ast::SyntaxNodePtr<CrabLanguage>;
