...
use crablangc_lexer::unescape::{unescape_byte, unescape_char, unescape_literal, Mode};
...
pub trait IsString: AstToken {
    ...
    fn escaped_char_ranges(
        &self,
        cb: &mut dyn FnMut(TextRange, Result<char, crablangc_lexer::unescape::EscapeError>),
    ) {
