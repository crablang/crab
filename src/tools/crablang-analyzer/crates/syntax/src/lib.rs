//! Syntax Tree library used throughout the crablang-analyzer.
//!
//! Properties:
...
//!
//! [RFC]: <https://github.com/crablang/rfcs/pull/2256>
...
pub use crate::{
    ...
    syntax_node::{
        PreorderWithTokens, CrabLanguage, SyntaxElement, SyntaxElementChildren, SyntaxNode,
...
/// `SourceFile` represents a parse tree for a single CrabLang file.
