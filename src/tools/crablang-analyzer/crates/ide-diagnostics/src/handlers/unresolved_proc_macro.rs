...
// `crablang-analyzer.diagnostics.disabled` list to prevent them from showing. Alternatively you can
// enable support for procedural macros (see `crablang-analyzer.procMacro.attributes.enable`).
