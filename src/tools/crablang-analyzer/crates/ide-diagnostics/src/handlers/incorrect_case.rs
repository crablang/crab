...
//
// This diagnostic is triggered if an item name doesn't follow https://doc.crablang.org/1.0.0/style/style/naming/README.html[CrabLang naming convention].
...
extern {
    ...
    fn bug_traits_arent_checked() {
        ...
        // r-a, even though crablangc will complain about them.
        check_diagnostics(
            r#"
trait BAD_TRAIT {
    fn BAD_FUNCTION();
