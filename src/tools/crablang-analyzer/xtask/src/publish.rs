...
fn create_original_changelog_url(file_name: &str) -> String {
    ...
    format!("https://crablang-analyzer.github.io/thisweek/{year}/{month}/{day}/{stem}.html")
}
...
fn update_release(sh: &Shell, tag_name: &str, release_notes: &str) -> Result<()> {
    ...
    let release_url = "https://api.github.com/repos/crablang/crablang-analyzer/releases";
...
mod tests {
    ...
    fn original_changelog_url_creation() {
        ...
        let expected = "https://crablang-analyzer.github.io/thisweek/2019/07/24/changelog-0.html";
