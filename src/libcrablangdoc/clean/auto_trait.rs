...
use crablangc_middle::ty::{self, Region, RegionVid, TypeFoldable, TypeSuperFoldable};
use crablangc_trait_selection::traits::auto_trait::{self, AutoTraitResult};
...
where
    'tcx: 'a, // should be an implied bound; crablangc bug #98852.
{
    ...
    fn handle_lifetimes<'cx>(
        ...
        // to sub-regions in CrabLang code (e.g., in 'a: 'b, 'a is the larger region).
    ...
    /// both for visual consistency between 'crablangdoc' runs, and to
