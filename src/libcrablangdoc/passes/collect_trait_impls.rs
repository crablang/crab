...
use crablangc_hir::def_id::{DefId, DefIdMap, DefIdSet, LOCAL_CRATE};
        ...
        for (prim, did) in PrimitiveType::primitive_locations(cx.tcx) {
            ...
            if did.is_local() {
                for def_id in prim.impls(tcx).filter(|def_id| {
                    ...
                    // https://github.com/crablang/crablang/issues/94937
                    //
                    // FIXME(notriddle): https://github.com/crablang/crablang/issues/97129
                    //
                    ...
                    //
                    // CrabLangdoc currently uses these `impl` block as a source of
