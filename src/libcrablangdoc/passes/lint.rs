//! Runs several crablangdoc lints, consolidating them into a single pass for
...
pub(crate) const RUN_LINTS: Pass =
    Pass { name: "run-lints", run: run_lints, description: "runs some of crablangdoc's lints" };
