...
use crablangc_middle::ty::{TyCtxt, Visibility};
...
pub(crate) struct Stripper<'a, 'tcx> {
    ...
    pub(crate) effective_visibilities: &'a CrabLangdocEffectiveVisibilities,
...
fn is_item_reachable(
    tcx: TyCtxt<'_>,
    is_json_output: bool,
    effective_visibilities: &CrabLangdocEffectiveVisibilities,
    item_id: ItemId,
) -> bool {
    if is_json_output {
