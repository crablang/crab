...
// WARNING: CRABLANGDOC_MOBILE_BREAKPOINT MEDIA QUERY
// If you update this line, then you also need to update the media query with the same
// warning in crablangdoc.css
window.CRABLANGDOC_MOBILE_BREAKPOINT = 700;
...
(function() {
    ...
    window.crablangdoc_add_line_numbers_to_examples = () => {
        onEachLazy(document.getElementsByClassName("crablang-example-rendered"), x => {
    ...
    window.crablangdoc_remove_line_numbers_from_examples = () => {
        onEachLazy(document.getElementsByClassName("crablang-example-rendered"), x => {
            const parent = x.parentNode;
            const line_numbers = parent.querySelectorAll(".example-line-numbers");
    ...
    window.crablangdocMobileScrollLock = function() {
        const mobile_topbar = document.querySelector(".mobile-topbar");
        if (window.innerWidth <= window.CRABLANGDOC_MOBILE_BREAKPOINT) {
    ...
    window.crablangdocMobileScrollUnlock = function() {
        const mobile_topbar = document.querySelector(".mobile-topbar");
    ...
    function showSidebar() {
        window.hideAllModals(false);
        window.crablangdocMobileScrollLock();
        const sidebar = document.getElementsByClassName("sidebar")[0];
        addClass(sidebar, "shown");
    }

    function hideSidebar() {
        window.crablangdocMobileScrollUnlock();
        const sidebar = document.getElementsByClassName("sidebar")[0];
    ...
    function buildHelpMenu() {
        ...
        book_info.innerHTML = "You can find more information in \
            <a href=\"https://doc.crablang.org/crablangdoc/\">the crablangdoc book</a>.";
        ...
        const crablangdoc_version = document.createElement("span");
        crablangdoc_version.className = "bottom";
        const crablangdoc_version_code = document.createElement("code");
        crablangdoc_version_code.innerText = "crablangdoc " + getVar("crablangdoc-version");
        crablangdoc_version.appendChild(crablangdoc_version_code);
        ...
        container.appendChild(crablangdoc_version);
