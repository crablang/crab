...
use crablangc_hir::def_id::{DefIdMap, LOCAL_CRATE};
...
/// Major driving force in all crablangdoc rendering. This contains information
...
pub(crate) struct Context<'tcx> {
    ...
    ///
    /// [#82381]: https://github.com/crablang/crablang/issues/82381
...
crablangc_data_structures::static_assert_size!(Context<'_>, 160);
...
pub(crate) struct SharedContext<'tcx> {
    ...
    pub(crate) span_correspondance_map: FxHashMap<crablangc_span::Span, LinkFromSrc>,
...
impl<'tcx> Context<'tcx> {
    ...
    fn render_item(&mut self, it: &clean::Item, is_module: bool) -> String {
        ...
        let desc = if let Some(desc) = desc {
            ...
            format!("API documentation for the CrabLang `{}` crate.", self.shared.layout.krate)
        } else {
            format!(
                "API documentation for the CrabLang `{}` {} in crate `{}`.",
...
impl<'tcx> FormatRenderer<'tcx> for Context<'tcx> {
    ...
    fn after_krate(&mut self) -> Result<(), Error> {
        ...
        page.title = "CrabLangdoc settings";
        page.description = "Settings of CrabLangdoc";
        page.root_path = "./";
        ...
        page.title = "CrabLangdoc help";
        page.description = "Documentation for CrabLangdoc";
        page.root_path = "./";
                    ...
                    "<div class=\"main-heading\">\
                     ...
                     <noscript>\
                        <section>\
                            ...
                            <p>For more information, browse the <a href=\"https://doc.crablang.org/crablangdoc/\">crablangdoc handbook</a>.</p>\
                        </section>\
                     </noscript>",
                )
            },
        ...
        if shared.layout.scrape_examples_extension {
            ...
            page.description = "How the scraped examples feature works in CrabLangdoc";
            let v = layout::render(
                &shared.layout,
                &page,
                "",
    ...
    fn mod_item_in(&mut self, item: &clean::Item) -> Result<(), Error> {
        // Stripped modules survive the crablangdoc passes (i.e., `strip-private`)
