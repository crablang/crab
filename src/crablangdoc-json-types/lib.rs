//! CrabLangdoc's JSON output interface
//!
...
pub struct Item {
    ...
    /// By default all documented items are public, but you can tell crablangdoc to output private items
    /// so this field is needed to differentiate.
    pub visibility: Visibility,
    /// The full markdown docstring of this item. Absent if there is no documentation at all,
    /// Some("") if there is some documentation but it is empty (EG `#[doc = ""]`).
    pub docs: Option<String>,
    /// This mapping resolves [intra-doc links](https://github.com/crablang/rfcs/blob/master/text/1946-intra-crablangdoc-links.md) from the docstring to their IDs
...
#[derive(Clone, Debug, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct Span {
    /// The path to the source file for this span relative to the path `crablangdoc` was invoked with.
...
pub enum Abi {
    ...
    // See crablangc_ast_passes::feature_gate::PostExpansionVisitor::check_abi for the list
    CrabLang,
    C { unwind: bool },
    Cdecl { unwind: bool },
    Stdcall { unwind: bool },
...
pub enum GenericParamDefKind {
    ...
    Type {
        ...
        /// declared in the CrabLang source text.
        ///
