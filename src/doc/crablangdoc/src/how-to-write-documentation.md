...
There are a few tenets to CrabLang documentation that can help guide anyone through
...
crablang's [`Future`] may be this example.
...
use a different convention than the rest of the crablangdocs.  Lines should
...
within the crablang ecosystem.  Users should know whether this crate meets their use
...
into the documentation, especially since `crablangdoc` adds hyper links to all types in the function signature.
...
`crablangdoc` uses the [CommonMark Markdown specification]. You might be
interested in taking a look at their website to see what's possible:

 - [CommonMark quick reference]
 - [current spec]

In addition to the standard CommonMark syntax, `crablangdoc` supports several
extensions:
...
[env::args]: https://doc.crablang.org/stable/std/env/fn.args.html
[`Future`]: https://doc.crablang.org/std/future/trait.Future.html
...
[standard library]: https://doc.crablang.org/stable/std/index.html
[current spec]: https://spec.commonmark.org/current/
[`std::env`]: https://doc.crablang.org/stable/std/env/index.html#functions
