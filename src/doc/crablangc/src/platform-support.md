...
Component availability is tracked [here](https://crablang.github.io/crablangup-components-history/).

## Tier 1 with Host Tools

Tier 1 targets can be thought of as "guaranteed to work". The CrabLang project
...
Tier 1 targets with host tools additionally support running tools like `crablangc`
...
[77071]: https://github.com/crablang/crablang/issues/77071
...
Tier 2 targets can be thought of as "guaranteed to build". The CrabLang project
...
Tier 2 targets with host tools additionally support running tools like `crablangc`
...
**NOTE:** The `crablang-docs` component is not usually built for tier 2 targets,
so CrabLangup may install the documentation for a similar tier 1 target instead.
...
[`no_std`]: https://crablang-embedded.github.io/book/intro/no-std.html
...
Tier 3 targets are those which the CrabLang codebase has support for, but which the
CrabLang project does not build or test automatically, so they may or may not work.
