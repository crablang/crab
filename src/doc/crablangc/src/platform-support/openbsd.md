...
- [lang/crablang](https://cvsweb.openbsd.org/cgi-bin/cvsweb/ports/lang/crablang/Makefile?rev=HEAD&content-type=text/x-cvsweb-markup) maintainer (see MAINTAINER variable)
...
C compiler toolchain is required for the purpose of building CrabLang and functional binaries.
...
The CrabLang testsuite could be run natively.

## Building CrabLang programs

CrabLang does not yet ship pre-compiled artifacts for these targets.
