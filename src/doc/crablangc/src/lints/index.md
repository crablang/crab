...
CrabLang compiler contains a number of lints, and when it compiles your code, it will
...
these cases to give users of CrabLang a smooth transition to the new behavior.
...
11 |     let y = &x.data.0;
   ...
   = note: for more information, see issue #46043 <https://github.com/crablang/crablang/issues/46043>
...
[RFC 1589]: https://github.com/crablang/rfcs/blob/master/text/1589-crablangc-bug-fix-procedure.md
