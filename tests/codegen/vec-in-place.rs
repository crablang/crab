...
// implementing Copy exercises the TcrablangedRandomAccess specialization inside the in-place
// specialization
#[derive(Copy, Clone)]
pub struct Bar {
    a: u64,
...
pub fn vec_iterator_cast_deaggregate_tra(vec: Vec<Bar>) -> Vec<[u64; 4]> {
    ...
    // This currently is not guaranteed for repr(CrabLang) types, but it happens to work here and
