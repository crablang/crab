...
// Ensure that __crablang_alloc_zeroed gets the right attributes for LLVM to optimize it away.
// CHECK: declare noalias noundef ptr @__crablang_alloc_zeroed(i64 noundef, i64 allocalign noundef) unnamed_addr [[CRABLANG_ALLOC_ZEROED_ATTRS:#[0-9]+]]

// CHECK-DAG: attributes [[CRABLANG_ALLOC_ZEROED_ATTRS]] = { {{.*}} allockind("alloc,zeroed,aligned") allocsize(0) uwtable "alloc-family"="__crablang_alloc" {{.*}} }
