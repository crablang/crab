...
// into this separate file because they can't be `crablangfix`'d (and thus, can't
// be part of a `run-crablangfix` test file) until crablang-nursery/crablangfix#141
// is solved
...
// https://github.com/crablang/crablang/issues/106870
