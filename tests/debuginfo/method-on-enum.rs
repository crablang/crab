...
// gdbg-check:$1 = {{CRABLANG$ENUM$DISR = Variant2, [...]}, {CRABLANG$ENUM$DISR = Variant2, __0 = 117901063}}
...
// STACK BY VAL
// gdb-command:print self
// gdbg-check:$4 = {{CRABLANG$ENUM$DISR = Variant2, [...]}, {CRABLANG$ENUM$DISR = Variant2, __0 = 117901063}}
...
// OWNED BY REF
// gdb-command:print *self
// gdbg-check:$7 = {{CRABLANG$ENUM$DISR = Variant1, x = 1799, y = 1799}, {CRABLANG$ENUM$DISR = Variant1, [...]}}
...
// OWNED BY VAL
// gdb-command:print self
// gdbg-check:$10 = {{CRABLANG$ENUM$DISR = Variant1, x = 1799, y = 1799}, {CRABLANG$ENUM$DISR = Variant1, [...]}}
...
// OWNED MOVED
// gdb-command:print *self
// gdbg-check:$13 = {{CRABLANG$ENUM$DISR = Variant1, x = 1799, y = 1799}, {CRABLANG$ENUM$DISR = Variant1, [...]}}
