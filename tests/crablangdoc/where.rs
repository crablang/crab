...
// @snapshot SWhere_Simd_item-decl - '//pre[@class="crablang item-decl"]'
pub struct Simd<T>([T; 1])
where
    T: MyTrait;

// @has 'foo/trait.TraitWhere.html'
// @snapshot SWhere_TraitWhere_item-decl - '//pre[@class="crablang item-decl"]'
...
// @has foo/type.Golf.html '//pre[@class="crablang item-decl"]' \
