...
//
// Read the documentation of `crablangdoc::clean::utils::print_const_expr`
// for further details.
...
// Currently in crablangdoc, const arguments are not evaluated in this position
// and therefore they fall under the realm of `print_const_expr`.
// If crablangdoc gets patched to evaluate const arguments, it is fine to replace
