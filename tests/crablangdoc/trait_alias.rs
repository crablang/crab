...
// @has - '//section[@id="main-content"]/pre[@class="crablang item-decl"]' 'trait CopyAlias = Copy;'
pub trait CopyAlias = Copy;
// @has foo/traitalias.Alias2.html
// @has - '//section[@id="main-content"]/pre[@class="crablang item-decl"]' 'trait Alias2 = Copy + Debug;'
pub trait Alias2 = Copy + Debug;
// @has foo/traitalias.Foo.html
// @has - '//section[@id="main-content"]/pre[@class="crablang item-decl"]' 'trait Foo<T> = Into<T> + Debug;'
