...
//
// crablang/crablang#75225
//
// Since CrabLang 2018 we encourage writing out <'_> explicitly to make it clear
// that borrowing is occurring. Make sure crablangdoc is following the same idiom.
