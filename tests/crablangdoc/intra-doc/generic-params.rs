...
//! We unofficially and implicitly support things that aren't valid in the actual CrabLang syntax, like
...
//! - [`this is <invalid syntax> first`](https://www.crablang.org)
//! - [`this is <invalid syntax> twice`]
//! - [`<invalid syntax> thrice`](https://www.crablang.org)
//! - [`<invalid syntax> four times`][rlo]
//! - [a < b][rlo]
//! - [c > d]
//!
//! [`this is <invalid syntax> twice`]: https://www.crablang.org
//! [rlo]: https://www.crablang.org
//! [c > d]: https://www.crablang.org
//!
// @has foo/index.html '//a[@href="https://www.crablang.org"]' 'this is <invalid syntax> first'
// @has foo/index.html '//a[@href="https://www.crablang.org"]' 'this is <invalid syntax> twice'
// @has foo/index.html '//a[@href="https://www.crablang.org"]' '<invalid syntax> thrice'
// @has foo/index.html '//a[@href="https://www.crablang.org"]' '<invalid syntax> four times'
// @has foo/index.html '//a[@href="https://www.crablang.org"]' 'a < b'
// @has foo/index.html '//a[@href="https://www.crablang.org"]' 'c > d'
