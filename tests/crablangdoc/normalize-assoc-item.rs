...
// @has 'normalize_assoc_item/fn.f.html' '//pre[@class="crablang item-decl"]' 'pub fn f() -> isize'
pub fn f() -> <usize as Trait>::X {
    0
}

// @has 'normalize_assoc_item/fn.f2.html' '//pre[@class="crablang item-decl"]' 'pub fn f2() -> fn() -> i32'
...
// @has 'normalize_assoc_item/struct.Unknown.html' '//pre[@class="crablang item-decl"]' 'pub struct Unknown<Inner: Trait>(pub <Inner as Trait>::X);'
pub struct Unknown<Inner: Trait>(pub <Inner as Trait>::X);

// @has 'normalize_assoc_item/struct.Unknown2.html' '//pre[@class="crablang item-decl"]' 'pub struct Unknown2<Inner: Trait>(pub Inner::X);'
...
// @has 'normalize_assoc_item/fn.g.html' '//pre[@class="crablang item-decl"]' "pub fn g() -> &'static isize"
pub fn g() -> <usize as Lifetimes<'static>>::Y {
    &0
}

// @has 'normalize_assoc_item/constant.A.html' '//pre[@class="crablang item-decl"]' "pub const A: &'static isize"
pub const A: <usize as Lifetimes<'static>>::Y = &0;

// test cross-crate re-exports
extern crate inner;
// @has 'normalize_assoc_item/fn.foo.html' '//pre[@class="crablang item-decl"]' "pub fn foo() -> i32"
pub use inner::foo;

// @has 'normalize_assoc_item/fn.h.html' '//pre[@class="crablang item-decl"]' "pub fn h<T>() -> IntoIter<T, Global>"
