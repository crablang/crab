...
// @has issue_98697/fn.repro.html '//pre[@class="crablang item-decl"]/code' 'fn repro<F>()where F: Fn(&str)'
// @!has issue_98697/fn.repro.html '//pre[@class="crablang item-decl"]/code' 'for<'
