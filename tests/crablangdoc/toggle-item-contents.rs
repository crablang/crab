...
// @count - '//details[@class="toggle type-contents-toggle"]' 0
// @has - '//pre[@class="crablang item-decl"]' '/* private fields */'
...
// @count - '//pre[@class="crablang item-decl"]//details[@class="toggle type-contents-toggle"]' 1
// @has - '//pre[@class="crablang item-decl"]//details[@class="toggle type-contents-toggle"]' 'Show 13 variants'
pub enum LargeEnum {
