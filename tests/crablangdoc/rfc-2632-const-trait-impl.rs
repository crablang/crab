// Test that we do not currently display `~const` in crablangdoc
...
// @!has foo/trait.Tr.html '//pre[@class="crablang item-decl"]/code/a[@class="trait"]' '~const'
// @has - '//pre[@class="crablang item-decl"]/code/a[@class="trait"]' 'Clone'
// @!has - '//pre[@class="crablang item-decl"]/code/span[@class="where"]' '~const'
// @has - '//pre[@class="crablang item-decl"]/code/span[@class="where"]' ': Clone'
#[const_trait]
pub trait Tr<T> {
...
// @!has foo/fn.foo.html '//pre[@class="crablang item-decl"]/code/a[@class="trait"]' '~const'
// @has - '//pre[@class="crablang item-decl"]/code/a[@class="trait"]' 'Clone'
// @!has - '//pre[@class="crablang item-decl"]/code/span[@class="where fmt-newline"]' '~const'
// @has - '//pre[@class="crablang item-decl"]/code/span[@class="where fmt-newline"]' ': Clone'
