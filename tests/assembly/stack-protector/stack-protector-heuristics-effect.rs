...
pub fn array_char(f: fn(*const char)) {
    ...
    // 'char' is 4 bytes in CrabLang, this function is not protected by the 'basic'
    // heuristic
    //
...
extern "C" {
    ...
    // function in CrabLang also doesn't trigger stack protection.
...
// The question then is: in what ways can CrabLang code generate array-`alloca`
// LLVM instructions? This appears to only be generated by
// crablangc_codegen_ssa::traits::Builder::array_alloca() through
// crablangc_codegen_ssa::mir::operand::OperandValue::store_unsized(). FWICT
// this is support for the "unsized locals" unstable feature:
// https://doc.crablang.org/unstable-book/language-features/unsized-locals.html.
