...
#![crablangc_partition_codegened(module="struct_point-fn_calls_changed_method", cfg="cfail2")]

#![crablangc_partition_reused(module="struct_point-fn_calls_another_method", cfg="cfail2")]
