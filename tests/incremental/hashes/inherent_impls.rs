...
#[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,associated_item_def_ids")]
#[crablangc_clean(cfg="cfail3")]
#[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,associated_item_def_ids")]
...
#[crablangc_clean(cfg="cfail6")]
impl Foo {
    #[crablangc_clean(cfg="cfail2", except="hir_owner_nodes,optimized_mir,promoted_mir,typeck")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="hir_owner_nodes,optimized_mir,promoted_mir,typeck")]
    #[crablangc_clean(cfg="cfail6")]
    pub fn method_body() {
        println!("Hello, world!");
    }
...
#[crablangc_clean(cfg="cfail6")]
impl Foo {
    #[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,fn_sig,typeck,optimized_mir")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,fn_sig,typeck,optimized_mir")]
    #[crablangc_clean(cfg="cfail6")]
...
#[crablangc_clean(cfg="cfail6")]
impl Foo {
    #[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,fn_sig,optimized_mir,typeck")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,fn_sig,optimized_mir,typeck")]
    #[crablangc_clean(cfg="cfail6")]
...
#[crablangc_clean(cfg="cfail6")]
impl Foo {
    #[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,fn_sig,typeck")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,fn_sig,typeck")]
    #[crablangc_clean(cfg="cfail6")]
...
impl Foo {
    ...
    #[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,fn_sig")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,fn_sig,generics_of")]
    #[crablangc_clean(cfg="cfail6")]
...
#[cfg(not(any(cfail1,cfail4)))]
#[crablangc_clean(cfg="cfail2", except="hir_owner,hir_owner_nodes,generics_of")]
#[crablangc_clean(cfg="cfail3")]
#[crablangc_clean(cfg="cfail5", except="hir_owner,hir_owner_nodes,generics_of")]
#[crablangc_clean(cfg="cfail6")]
impl<T> Bar<T> {
    #[crablangc_clean(
        cfg="cfail2",
...
#[crablangc_clean(cfg="cfail6")]
impl Bar<u64> {
    #[crablangc_clean(cfg="cfail2", except="fn_sig,optimized_mir,typeck")]
    #[crablangc_clean(cfg="cfail3")]
    #[crablangc_clean(cfg="cfail5", except="fn_sig,optimized_mir,typeck")]
    #[crablangc_clean(cfg="cfail6")]
    pub fn change_impl_self_type(&self) { }
}
