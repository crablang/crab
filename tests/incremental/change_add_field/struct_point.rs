...
#![crablangc_partition_codegened(module="struct_point-fn_with_type_in_sig", cfg="cfail2")]
#![crablangc_partition_codegened(module="struct_point-call_fn_with_type_in_sig", cfg="cfail2")]
#![crablangc_partition_codegened(module="struct_point-fn_with_type_in_body", cfg="cfail2")]
#![crablangc_partition_codegened(module="struct_point-fn_make_struct", cfg="cfail2")]
#![crablangc_partition_codegened(module="struct_point-fn_read_field", cfg="cfail2")]
#![crablangc_partition_codegened(module="struct_point-fn_write_field", cfg="cfail2")]

#![crablangc_partition_reused(module="struct_point-call_fn_with_type_in_body", cfg="cfail2")]
...
pub mod fn_with_type_in_sig {
    ...
    #[crablangc_clean(except="typeck,fn_sig,optimized_mir", cfg="cfail2")]
...
pub mod call_fn_with_type_in_sig {
    ...
    #[crablangc_clean(except="typeck,optimized_mir", cfg="cfail2")]
    pub fn bip() -> f32 {
