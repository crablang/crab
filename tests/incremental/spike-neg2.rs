...
// `crablangc_partition_reused` and `crablangc_partition_codegened` tests.
...
#![crablangc_partition_reused(module="spike_neg2", cfg="rpass2")]
#![crablangc_partition_codegened(module="spike_neg2-x", cfg="rpass2")]
#![crablangc_partition_codegened(module="spike_neg2-y", cfg="rpass2")] // this is wrong!
