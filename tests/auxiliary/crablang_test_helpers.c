...
uint32_t
crablang_dbg_extern_identity_u32(uint32_t u) {
    return u;
}

uint64_t
crablang_dbg_extern_identity_u64(uint64_t u) {
    return u;
}

double
crablang_dbg_extern_identity_double(double u) {
    return u;
}

char
crablang_dbg_extern_identity_u8(char u) {
    return u;
}
...
void *
crablang_dbg_call(dbg_callback cb, void *data) {
    return cb(data);
}

void crablang_dbg_do_nothing() { }
...
struct TwoU8s
crablang_dbg_extern_return_TwoU8s() {
    struct TwoU8s s;
    s.one = 10;
    s.two = 20;
    return s;
...
struct TwoU8s
crablang_dbg_extern_identity_TwoU8s(struct TwoU8s u) {
    return u;
}
...
struct TwoU16s
crablang_dbg_extern_return_TwoU16s() {
    struct TwoU16s s;
    s.one = 10;
    s.two = 20;
    return s;
...
struct TwoU16s
crablang_dbg_extern_identity_TwoU16s(struct TwoU16s u) {
    return u;
}
...
struct TwoU32s
crablang_dbg_extern_return_TwoU32s() {
    struct TwoU32s s;
    s.one = 10;
    s.two = 20;
    return s;
...
struct TwoU32s
crablang_dbg_extern_identity_TwoU32s(struct TwoU32s u) {
    return u;
}
...
struct TwoU64s
crablang_dbg_extern_return_TwoU64s() {
    struct TwoU64s s;
    s.one = 10;
    s.two = 20;
    return s;
...
struct TwoU64s
crablang_dbg_extern_identity_TwoU64s(struct TwoU64s u) {
    return u;
}
...
struct TwoDoubles
crablang_dbg_extern_identity_TwoDoubles(struct TwoDoubles u) {
    return u;
}
...
void
crablang_dbg_extern_empty_struct(struct ManyInts v1, struct Empty e, struct ManyInts v2) {
...
struct quad
crablang_dbg_abi_1(struct quad q) {
...
struct floats
crablang_dbg_abi_2(struct floats f) {
...
struct char_char_double
crablang_dbg_abi_3(struct char_char_double a) {
...
struct char_char_float
crablang_dbg_abi_4(struct char_char_float a) {
...
crablang_dbg_static_mut_check_four() {
    assert(crablang_dbg_static_mut == 4);
}
...
double crablang_valist_interesting_average(uint64_t n, va_list pairs) {
    double sum = 0.0;
    int i;
    for(i = 0; i < n; i += 1) {
...
double crablang_interesting_average(uint64_t n, ...) {
    double sum;
    va_list pairs;
    va_start(pairs, n);
    sum = crablang_valist_interesting_average(n, pairs);
    va_end(pairs);
    return sum;
}

int32_t crablang_int8_to_int32(int8_t x) {
    return (int32_t)x;
}
...
struct U8TaggedEnumOptionU64
crablang_dbg_new_some_u64(uint64_t some) {
...
struct U8TaggedEnumOptionU64
crablang_dbg_new_none_u64(void) {
    struct U8TaggedEnumOptionU64 r = {
        .tag = OPTION_TAG_NONE,
    };
    return r;
...
int32_t
crablang_dbg_unpack_option_u64(struct U8TaggedEnumOptionU64 o, uint64_t *into) {
    assert(into);
    switch (o.tag) {
...
struct U8TaggedEnumOptionU64U64
crablang_dbg_new_some_u64u64(uint64_t a, uint64_t b) {
...
struct U8TaggedEnumOptionU64U64
crablang_dbg_new_none_u64u64(void) {
    struct U8TaggedEnumOptionU64U64 r = {
        .tag = OPTION_TAG_NONE,
    };
    return r;
...
int32_t
crablang_dbg_unpack_option_u64u64(struct U8TaggedEnumOptionU64U64 o, uint64_t *a, uint64_t *b) {
    assert(a);
    assert(b);
    switch (o.tag) {
    case OPTION_TAG_SOME:
