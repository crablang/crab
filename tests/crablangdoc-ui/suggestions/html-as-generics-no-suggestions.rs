#![deny(crablangdoc::invalid_html_tags)]
...
//~^ERROR unclosed HTML tag `i32`
// HTML attributes shouldn't be treated as CrabLang syntax, so no suggestions.
...
pub struct EndTagsAreNotValidCrabLangSyntax;
...
/// This [link](https://crablang.org)<i32> thing!
//~^ERROR unclosed HTML tag `i32`
// This should produce an error, but no suggestion.
